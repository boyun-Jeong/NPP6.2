(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("ref16_1.xfdl", function() {
        /***********************************************************************************
        * 화면(명)		: Grid Valdation
        * 메뉴(경로)	: 공통관리 > 플랫폼 > 공통
        ...
        ***********************************************************************************/
        ...
        this.fnButtonComOnclick = function(obj, e)
        {
            ...
            switch(sObjId)
        	{
        		...
        		case "btnValidationStatus" :
        			...
        			idx = nexacro.toNumber(nexacro.replaceAll(this.cboCol.value, "COL", "")) - 1;
        			this.Div00.form.Grid00.setCellProperty("Body", idx, "validationStatus", !this.Div00.form.Grid00.getCellProperty("Body", idx, "validationStatus"));
        			var validationStatus = this.Div00.form.Grid00.getCellProperty("Body", idx, "validationStatus");
        			this.btnValidationStatus.set_text("validationStatus=[" + validationStatus + "]");
        		...
        		case "btnEdittypeConf" :
        			...
        			idx = nexacro.toNumber(nexacro.replaceAll(this.cboCol.value, "COL", "")) - 1;
        			this.Div00.form.Grid00.setCellProperty("Body", idx, "edittype", this.cboEdittype.value);
        			break;
        		...
        		case "btnValidationConf" :
        			...
        			idx = nexacro.toNumber(nexacro.replaceAll(this.cboCol.value, "COL", "")) - 1;
        			validationStr = this.Div00.form.Grid00.getCellProperty("Body", idx, "validation") || "";
        			validation = validationStr.split(";");
        			validationAttr = validation[0];

        			if(validation.length > 1)
        			{
        				this.Div00.form.Grid00.setCellProperty("Body", idx, "validation", validationAttr + ";" + this.edtPropValidaion.value);
        			}
        			else
        			{
        				this.Div00.form.Grid00.setCellProperty("Body", idx, "validation", validationAttr + ";");
        			}
        			break;
        ...
        this.loadIncludeScript("ref16_1.xfdl");
