(function()
{
    return function()
    {
        ...
        {
            this.set_name("ref21");
            this.set_titletext("Grid 필터");
            if (Form == this.constructor)
            {
                this._setFormPosition(620,520);
            }
            ...
            obj = new Grid("Grid00","20","48",null,null,"20","20",null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"250\"/><Column size=\"80\"/><Column size=\"120\"/><Column size=\"80\"/><Column size=\"250\"/><Column size=\"57\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"32\"/><Row size=\"24\" band=\"summ\"/></Rows><Band id=\"head\"><Cell text=\"No.\"/><Cell col=\"1\" text=\"이름\"/><Cell col=\"2\" text=\"타입\"/><Cell col=\"3\" text=\"주소\"/><Cell col=\"4\" text=\"금액\" isFilterCell=\"false\"/><Cell col=\"5\" text=\"일자\"/><Cell col=\"6\" text=\"금액2\" isFilterCell=\"false\"/><Cell col=\"7\" text=\"상세정보\"/><Cell col=\"8\" text=\"aaa\" isFilterCell=\"false\"/></Band><Band id=\"body\"><Cell expr=\"currow+1\" textAlign=\"center\"/><Cell col=\"1\" text=\"bind:Column0\"/><Cell col=\"2\" text=\"bind:Column1\"/><Cell col=\"3\" text=\"bind:Column2\"/><Cell col=\"4\" text=\"bind:Column3\" textAlign=\"right\"/><Cell col=\"5\" text=\"bind:Column4\" displaytype=\"date\"/><Cell col=\"6\" text=\"bind:Column5\" textAlign=\"right\"/><Cell col=\"7\" text=\"bind:Column6\"/><Cell col=\"8\" text=\"bind:Column77\"/></Band><Band id=\"summary\"><Cell/><Cell col=\"1\"/><Cell col=\"2\"/><Cell col=\"3\"/><Cell col=\"4\"/><Cell col=\"5\"/><Cell col=\"6\" expr=\"dataset.getSum(&apos;nexacro.toNumber(Column5)&apos;)\" displaytype=\"number\" textAlign=\"right\"/><Cell col=\"7\"/><Cell col=\"8\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",620,520,this,function(p){});
        ...
        // User Script
        this.registerScript("ref21.xfdl", function() {
        /**
        *  @MenuPath    techtip > gridheadfilter2
        *  techtip Grid Head에 Filter 기능 만들기2
        *  @FileName	gridheadfilter2.xfdl
        *******************************************************************************
        ...
        */
         ...
         * include 영역
        **************************************************************************/
        //include "lib_techtip::lib_gridheadfilter2.xjs";
        ...
        **************************************************************************/
         ...
         **************************************************************************/
        /**
         * @description 필터 추가 버튼 onclick 시 처리내역
        */
        ...
        **************************************************************************/
        ...
        this.loadIncludeScript("ref21.xfdl");
