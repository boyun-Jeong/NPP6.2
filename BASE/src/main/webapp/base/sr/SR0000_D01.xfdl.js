(function()
{
    return function()
    {
        ...
        {
            this.set_name("SR0000_D01");
            this.set_titletext("요청정보-서브 프로젝트");
            ...
            obj._setContents("<ColumnInfo><Column id=\"REQ_TMPLAT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"REQ_TMPLAT_VER\" type=\"STRING\" size=\"256\"/><Column id=\"REQ_ID\" type=\"STRING\" size=\"256\"/><Column id=\"ENC_REQ_ID\" type=\"STRING\" size=\"256\"/><Column id=\"IS_COPY\" type=\"STRING\" size=\"256\"/><Column id=\"WF_FUNC_CD\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"REQ_TMPLAT_ID\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("stcBg04","0","133",null,null,"0","0",null,null,null,null,this);
            obj.set_taborder("21");
            ...
            obj = new Static("stcReqDt","50.00%","67","114","34",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("요청일자");
            ...
            obj = new Edit("edtReqTitle","stcReqTitle:5","105",null,"24","5",null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_validationGroup("group01");
            obj.set_validation("프로젝트명;NULL");
            obj.set_cssclass("edt_WF_normal");
            ...
            obj = new Static("stcReqDesc","50%","133","114",null,null,"0",null,null,null,null,this);
            obj.set_taborder("19");
            obj.set_text("작성요령");
            obj.set_cssclass("sta_WF_inputTitle");
            this.addChild(obj.name, obj);

            obj = new Static("stcReqReason","0","133","114",null,null,"0",null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_text("프로젝트 개요");
            obj.set_cssclass("sta_WF_inputTitle_E");
            this.addChild(obj.name, obj);

            obj = new TextArea("txaContents","stcReqReason:5","138",null,null,"stcReqDesc:5","4",null,null,null,null,this);
            obj.set_taborder("18");
            obj.set_cssclass("txa_WF_normal");
            obj.set_wordWrap("char");
            obj.set_validation("프로젝트 개요;NULL");
            obj.set_validationGroup("group01");
            obj.set_readonly("true");
            obj.set_text("");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("edtReqTmplatNm","stcLabel06:5","72",null,"24","stcReqDt:5",null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_cssclass("edt_WF_normal");
            ...
            obj = new Calendar("calReqDt","stcReqDt:5.00","72","115","24",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            ...
            obj = new WebView("wevReqDesc","stcReqDesc:5","138",null,null,"5","4",null,null,null,null,this);
            obj.set_taborder("20");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("stcReqUserNm00","50%","34","114","34",null,null,null,null,null,null,this);
            obj.set_taborder("30");
            obj.set_text("요청부서");
            obj.set_cssclass("sta_WF_inputTitle");
            this.addChild(obj.name, obj);

            obj = new Edit("edtReqUserNm00","stcReqUserNm00:5","39",null,"24","stcRegDeptNm00:5",null,null,null,null,null,this);
            obj.set_taborder("29");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_cssclass("edt_WF_normal");
            ...
            obj = new BindItem("item2","edtReqUserNm00","value","dsSrBaseInfo","REQ_DEPT_NM");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("SR0000_D01.xfdl", function() {
        /***********************************************************************************
        * 화면 ID		︰ SR0110_D
        * 화면(명)		︰ 요청서 등록
        * 메뉴(경로)	︰ 공통
        ...
        ***********************************************************************************/
        ...
        this.loadIncludeScript("SR0000_D01.xfdl");
