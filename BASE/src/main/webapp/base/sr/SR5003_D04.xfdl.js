(function()
{
    return function()
    {
        ...
        {
            this.set_name("SR5003_D04");
            this.set_titletext("시스템작업계획서(서버)");
            if (Form == this.constructor)
            {
                this._setFormPosition(1820,1550);
            }
            ...
            obj = new Static("stcJobCont","900.00","605","130","120",null,null,null,null,null,null,this);
            obj.set_taborder("51");
            obj.set_text("작업개요");
            obj.set_cssclass("sta_WF_inputTitle_E");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("grdSub3","0","605",null,"180","Static21_00:0.5%",null,null,null,null,null,this);
            obj.set_taborder("45");
            ...
            obj = new Static("Static00_01_00_00","0","785",null,"20","0",null,null,null,null,null,this);
            obj.set_taborder("49");
            obj.set_background("rgba(173,142,219,0.4)");
            obj.set_text("20");
            obj.set_textAlign("center");
            ...
            obj = new Static("stcInfoTitle3_00_01","0","805","200","24",null,null,null,null,null,null,this);
            obj.set_taborder("54");
            obj.set_cssclass("sta_WF_gridTitle");
            obj.set_text("세부작업내용");
            this.addChild(obj.name, obj);

            obj = new Static("Static33_00_00_01","0","845","1820","10",null,null,null,null,null,null,this);
            obj.set_taborder("56");
            obj.set_cssclass("Guide_Color");
            obj.set_visible("false");
            obj.set_background("#e5dbfa");
            ...
            obj = new Static("stcInfoTitle3_00_00_00","440.00","805","200","24",null,null,null,null,null,null,this);
            obj.set_taborder("60");
            obj.set_cssclass("sta_WF_gridTitle");
            obj.set_text("처리내용");
            obj.set_visible("false");
            ...
            obj = new Button("btnJobDescDelete",null,"805","60","24","stcInfoTitle3_00_00_00:5",null,null,null,null,null,this);
            obj.set_taborder("58");
            obj.set_text("삭제");
            obj.set_cssclass("btn_WF_del");
            this.addChild(obj.name, obj);

            obj = new Button("btnJobDescAdd",null,"805","60","24","btnJobDescDelete:5",null,null,null,null,null,this);
            obj.set_taborder("57");
            obj.set_text("추가");
            obj.set_cssclass("btn_WF_add");
            this.addChild(obj.name, obj);

            obj = new Static("Static21_00_00","440.00","870",null,"150","0",null,null,null,null,null,this);
            obj.set_taborder("59");
            obj.set_cssclass("sta_WF_inputBg");
            this.addChild(obj.name, obj);

            obj = new Static("stcUpmu00_00_01_00","440.00","840",null,"34","0",null,null,null,null,null,this);
            obj.set_taborder("61");
            ...
            obj = new Grid("grdSub1","0","840",null,"180","stcUpmu00_00_01_00:0.65%",null,null,null,null,null,this);
            obj.set_taborder("55");
            ...
            obj.set_taborder("16");
            obj.set_validationGroup("input03");
            obj.set_validation("영향도;NULL");
            obj.set_cssclass("txa_WF_normal");
            obj.set_imemode("hangul");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new TextArea("txaProcDesc","445.00","877",null,"139","5",null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_validationGroup("input04");
            obj.set_validation("세부작업내용의 처리내용 및 작업COMMAND;NULL");
            obj.set_cssclass("txa_WF_normal");
            obj.set_imemode("hangul");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Static("Static00_01_00_00_00","0","1020",null,"20","0",null,null,null,null,null,this);
            obj.set_taborder("62");
            obj.set_background("rgba(173,142,219,0.4)");
            obj.set_text("20");
            obj.set_textAlign("center");
            ...
            obj = new Static("stcInfoTitle3_00_01_00","0","1040","200","24",null,null,null,null,null,null,this);
            obj.set_taborder("63");
            obj.set_cssclass("sta_WF_gridTitle");
            obj.set_text("작업 에러시 복구절차");
            this.addChild(obj.name, obj);

            obj = new Static("Static33_00_00_01_00","0","1065","1820","10",null,null,null,null,null,null,this);
            obj.set_taborder("64");
            obj.set_cssclass("Guide_Color");
            obj.set_visible("false");
            obj.set_background("#e5dbfa");
            ...
            obj = new Static("Static21_01","0","1075",null,"120","0",null,null,null,null,null,this);
            obj.set_taborder("65");
            obj.set_cssclass("sta_WF_inputBg");
            this.addChild(obj.name, obj);

            obj = new Static("Static24_00","0","1075","130","120",null,null,null,null,null,null,this);
            obj.set_taborder("66");
            obj.set_text("처리내용 및\r\n작업COMMAND");
            obj.set_cssclass("sta_WF_inputTitle_E");
            this.addChild(obj.name, obj);

            obj = new TextArea("txaProcDesc00","134.00","1080",null,"110","5",null,null,null,null,null,this);
            obj.set_taborder("18");
            obj.set_validationGroup("input04");
            obj.set_validation("작업 에러시 복구절차의 처리내용 및 작업COMMAND;NULL");
            obj.set_cssclass("txa_WF_normal");
            obj.set_imemode("hangul");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Static("Static09_01_00_00_00","0","1194",null,"34","0",null,null,null,null,null,this);
            obj.set_taborder("67");
            obj.set_cssclass("sta_WF_inputBg");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Static("stcSvcYn","0","1194","130","34",null,null,null,null,null,null,this);
            obj.set_taborder("68");
            obj.set_text("처리결과");
            obj.set_cssclass("sta_WF_inputTitle");
            this.addChild(obj.name, obj);

            obj = new Radio("rdrcvProcRst","stcSvcYn:8.00","1199","250","24",null,null,null,null,null,null,this);
            obj.set_taborder("19");
            ...
            obj = new Static("Static00_01_00_00_00_00","0","1228",null,"20","0",null,null,null,null,null,this);
            obj.set_taborder("69");
            obj.set_background("rgba(173,142,219,0.4)");
            obj.set_text("20");
            obj.set_textAlign("center");
            ...
            obj = new Static("stcInfoTitle3_00_01_00_00","0","1245","200","24",null,null,null,null,null,null,this);
            obj.set_taborder("70");
            obj.set_cssclass("sta_WF_gridTitle");
            obj.set_text("작업 후 확인해야 할 사항");
            this.addChild(obj.name, obj);

            obj = new Static("Static33_00_00_01_00_00","0","1270","1820","10",null,null,null,null,null,null,this);
            obj.set_taborder("71");
            obj.set_cssclass("Guide_Color");
            obj.set_visible("false");
            obj.set_background("#e5dbfa");
            ...
            obj = new Grid("grdSub2","0","1280",null,"150","0.00%",null,null,null,null,null,this);
            obj.set_taborder("72");
            ...
            obj = new Button("btnIdentifyDelete",null,"1245","60","24","10",null,null,null,null,null,this);
            obj.set_taborder("73");
            obj.set_text("삭제");
            obj.set_cssclass("btn_WF_del");
            this.addChild(obj.name, obj);

            obj = new Button("btnIdentifyAdd",null,"1245","60","24","75",null,null,null,null,null,this);
            obj.set_taborder("74");
            obj.set_text("추가");
            obj.set_cssclass("btn_WF_add");
            this.addChild(obj.name, obj);

            obj = new Static("Static21_00_01","0","1430",null,"120","0",null,null,null,null,null,this);
            obj.set_taborder("75");
            obj.set_cssclass("sta_WF_inputBg");
            this.addChild(obj.name, obj);

            obj = new Static("stcJobCont00","0","1430","130","120",null,null,null,null,null,null,this);
            obj.set_taborder("76");
            obj.set_text("점검내용");
            obj.set_cssclass("sta_WF_inputTitle_E");
            this.addChild(obj.name, obj);

            obj = new TextArea("txachkDesc","134.00","1435",null,null,"5","5",null,null,null,null,this);
            obj.set_taborder("20");
            ...
            //-- Default Layout : this
            obj = new Layout("default","",1820,1550,this,function(p){});
        ...
        // User Script
        this.addIncludeScript("SR5003_D04.xfdl","lib::lib_WorkFlow.xjs");
        this.registerScript("SR5003_D04.xfdl", function() {
        /***********************************************************************************
        * 화면 ID	︰ SR5003_D04
        * 화면(명)	︰ 시스템작업계획서(서버)
        * 메뉴(경로)	︰
        ...
        ***********************************************************************************/
        ...
        this.fn_initDataset = function()
        {
        	if( this.dsCond.getColumn(0, "REQ_ID").indexOf("REQ") > -1 )
        	{
        		...
        		this.dsWfSrm.setColumn(0, "REQ_ID2", "REQC0CA0");
        ...
        this.fnSvcStaffMng = function()
        {
        	...
        	this.dsStaff.setColumn(0, "BSE_LVL2_CD", "SPA05201S"); 	// 시스템작업계획서(서버)
        ...
        this.loadIncludeScript("SR5003_D04.xfdl");
