(function()
{
    return function()
    {
        ...
        {
            this.set_name("SR5013_D01");
            this.set_titletext("점검일지");
        ...
        // User Script
        this.addIncludeScript("SR5013_D01.xfdl","lib::lib_WorkFlow.xjs");
        this.registerScript("SR5013_D01.xfdl", function() {
        /***********************************************************************************
        * 화면 ID	︰ SR5013_D01
        * 화면(명)	︰ 점검일지
        * 메뉴(경로)	︰
        ...
        ***********************************************************************************/
        ...
        this.fnSvcStaffMng = function()
        {
        	...
        	//this.dsWfSrm.setColumn(0, "BSE_LVL2_CD", "SPA05224"); 	// AS-IS에서는 SPA05224로 보내고있음 DB상에 테이터가 없어서 추후 확인필요
        ...
        this.loadIncludeScript("SR5013_D01.xfdl");
