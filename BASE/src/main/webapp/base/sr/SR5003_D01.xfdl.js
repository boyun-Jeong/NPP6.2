(function()
{
    return function()
    {
        ...
        {
            this.set_name("SR5003_D01");
            this.set_titletext("시스템작업계획서(보안)");
            if (Form == this.constructor)
            {
                this._setFormPosition(1820,1551);
            }
            ...
            obj = new Static("Static33_00_00_01","0","830","1820","10",null,null,null,null,null,null,this);
            obj.set_taborder("56");
            obj.set_cssclass("Guide_Color");
            obj.set_visible("false");
            obj.set_background("#e5dbfa");
            ...
            obj = new Static("stcInfoTitle3_00_01_00_00","0","1246","200","24",null,null,null,null,null,null,this);
            obj.set_taborder("70");
            obj.set_cssclass("sta_WF_gridTitle");
            obj.set_text("작업 후 확인해야 할 사항");
            this.addChild(obj.name, obj);

            obj = new Static("Static33_00_00_01_00_00","0","1271","1820","10",null,null,null,null,null,null,this);
            obj.set_taborder("71");
            obj.set_cssclass("Guide_Color");
            obj.set_visible("false");
            obj.set_background("#e5dbfa");
            ...
            obj = new Grid("grdSub2","0","1281",null,"150","0.00%",null,null,null,null,null,this);
            obj.set_taborder("72");
            ...
            obj = new Button("btnIdentifyDelete",null,"1246","60","24","10",null,null,null,null,null,this);
            obj.set_taborder("73");
            obj.set_text("삭제");
            obj.set_cssclass("btn_WF_del");
            this.addChild(obj.name, obj);

            obj = new Button("btnIdentifyAdd",null,"1246","60","24","75",null,null,null,null,null,this);
            obj.set_taborder("74");
            obj.set_text("추가");
            obj.set_cssclass("btn_WF_add");
            this.addChild(obj.name, obj);

            obj = new Static("Static21_00_01","0","1431",null,"120","0",null,null,null,null,null,this);
            obj.set_taborder("75");
            obj.set_cssclass("sta_WF_inputBg");
            this.addChild(obj.name, obj);

            obj = new Static("stcJobCont00","0","1431","130","120",null,null,null,null,null,null,this);
            obj.set_taborder("76");
            obj.set_text("점검내용");
            obj.set_cssclass("sta_WF_inputTitle_E");
            this.addChild(obj.name, obj);

            obj = new TextArea("txachkDesc","134.00","1436",null,null,"5","5",null,null,null,null,this);
            obj.set_taborder("20");
            ...
            //-- Default Layout : this
            obj = new Layout("default","",1820,1551,this,function(p){});
        ...
        // User Script
        this.addIncludeScript("SR5003_D01.xfdl","lib::lib_WorkFlow.xjs");
        this.registerScript("SR5003_D01.xfdl", function() {
        /***********************************************************************************
        * 화면 ID	︰ SR5003_D01
        * 화면(명)	︰ 시스템작업계획서(보안)
        * 메뉴(경로)	︰
        ...
        ***********************************************************************************/
        ...
        this.fn_initDataset = function()
        {
        	if( this.dsCond.getColumn(0, "REQ_ID").indexOf("REQ") > -1 )
        	{
        		...
        		this.dsWfSrm.setColumn(0, "REQ_ID2", "REQC0CC0");
        ...
        this.fnSaveCheck = function(isReg)
        {
        	...
        	if(this.reqInfo.WF_PROC_CD == "WF_PROC_1000")
        	{
        		...
        		for(i = 0; i < nRowCnt; i++)
        		{
        			...
        			{
        				var param = {
        					  msg	: "세부작업내용 " + (i.valueOf() + 1) + "행의 일자 확인하시기 바랍니다."	//메시지 내용
        					, arrparam : []						//메시지의 변수에 들어갈 실제값
        					, msgtype : "E"						//메시지 타입 '' : [No icon]아이콘 없는 기본 alert, 'I' : [Info]일반 alert, 'W' : [Warning]경고 Alert, 'S' : [Success]성공 alert(저장 등에 사용)&#13;
        				};
        				Ex.core.alert(this, param);
        ...
        this.fnSvcStaffMng = function()
        {
        	...
        	this.dsStaff.setColumn(0, "BSE_LVL2_CD", "SPA05201"); 	// 시스템작업계획서(보안)
        ...
        this.on_initEvent = function()
        {
            ...
            this.grdSub1.addEventHandler("oncellclick",this.grdOnCellClick,this);
            this.stcSvcYn.addEventHandler("onclick",this.stcProblemCode00_onclick,this);
            this.grdSub2.addEventHandler("oncellclick",this.grdOnCellClick,this);
            ...
            this.dsSrSysWorkPlan.addEventHandler("oncolumnchanged",this.dsOnColumnChanged,this);
            this.dsSrSysWorkPlanSub1.addEventHandler("oncolumnchanged",this.dsOnColumnChanged,this);
            this.dsSrSysWorkPlanSub2.addEventHandler("oncolumnchanged",this.dsOnColumnChanged,this);
            this.dsSrSysWorkPlanSub3.addEventHandler("oncolumnchanged",this.dsOnColumnChanged,this);
        };
        this.loadIncludeScript("SR5003_D01.xfdl");
