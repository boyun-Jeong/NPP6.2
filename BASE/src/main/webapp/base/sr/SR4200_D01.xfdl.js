(function()
{
    return function()
    {
        ...
        {
            this.set_name("SR4200_D01");
            this.set_titletext("문제등록-변경");
            ...
            obj = new Static("sta_title","0","0","100","24",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("문제 등록");
            ...
            obj = new Static("stcProblemCode","cboUpmu3:130.00%","34","130","34",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("문제범주");
            obj.set_cssclass("sta_WF_inputTitle_E");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("stc00","sta_title:35.00","0","312","24",null,null,null,null,null,null,this);
            obj.set_taborder("20");
            ...
            obj = new Button("btnWriteSRM","stc00:5.00","0","115","24",null,null,null,null,null,null,this);
            obj.set_taborder("21");
        ...
        // User Script
        this.addIncludeScript("SR4200_D01.xfdl","lib::lib_WorkFlow.xjs");
        this.registerScript("SR4200_D01.xfdl", function() {
        /***********************************************************************************
        * 화면 ID	︰ SR4100_D01
        * 화면(명)	︰ 문제등록
        * 메뉴(경로)	︰
        ...
        ***********************************************************************************/
        ...
        this.isUpdateForm = function()
        {
        	...
        	this.dsWfPbm.setColumn(0, "REQ_USER_JBC_POSI",  Ex.util.getSession("gvPosNm") ); // 요청자직챙
        	this.dsWfPbm.setColumn(0, "SR_BRIEF",  this.dsSrBaseInfo.getColumn(0, "TITLE")); // 희망완료일시
        	this.dsWfPbm.setColumn(0, "REQ_WISH_SDT",  this.dsSrBaseInfo.getColumn(0, "REQ_WISH_TIME")); // 희망완료일시
        	...
        	if(e.columnid == "UPMU_ID1" || e.columnid == "UPMU_ID2")
        	{
        		...
        		if( !Ex.isEmpty(e.newvalue) )
        		{
        			...
        			if(e.columnid == "UPMU_ID1")
        			{
        				...
        				if(this.isEnterKey == "Y2"){
        					this.cboUpmu3.set_text(Ex.core.word(""));
        					this.cboUpmu3.setFocus();
        					this.isEnterKey = "N";
        				}
        			}
        			//}
        ...
        this.loadIncludeScript("SR4200_D01.xfdl");
