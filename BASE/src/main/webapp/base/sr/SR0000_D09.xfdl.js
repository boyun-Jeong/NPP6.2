(function()
{
    return function()
    {
        ...
        {
            this.set_name("SR0000_D09");
            this.set_titletext("요청정보-기본-비상");
        ...
        // User Script
        this.registerScript("SR0000_D09.xfdl", function() {
        /***********************************************************************************
        * 화면 ID	︰ SR0000_D04
        ...
        ***********************************************************************************/
        	...
        	switch (sSvcId)
        	{
        		...
        		case "select01" :
        			...
        			if(this.dsSrBaseInfo.getColumn(0, "ROWFLAG") == "I")
        			{
        				...
        				this.dsSrBaseInfo.setColumn(0, "REQ_WISH_DT", Ex.util.today());
        ...
        this.loadIncludeScript("SR0000_D09.xfdl");
