(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("요청정보-계약서신청 기본");
            ...
            obj = new Static("stcLabel06","25%","67","114","34",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("요청서명");
            obj.set_cssclass("sta_WF_inputTitle");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("edtReqDept","stcReqUserNm00:5.00","72",null,"24","stcReqDesc:5",null,null,null,null,null,this);
            obj.set_taborder("18");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_cssclass("edt_WF_normal");
            ...
            obj = new Edit("edtReqTitle","stcReqTitle:5.00","105",null,"24","stcReqDesc:5",null,null,null,null,null,this);
            obj.set_taborder("19");
            obj.set_validationGroup("group01");
            ...
            obj = new Static("stcReqUserNm","50.00%","100","114","34",null,null,null,null,null,null,this);
            obj.set_taborder("25");
            obj.set_text("작성자");
            obj.set_cssclass("sta_WF_inputTitle");
            obj.set_visible("false");
        ...
        // User Script
        this.registerScript("SR0000_D07.xfdl", function() {
        /***********************************************************************************
        * 화면 ID		︰ SR0110_D
        * 화면(명)		︰ 요청서 등록
        * 메뉴(경로)	︰ 공통
        		...
        		case "select01" :
        			...
        			else
        			{
        				...
        				this.edtWfProcNm.set_value(
        					!Ex.isEmpty(this.dsSrBaseInfo.getColumn(0, "WF_PROC_NM"))?this.dsSrBaseInfo.getColumn(0, "WF_PROC_NM"):'' +
        ...
        */
        ...
        this.loadIncludeScript("SR0000_D07.xfdl");
