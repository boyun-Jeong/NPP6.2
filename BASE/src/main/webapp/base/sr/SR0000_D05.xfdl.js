(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("stcReqReason","0","100","100","102",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("내용");
            obj.set_cssclass("sta_WF_inputTitle_E");
            this.addChild(obj.name, obj);

            obj = new Static("stcReqDesc","50.00%","100","100",null,null,"0",null,null,null,null,this);
            obj.set_taborder("21");
            obj.set_text("작성요령");
            obj.set_cssclass("sta_WF_inputTitle");
            this.addChild(obj.name, obj);
            ...
            obj = new WebView("wevReqDesc","stcReqDesc:5","105",null,null,"5","4",null,null,null,null,this);
            obj.set_taborder("22");
            obj.set_url("html/htmlViewer.html");
            this.addChild(obj.name, obj);

            obj = new Button("btnHelp","stcReqDesc:-95","stcReqDesc:-42","55","24",null,null,null,null,null,null,this);
            obj.set_taborder("23");
            obj.set_text("도움말");
        ...
        // User Script
        this.registerScript("SR0000_D05.xfdl", function() {
        /***********************************************************************************
        * 화면 ID	︰ SR0000_D04
        ...
        ***********************************************************************************/
        ...
        this.doChgWishDt = function(obj,e)
        {
          	...
          	trace("selecToday :  "+selecToday);

          	if(selecToday <  nexacro.toNumber(Ex.util.today()))
          	{
          		var param = {id : "", msg : "완료희망일은 오늘날짜보다 크거나 같아야합니다."};
        		Ex.core.alert(this, param);
        ...
        this.on_initEvent = function()
        {
            ...
            this.calReqWishDt.addEventHandler("onchanged",this.doChgWishDt,this);
        ...
        this.loadIncludeScript("SR0000_D05.xfdl");
