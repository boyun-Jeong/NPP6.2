(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("담당자 처리");
            if (Form == this.constructor)
            {
                this._setFormPosition(1280,210);
            }
            ...
            obj = new Grid("grdList","0","34",null,"176","0.00%",null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1280,210,this,function(p){});
        ...
        // User Script
        this.addIncludeScript("SR5000_D06.xfdl","lib::lib_WorkFlow.xjs");
        this.registerScript("SR5000_D06.xfdl", function() {
        /***********************************************************************************
        * 화면 ID	︰ SR5016_D03
        * 화면(명)	︰ 담당자 처리
        * 메뉴(경로)	︰ 공통
        ...
        ***********************************************************************************/
        ...
        this.fnAdd = function(objDs)
        {
        	...
        	//this.dsWfChmWorkHist.setColumn(rowPos, "ROWFLAG", "I");
        	...
        	switch (sSvcId)
        	{
        		case "select" :
        				...
        				(this.reqInfo.SAVE_BTN_YN == "Y" || this.reqInfo.REV_BTN_YN == "Y") )
        			{
        				...
        				this.dsWfChmWorkHist.setColumn(0, "DEV_USER_ID", Ex.util.getSession('gvUserNm'));
        			}
        			break;

        		case "selectSrmTarget" :
        			this.gfnFormOnLoad(this, this.fnInit);
        			break;
        	}
        }
        ...
        this.fnCompInit = function()
        {
        	...
        	if(this.dsWfSrm.getColumn(0, "EM_YN") == "1")
        	{
        		...
        		obj.parent.set_width(0);
        		obj.parent.set_height(0);
        	};
        	...
        	{
        		// 랜더링 이후 이벤트
        		//this.reqInfo.PARENT_FORM.components["divBottomButton"].form.btnSave
        		//this.reqInfo.PARENT_FORM.components["divBottomButton"].form.btnScrnRtn.set_visible(false);

        		this.reqInfo.PARENT_FORM.components["divBottomSub"].form.btnRelationId.set_visible(true); // 연관ID조회
        		//this.reqInfo.PARENT_FORM.components["divBottomButton"].form.btnRev.set_visible(false); 	  // 승인,처리
        		//this.reqInfo.PARENT_FORM.components["divBottomButton"].form.btnCancel.set_visible(false); // 회수
        		//this.reqInfo.PARENT_FORM.components["divBottomSub"].form.btnChkList.set_visible(true); // 체크리스트 TODO 앞에서 열어줘야함

        		// 반려 TODO 테스트후 적용. 반려가 2가지
        		//this.reqInfo.PARENT_FORM.components["divBottomButton"].form.btnRtn.set_visible(false);
        		//this.reqInfo.PARENT_FORM.components["divBottomButton"].form.btnScrnRtn.set_visible(false);
        ...
        this.loadIncludeScript("SR5000_D06.xfdl");
