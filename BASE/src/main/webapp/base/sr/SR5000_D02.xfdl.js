(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("stcBg","0","66",null,"80","0",null,null,null,null,null,this.divContent.form);
            obj.set_taborder("0");
            obj.set_cssclass("sta_WF_inputBg");
            obj.set_text("");
            this.divContent.addChild(obj.name, obj);

            obj = new Static("stcOpinion","0","66","130","80",null,null,null,null,null,null,this.divContent.form);
            ...
            obj = new Static("Static04","50%","0","130","34",null,null,null,null,null,null,this.divContent.form);
            obj.set_taborder("4");
            obj.set_text("접수일시");
            obj.set_cssclass("sta_WF_inputTitle");
            obj.set_visible("true");
            ...
            obj = new TextArea("txaOpinion","stcOpinion:5","71",null,null,"5","5",null,null,null,null,this.divContent.form);
            obj.set_taborder("7");
            ...
            obj = new Static("stcCont","0.00%","33","130","34",null,null,null,null,null,null,this.divContent.form);
            obj.set_taborder("9");
            obj.set_cssclass("sta_WF_inputTitle");
            obj.set_text("내용");
            this.divContent.addChild(obj.name, obj);

            obj = new Combo("cboContSelect","stcCont:5","39","760","24",null,null,null,null,null,null,this.divContent.form);
            obj.set_taborder("10");
            obj.set_cssclass("cbo_WF_normal");
            obj.set_innerdataset("dsCont");
            obj.set_codecolumn("CMM_CD");
            obj.set_datacolumn("CMM_CD_DESC");
            obj.set_type("filterlike");
            obj.set_text("");
            this.divContent.addChild(obj.name, obj);

            obj = new Static("stcCodeInfo","cboContSelect:10.00","39","209","20",null,null,null,null,null,null,this.divContent.form);
            obj.set_taborder("11");
            obj.set_text("공통코드 [워크플로우 > QA검토의견]");
            this.divContent.addChild(obj.name, obj);

            obj = new Static("stcTitle","2.00","0","129","24",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("QA 검토의견");
            obj.set_cssclass("sta_WF_gridTitle");
            ...
            obj = new BindItem("item0","divContent.form.txaOpinion","value","dsWfSrm","BA1_EXAM_OPIN");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item2","divContent.form.edtUserNm","value","dsWfSrm","BA1_USER_NM");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item4","divContent.form.stcCont","value","dsWfSrm","WORK_USER_ID");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("SR5000_D02.xfdl","lib::lib_WorkFlow.xjs");
        this.registerScript("SR5000_D02.xfdl", function() {
        /***********************************************************************************
        * 화면(ID)	︰ SR0010_D02
        * 화면(명)	︰ 접수의견 공통
        * 메뉴(경로)	︰ 공통
        ...
        ***********************************************************************************/
        ...
        {
        	var oParam = {
        		 upCmmCd	: ['QA_CONT_CD']	// 조회할 상위코드
        		,codeDiv	: ['WORKFLOW_CD']	// 조회할 코드의 업무구분
        		,optStr		: ['SEL']			// ALL: '- 전체 -'; SEL: '- 선택 -'
        		,useYn		: ['Y']				// 사용여부
        		,filter		: ['']				// filterStr
        		,objDs		: [ this.dsCont]	// copy dataset
        	}
        	Ex.util.getCmmCode(oParam);	// 공통코드 getter util; (oParam);
        	this.dsCont.setColumn(0, "CMM_CD_DESC", this.dsCont.getColumn(0, "CMM_CD_NM"));
        }
        	...
        	switch (sSvcId)
        	{
        		case "select" :
        				...
        				(this.reqInfo.SAVE_BTN_YN == "Y" || this.reqInfo.REV_BTN_YN == "Y") )
        			{
        				...
        				this.dsWfSrm.setColumn(0, "BA1_USER_ID", Ex.util.getSession('gvUserId'));
        				this.dsWfSrm.setColumn(0, "BA1_USER_NM", Ex.util.getSession('gvUserNm'));
        			}
        			break;
        	}
        }
        ...
        this.isUpdateForm = function()
        {
        	if(	this.reqInfo.WF_PROC_CD == this.reqInfo.SCRN_WF_PROC_CD && this.reqInfo.WF_FUNC_CD == "WF_FUNC_04" &&
        		(this.reqInfo.SAVE_BTN_YN == "Y" || this.reqInfo.REV_BTN_YN == "Y") )
        	{
        		this.dsWfSrm.setColumn(0, "BA1_RECP_DATE", undefined);
        	}
        ...
        this.fnSaveCheck = function(isReg)
        {
        	...
        	if(this.reqInfo.WF_PROC_CD == this.reqInfo.SCRN_WF_PROC_CD && this.parent.editYn == "Y")
        	{
        		if( Ex.isEmpty(this.dsWfSrm.getColumn(0,"BA1_EXAM_OPIN")) )
        		{
        			var param = {
        				  id	: "txaOpinion"
        ...
        this.divContent_cboContSelect_onitemchanged = function(obj,e)
        {
        	if( !Ex.isEmpty(this.divContent.form.cboContSelect.value) )
        	{
        		this.divContent.form.txaOpinion.set_value(this.dsCont.getColumn(e.postindex, "CMM_CD_DESC"));
        	}
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.divContent.form.cboContSelect.addEventHandler("onitemchanged",this.divContent_cboContSelect_onitemchanged,this);
            ...
            this.dsCont.addEventHandler("oncolumnchanged",this.dsOnColumnChanged,this);
        };
        this.loadIncludeScript("SR5000_D02.xfdl");
