(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            {
                this._setFormPosition(1000,1530);
            }
            ...
            obj = new Div("divContents","0.00","-10",null,null,"0","60",null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("");
            ...
            obj = new Div("divFiles","20.00","1157",null,"179","20",null,null,null,null,null,this.divContents.form);
            obj.set_taborder("12");
            ...
            obj = new Div("divGrdTopBtn","85.50%","649",null,"24","15",null,null,null,null,null,this.divContents.form);
            obj.set_taborder("25");
            ...
            obj = new Static("Static32_00","20","903","100","24",null,null,null,null,null,null,this.divContents.form);
            obj.set_taborder("38");
            obj.set_text("불참자 목록");
            obj.set_cssclass("sta_WF_gridTitle");
            this.divContents.addChild(obj.name, obj);

            obj = new Div("divGrdTopBtnS",null,"903","130","24","15",null,null,null,null,null,this.divContents.form);
            obj.set_taborder("26");
            obj.set_visible("true");
            obj.set_isButtonGroup("true");
            this.divContents.addChild(obj.name, obj);
            ...
            obj = new Static("stcBotMargin","20","grdMeetAttnd:0",null,"20","15",null,null,null,null,null,this.divContents.form);
            obj.set_taborder("29");
            ...
            obj = new Edit("edtTitle00","stcTitleSub:5","86","350","24",null,null,null,null,null,null,this.divContents.form);
            obj.set_taborder("2");
            obj.getSetter("validate").set("");
            ...
            obj = new Grid("grdMeetAttndS","20","937",null,"200","15",null,null,null,null,null,this.divContents.form);
            obj.set_taborder("37");
            obj.getSetter("useinputpanel").set("false");
            obj.set_binddataset("dsAttndS");
            obj.set_autofittype("col");
            obj.set_cssclass("grd_WF_normal");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\" band=\"left\"/><Column size=\"40\" band=\"left\"/><Column size=\"60\" band=\"left\"/><Column size=\"100\"/><Column size=\"70\"/><Column size=\"80\"/><Column size=\"400\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"32\"/></Rows><Band id=\"head\"><Cell text=\"NO\"/><Cell col=\"1\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"2\" text=\"행상태\"/><Cell col=\"3\" text=\"부서\"/><Cell col=\"4\" text=\"이름\"/><Cell col=\"5\" text=\"확인시간\"/><Cell col=\"6\" text=\"검토의견\"/></Band><Band id=\"body\"><Cell expr=\"currow+1\"/><Cell col=\"1\" text=\"bind:CHK\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"2\" text=\"bind:ROWFLAG\"/><Cell col=\"3\" style=\"align:left;\" text=\"bind:ATN_USER_DEPT\" textAlign=\"left\"/><Cell col=\"4\" text=\"bind:ATN_USER_NM\"/><Cell col=\"5\"/><Cell col=\"6\"/></Band></Format></Formats>");
            this.divContents.addChild(obj.name, obj);
            ...
            obj = new Static("Static28_00_00_00","50.30%","82","110","34",null,null,null,null,null,null,this.divContents.form);
            obj.set_taborder("40");
            obj.set_cssclass("sta_WF_inputTitle_E");
            obj.set_text("회의종류");
            this.divContents.addChild(obj.name, obj);

            obj = new Combo("cboMeetTypeCd","Static28_00_00_00:5","87","90","24",null,null,null,null,null,null,this.divContents.form);
            obj.set_taborder("3");
            ...
            obj = new Static("stcBackMid2_00_00_00_01","20.00","927",null,"10","15",null,null,null,null,null,this.divContents.form);
            obj.set_taborder("41");
            obj.set_background("rgba(173,142,219,0.4)");
            obj.set_text("10");
            obj.set_textAlign("center");
            ...
            obj = new Static("stcBotMargin00","20.00","grdMeetAttndS:0",null,"20","15",null,null,null,null,null,this.divContents.form);
            obj.set_taborder("42");
            obj.set_background("#e5dbfa");
            obj.set_text("20");
            obj.set_textAlign("center");
            ...
            //-- Default Layout : this
            obj = new Layout("default","",1000,1530,this,function(p){});
        ...
        // User Script
        this.addIncludeScript("SR5000_P03.xfdl","lib::lib_AmComm.xjs");
        this.registerScript("SR5000_P03.xfdl", function() {
        /***********************************************************************************
        * 화면(ID)	︰ SR5000_P03
        * 화면(명)	︰ 회의상세
        * 화면 설명	︰
        ...
        ***********************************************************************************/
        ...
        this.fnCallback = function (sSvcId, nErrorCode, sErrorMsg)
        {
        	...
        	switch (sSvcId)
        	{
        		case "select01" :
        			...
        			if((this.dsData.getColumn(0, "FRID") != null) && this.dsData.getColumn(0, "FRID") == Ex.util.getSession("gvUserId")){
        				this.divContents.form.divWebEditor.form.initCreate();
        			} else {
        				this.divContents.form.divWebEditor.form.initCreate(true);
        				this.divContents.form.divGrdTopBtnS.form.btnAddS.set_visible(false);
        				this.divContents.form.divGrdTopBtnS.form.btnDeleteS.set_visible(false);
        			}
        		...
        		case "select02" :
        			...
        			// 검토의견 활성화
        			this.divContents.form.grdMeetAttnd.set_enable(true);
        			this.divContents.form.grdMeetAttnd.setCellProperty("body", 6, "edittype", "expr:ATN_USER_ID == Ex.util.getSession('gvUserId') ? 'text':'none'");
        			break;
        ...
        this.fnCompInit = function()
        {
        	...
        	var arrBtn = [this.divContents.form.divGrdTopBtn.form.btnAdd];	// 참석자목록
        	Ex.util.setBtnVisible(this, 'write', arrBtn);

        	arrBtn = [this.divContents.form.divGrdTopBtn.form.btnDelete];	// 참석자목록
        	Ex.util.setBtnVisible(this, 'delete', arrBtn);

        	arrBtn = [this.divContents.form.divGrdTopBtnS.form.btnAddS];	// 불참자목록
        	Ex.util.setBtnVisible(this, 'write', arrBtn);

        	arrBtn = [this.divContents.form.divGrdTopBtnS.form.btnDeleteS];	// 불참자목록
        	Ex.util.setBtnVisible(this, 'delete', arrBtn);
        ...
        // 	Ex.util.setBtnVisible(this, 'save', arrBtn);
        	...
        	switch(this.pPopType)
        	{
        		...
        		case "I" :
        			...
        			// 회의일자
        			this.divContents.form.calMeetDate.set_value( Ex.util.today() );			//날짜
        			//this.divContents.form.mskMeetStime.set_value( Ex.util.todayTime().substring(8, 12) );	//시작시간
        			//this.divContents.form.mskMeetEtime.set_value( Ex.util.todayTime().substring(8, 12) );	//종료시간
        			//this.divContents.form.mskMeetEtime.set_value( hourStr+""+minStr);

        			this.divContents.form.mskMeetStime.set_value(sHour.getHours() +""+ "00");
        			this.divContents.form.mskMeetEtime.set_value(eHour.getHours() +""+ "00");
        ...
        this.fnGetCmmCd = function()
        {
        	var oParam = {
        		...
        		,codeDiv: ['IT_WKREQ_CD',		'CMM_CD']	// 조회할 코드의 업무구분
        ...
        this.on_initEvent = function()
        {
            ...
            this.divContents.form.cboMeetTypeCd.addEventHandler("onlbuttondown",this.cboUpmu1_onlbuttondown,this);
            this.divContents.form.cboMeetTypeCd.addEventHandler("onkillfocus",this.cboUpmu1_onkillfocus,this);
        ...
        this.loadIncludeScript("SR5000_P03.xfdl");
