(function()
{
    return function()
    {
        ...
        {
            this.set_name("SR5017_D04");
            this.set_titletext("사전검토");
            ...
            obj._setContents("<ColumnInfo><Column id=\"REQ_ID\" type=\"STRING\" size=\"256\"/><Column id=\"WF_PROC_CD\" type=\"STRING\" size=\"256\"/><Column id=\"REQ_TMPLAT_ID\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            ...
            obj = new Static("Static04",null,"0","130","34","20.58%",null,null,null,null,null,this.divContent.form);
            obj.set_taborder("6");
            obj.set_text("접수일시");
            obj.set_cssclass("sta_WF_inputTitle");
            obj.set_visible("true");
            ...
            obj = new MaskEdit("mskProcDate","Static04:4.00","5","150","24",null,null,null,null,null,null,this.divContent.form);
            obj.set_taborder("8");
            obj.set_type("string");
            ...
            obj.set_validation("사전검토의견;NULL");
            obj.set_imemode("hangul");
            obj.set_text("");
            this.divContent.addChild(obj.name, obj);

            obj = new Static("stcSvcRequstYn","33.00%","0","130","34",null,null,null,null,null,null,this.divContent.form);
            obj.set_taborder("9");
            obj.set_text("요청구분");
            obj.set_cssclass("sta_WF_inputTitle");
            obj.set_visible("true");
            ...
            obj = new Radio("rdSvcYn","stcSvcRequstYn:10.00","5","282","24",null,null,null,null,null,null,this.divContent.form);
            obj.set_taborder("1");
            obj.set_codecolumn("CMM_CD");
            obj.set_datacolumn("CMM_CD_NM");
            obj.set_direction("vertical");
            obj.set_validation("요청구분;NULL");
            obj.set_validationGroup("input01");
            obj.set_enable("true");
            ...
            obj = new Static("stc00","stcSvcRequstYn:29.00","4","120","26",null,null,null,null,null,null,this.divContent.form);
            obj.set_taborder("10");
            ...
            obj = new Static("stcTitle","0","0","95","24",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("사전검토");
            obj.set_cssclass("sta_WF_gridTitle");
            ...
            obj = new Static("sta_title00","stcTitle:0","0","515","24",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            this.addChild(obj.name, obj);
            // Layout Functions
            ...
            obj = new BindItem("item0","divContent.form.txaOpinion","value","dsWfSrm","PRE_CONF_EXAM_OPIN");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item2","divContent.form.edtUserNm","value","dsWfSrm","PRE_CONF_USER_NM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","divContent.form.mskProcDate","value","dsWfSrm","PRE_CONF_RECP_DATE");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item4","divContent.form.stcSvcRequstYn","value","dsWfSrm","SITE_RECP_DATE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","divContent.form.rdSvcYn","value","dsWfSrm","SR_YN");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("SR5017_D04.xfdl", function() {
        /***********************************************************************************
        * 화면(ID)	︰ SR5000_D04
        * 화면(명)	︰ 사전검토
        * 메뉴(경로)	︰ 공통
        ...
        ***********************************************************************************/
        ...
        this.fnInit = function()
        {
        	...
        	// 신규,변경건에 대해서만 변경이관 선택처리
        	if(this.getOwnerFrame().pREQ_TMPLAT_ID == "WFT250048" || this.getOwnerFrame().pREQ_TMPLAT_ID == "WFT250048")
        	{
        		this.divContent.form.rdSvcYn.set_enable(false);
        		this.divContent.form.rdSvcYn.set_value("N");
        	}

        	this.sta_title00.set_usedecorate(true);
        	this.sta_title00.set_text("※ 배포가 필요없는 업무(시스템작업서 등)는 < <fc v='red'>일반요청</fc> >을 선택하세요");
        }
        ...
        this.fnMsgAfter = function(mID,varValue)
        {
        	...
        	switch(mID)
        	{
        		...
        		case "rdSvcYn" :
        			this.divContent.form.rdSvcYn.setFocus();
        			break;
        ...
        this.isUpdateForm = function()
        {
        	if(	this.reqInfo.WF_PROC_CD == this.reqInfo.SCRN_WF_PROC_CD && this.reqInfo.WF_FUNC_CD == "WF_FUNC_04" &&
        		(this.reqInfo.SAVE_BTN_YN == "Y" || this.reqInfo.REV_BTN_YN == "Y") )
        	{
        		this.dsWfSrm.setColumn(0, "PRE_CONF_RECP_DATE", undefined);
        	}
        ...
        this.fnSaveCheck = function(isReg)
        {
        	...
        	if(this.reqInfo.WF_PROC_CD == "WF_PROC_2010")
        	{	// 사전검토
        		if( Ex.isEmpty(this.dsWfSrm.getColumn(0,"SR_YN")) )
        		{
        			var param = {
        				  id	: "rdSvcYn"
        				, msg	: "요청구분을 선택하시기 바랍니다."		//메시지 내용
        		...
        		if( Ex.isEmpty(this.dsWfSrm.getColumn(0,"PRE_CONF_EXAM_OPIN")) )
        		{
        			var param = {
        				  id	: "txaOpinion"
        				, msg	: "사전검토의견을 작성하시기 바랍니다."	//메시지 내용
        				, arrparam : []						//메시지의 변수에 들어갈 실제값
        				, msgtype : "E"						//메시지 타입 '' : [No icon]아이콘 없는 기본 alert, 'I' : [Info]일반 alert, 'W' : [Warning]경고 Alert, 'S' : [Success]성공 alert(저장 등에 사용)&#13;
        			};
        			Ex.core.alert(this, param);
        ...
        {
        	this.divContent.form.rdSvcYn.set_value("Y");
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.divContent.form.rdSvcYn.addEventHandler("onitemchanged",this.divContent_rdSvcYn_onitemchanged,this);
            this.divContent.form.stc00.addEventHandler("onclick",this.divContent_stc00_onclick,this);
        ...
        this.loadIncludeScript("SR5017_D04.xfdl");
