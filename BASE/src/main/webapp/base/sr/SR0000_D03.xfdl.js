(function()
{
    return function()
    {
        ...
        {
            this.set_name("SR0000_D02");
            this.set_titletext("요청정보-기본(프로젝트)");
            ...
            obj = new Static("stcReqUserNm","25%","34","114","34",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("요청자");
            obj.set_cssclass("sta_WF_inputTitle");
            this.addChild(obj.name, obj);

            obj = new Static("stcReqDt","50%","34","114","34",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("요청일자");
            ...
            obj = new Static("stcWishComp","75.00%","34","114","34",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("완료희망일자");
            obj.set_cssclass("sta_WF_inputTitle_E");
            obj.set_visible("true");
            ...
            obj = new Calendar("calWishCompDt","stcWishComp:5.00","39","170","24",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            ...
            obj = new Static("stcRegDeptNm00","75.00%","67","114","34",null,null,null,null,null,null,this);
            obj.set_taborder("23");
            obj.set_text("진행단계 및 상태");
            obj.set_cssclass("sta_WF_inputTitle");
            this.addChild(obj.name, obj);

            obj = new Div("divRefReqId","75.00%","100",null,"34","0",null,null,null,null,null,this);
            obj.set_taborder("25");
            obj.set_text("Div00");
            ...
            obj = new Edit("edtReqTitle","stcReqTitle:5.00","105",null,"24","divRefReqId:5",null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_validationGroup("group01");
            ...
            obj = new Edit("edtReqTmplatNm","42.5%","72",null,"24","stcRegDeptNm00:5",null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_cssclass("edt_WF_normal");
            ...
            obj = new Edit("edtSvcNm","stcLabel05:5","72",null,"24","edtReqTmplatNm:2",null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_cssclass("edt_WF_normal");
            ...
            obj = new Calendar("calReqDt","stcReqDt:5","39","170","24",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            ...
            obj = new Edit("edtReqUserNm","stcReqUserNm:5.00","39",null,"24","stcReqDt:5",null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_cssclass("edt_WF_normal");
            ...
            obj = new Edit("edtWfProcNm","stcRegDeptNm00:5.00","72",null,"24","5",null,null,null,null,null,this);
            obj.set_taborder("24");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_cssclass("edt_WF_normal");
            ...
            obj = new Button("btnHelp","stcReqDesc:-109","stcReqDesc:-25","55","24",null,null,null,null,null,null,this);
            obj.set_taborder("28");
            obj.set_text("도움말");
            ...
            obj = new BindItem("item1","divRefReqId.form.edtRefReqId","value","dsSrBaseInfo","REF_REQ_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","divRefReqId.form.divForm.form.btnSearchReqPop","value","dsSrBaseInfo","REF_REQ_ID");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("SR0000_D03.xfdl", function() {
        /***********************************************************************************
        * 화면 ID		︰ SR0110_D
        * 화면(명)		︰ 요청서 등록
        * 메뉴(경로)	︰ 공통
        ...
        ***********************************************************************************/
        	...
        	switch (sSvcId)
        	{
        		case "select01" :
        			...
        			if(this.dsSrBaseInfo.getColumn(0, "ROWFLAG") == "I")
        			{
        				...
        				this.dsSrBaseInfo.setColumn(0, "WF_PROC_CD", this.reqInfo.WF_PROC_CD);
        ...
        {	//trace("SR0000_D02 this.wevReqDesc_onloadcompleted()~~~~~~");
        ...
        this.loadIncludeScript("SR0000_D03.xfdl");
