(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("결재이력(FLOW)조회");
            ...
            obj = new Static("Static00_00_00","295","11","30","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("15");
            obj.set_background("#e5dbfa");
            obj.set_text("30");
            ...
            obj = new Static("stcReqTmplatNm","Static00_00_00:0","13","80","21",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("7");
            obj.set_text("처리ID");
            obj.set_cssclass("sta_WF_schTitle");
            this.divSearchArea.addChild(obj.name, obj);

            obj = new Edit("edtProcNumber","stcReqTmplatNm:0","12","100","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("1");
            obj.set_cssclass("edt_WF_normal");
            this.divSearchArea.addChild(obj.name, obj);

            obj = new Static("Static00_00_00_00","edtProcNumber:0","12","30","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("16");
            obj.set_background("#e5dbfa");
            obj.set_text("30");
            obj.set_textAlign("center");
            ...
            obj = new Static("stcSvcCd","Static00_00_00_00:0","13","80","21",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("6");
            obj.set_text("서비스유형");
            obj.set_cssclass("sta_WF_schTitle");
            this.divSearchArea.addChild(obj.name, obj);
            ...
            obj = new Edit("edtReqTitle","95","12","200","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("2");
            obj.set_cssclass("edt_WF_normal");
            this.divSearchArea.addChild(obj.name, obj);

            obj = new Static("stcReqTitle","Static06:0.00","13","75","21",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("8");
            obj.set_text("제목");
            obj.set_cssclass("sta_WF_schTitle");
            this.divSearchArea.addChild(obj.name, obj);

            obj = new Static("Static00_00_00_00_00","cboSvcCd:0","12","30","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("17");
            obj.set_background("#e5dbfa");
            obj.set_text("30");
            obj.set_textAlign("center");
            ...
            obj = new Calendar("calBeginDate","stcReqStatCd:10.00","12","135","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("14");
            ...
            obj = new Static("Static01_00","calBeginDate:0","12","18","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("12");
            obj.set_text("~");
            obj.set_textAlign("center");
            obj.set_verticalAlign("middle");
            ...
            obj = new Calendar("calEndDate","Static01_00:0","12","135","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("13");
            obj.set_cssclass("cal_WF_normal");
            obj.set_readonly("false");
            obj.set_enable("true");
            ...
            obj = new Static("Static00_00_00_00_00_00","calEndDate:0","12","30","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("18");
            obj.set_background("#e5dbfa");
            obj.set_text("30");
            obj.set_textAlign("center");
            ...
            obj = new Static("stcReqUsertNm00","Static00_00_00_00_00_00:0","13","70","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("10");
            obj.set_text("확인대상");
            obj.set_cssclass("sta_WF_schTitle");
            this.divSearchArea.addChild(obj.name, obj);

            obj = new CheckBox("chkConf","stcReqUsertNm00:0","15","24","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("11");
            ...
            obj = new Static("stcTreeTitle","0","70","145","24",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("FLOW결재이력");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"320\"/><Column size=\"100\"/><Column size=\"150\"/><Column size=\"70\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"120\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"32\"/></Rows><Band id=\"head\"><Cell text=\"NO\"/><Cell col=\"1\" text=\"구분\"/><Cell col=\"2\" text=\"처리ID\"/><Cell col=\"3\" text=\"제목\"/><Cell col=\"4\" text=\"처리자\"/><Cell col=\"5\" text=\"처리일시\"/><Cell col=\"6\" text=\"처리결과\"/><Cell col=\"7\" text=\"대결자\"/><Cell col=\"8\" text=\"현재처리상태\"/><Cell col=\"9\" text=\"처리자본인확인\"/></Band><Band id=\"body\"><Cell text=\"expr:currow+1\"/><Cell col=\"1\" displaytype=\"combotext\" edittype=\"none\" combodataset=\"dsSvcCd\" combodatacol=\"CMM_CD_NM\" combocodecol=\"CMM_CD\" text=\"bind:SVC_CD\"/><Cell col=\"2\" edittype=\"none\" text=\"bind:PROC_NUMBER\"/><Cell col=\"3\" edittype=\"none\" text=\"bind:TITLE\" textAlign=\"left\" cssclass=\"grdBCell_WF_event\"/><Cell col=\"4\" edittype=\"none\" text=\"bind:SRM_USER_NM\"/><Cell col=\"5\" displaytype=\"date\" edittype=\"none\" text=\"bind:REG_STIME\" mask=\"####-##-## ##:##\" calendardateformat=\"yyyy-MM-dd HH:mm:ss\" calendareditformat=\"yyyy-MM-dd HH:mm:ss\"/><Cell col=\"6\" text=\"bind:APPR_STAT_CD\" combodataset=\"dsApprStatCd\" combodatacol=\"CMM_CD_NM\" combocodecol=\"CMM_CD\" displaytype=\"combotext\" edittype=\"none\"/><Cell col=\"7\" edittype=\"none\" text=\"bind:ORG_USER_NM\"/><Cell col=\"8\" text=\"bind:WF_PROC_NM\" displaytype=\"normal\" edittype=\"none\"/><Cell col=\"9\" text=\"bind:DIV_NM\" style=\"align:center;color:EXPR(DIV_NM ==  &quot;본인확인&quot; ? &quot;blue&quot; : &quot;black&quot;); cursor:EXPR(DIV_NM ==  &quot;본인확인&quot; ? &quot;pointer&quot; : &quot;none&quot;);\" cssclass=\"expr:DIV_NM == &apos;본인확인&apos; ? &apos;grdBCell_WF_event&apos; : &apos;&apos;\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item15","div_search.form.Static00_00_01","value","dsCond","USE_DEPT_NM");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("SR0143_W.xfdl","lib::lib_WorkFlow.xjs");
        this.registerScript("SR0143_W.xfdl", function() {
        /***********************************************************************************
        * 화면 ID		︰ SR0143_W
        * 화면(명)		︰ 결재이력(FLOW)
        ...
        ***********************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearchArea.form.edtProcNumber.addEventHandler("onkeydown",this.fnCommOnkeydown,this);
        ...
        this.loadIncludeScript("SR0143_W.xfdl");
