(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("stcRegDeptNm","75.00%","67","114","34",null,null,null,null,null,null,this);
            obj.set_taborder("19");
            obj.set_text("긴급여부");
            obj.set_cssclass("sta_WF_inputTitle");
            this.addChild(obj.name, obj);
            ...
            obj = new Calendar("calWishCompDt","stcWishComp:5","72","115","24",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            ...
            obj = new Combo("cboWishCompTm","calWishCompDt:5","72","76","24",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            ...
            obj = new Edit("edtReqTitle","stcReqTitle:5.00","105",null,"24","325",null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_validationGroup("group01");
            ...
            obj = new CheckBox("CheckBox00","stcRegDeptNm:5","72","13","24",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            ...
            obj = new BindItem("item1","CheckBox00","value","dsSrBaseInfo","REQ_EM_YN");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("SR0000_D02.xfdl", function() {
        /***********************************************************************************
        * 화면 ID		︰ SR0110_D
        * 화면(명)		︰ 요청서 등록
        * 메뉴(경로)	︰ 공통
        ...
        ***********************************************************************************/
        ...
        this.loadIncludeScript("SR0000_D02.xfdl");
