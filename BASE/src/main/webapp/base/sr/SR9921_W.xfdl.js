(function()
{
    return function()
    {
        ...
        {
            this.set_name("SR9921_W");
            this.set_titletext("서비스조회(요청서목록)");
        ...
        // User Script
        this.addIncludeScript("SR9921_W.xfdl","lib::lib_WorkFlow.xjs");
        this.registerScript("SR9921_W.xfdl", function() {
        /***********************************************************************************
        * 화면 ID		︰ SR0120_W
        * 화면(명)		︰ 요청함
        * 메뉴(경로)	︰ 공통
        ...
        ***********************************************************************************/
        ...
        this.fnSearch = function()
        {
            ...
            var sService = "SR9921W/select01";			// 서비스명
        ...
        this.loadIncludeScript("SR9921_W.xfdl");
