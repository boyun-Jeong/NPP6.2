(function()
{
    return function()
    {
        ...
        {
            this.set_name("SR0141_W");
            this.set_titletext("내검토함");
            ...
            obj = new Combo("cboSvcDtlCd","330","13","140","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("1");
            ...
            obj = new Static("stcReqTmplatNm","cboSvcDtlCd:30","14","65","21",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("8");
            obj.set_text("요청서명");
            obj.set_cssclass("sta_WF_schTitle");
            this.divSearchArea.addChild(obj.name, obj);
            ...
            obj = new Edit("edtReqTitle","stcReqTitle:7","13","150","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("3");
            obj.set_cssclass("edt_WF_normal");
            this.divSearchArea.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"100\"/><Column size=\"60\"/><Column size=\"0\"/><Column size=\"90\"/><Column size=\"80\"/><Column size=\"130\"/><Column size=\"220\"/><Column size=\"300\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"100\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"32\"/></Rows><Band id=\"head\"><Cell text=\"요청ID\"/><Cell col=\"1\" text=\"검토여부\"/><Cell col=\"2\" text=\"긴급여부\"/><Cell col=\"3\" text=\"진행단계\"/><Cell col=\"4\" text=\"진행상태\"/><Cell col=\"5\" text=\"요청분류\"/><Cell col=\"6\" text=\"요청서명\"/><Cell col=\"7\" text=\"요청서 제목\"/><Cell col=\"8\" text=\"요청자\"/><Cell col=\"9\" text=\"요청일자\"/><Cell col=\"10\" text=\"희망완료일자\"/></Band><Band id=\"body\"><Cell displaytype=\"text\" text=\"bind:REQ_ID\" cssclass=\"grdBCell_WF_event\"/><Cell col=\"1\" text=\"bind:APPR_STAT_CD\" textDecoration=\"underline\" color=\"blue\" cursor=\"pointer\" displaytype=\"combotext\" combocodecol=\"CMM_CD\" combodatacol=\"CMM_CD_NM\" combodataset=\"dsApprStatCd\"/><Cell col=\"2\" text=\"bind:REQ_EM_YN\"/><Cell col=\"3\" displaytype=\"text\" text=\"bind:WF_PROC_NM\"/><Cell col=\"4\" text=\"bind:REQ_STAT_NM\"/><Cell col=\"5\" text=\"bind:SVC_CD_NM\" displaytype=\"text\"/><Cell col=\"6\" displaytype=\"text\" text=\"bind:REQ_TMPLAT_NM\"/><Cell col=\"7\" displaytype=\"text\" text=\"bind:TITLE\"/><Cell col=\"8\" displaytype=\"text\" text=\"bind:REQ_USER_NM\"/><Cell col=\"9\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd\" text=\"bind:REQ_DATE\" calendareditformat=\"yyyy-MM-dd\"/><Cell col=\"10\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd\" text=\"bind:REQ_WISH_DT_NM\" calendareditformat=\"yyyy-MM-dd\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divGrdTopBtn",null,"70","250","24","0",null,null,null,null,null,this);
            obj.set_taborder("3");
        ...
        // User Script
        this.addIncludeScript("SR0141_W.xfdl","lib::lib_WorkFlow.xjs");
        this.registerScript("SR0141_W.xfdl", function() {
        /***********************************************************************************
        * 화면 ID		︰ SR0141_W
        * 화면(명)		︰ 내검토함
        * 메뉴(경로)	︰ 공통
        ...
        ***********************************************************************************/
        ...
        this.fnSearchReset = function()
        {
        	...
        	this.dsCond.setColumn(0, 'REQ_TMPLAT_NM', "");
        	this.dsCond.setColumn(0, 'TITLE', "");

        	this.dsSvcDtlCd.clearData();
        	var aRow = this.dsSvcDtlCd.addRow();
        	this.dsSvcDtlCd.setColumn(aRow, 'CMM_CD_NM', Ex.core.word('- 전체 -'));
        }
        ...
        {
        	this.dsCond.setColumn(this.dsCond.rowposition, 'SVC_DTL_CD', undefined);
        	this.dsSvcDtlCd.clearData();

        	var upCmmCd = this.dsCond.getColumn(this.dsCond.rowposition, 'SVC_CD') || '';
        	trace("this.div_search_cboSvcCd_onitemchanged() upCmmCd ::: " + upCmmCd);
        ...
        this.grdReqMt_oncellclick = function(obj,e)
        {
        	if(e.row > -1)
        	{
        		...
        		else if(e.col == obj.getBindCellIndex('body', 'APPR_STAT_CD')) {		// 결재 팝업
        			var REQ_ID		= this.dsReqMt.getColumn(this.dsReqMt.rowposition, 'REQ_ID');
        			var WF_PROC_CD	= this.dsReqMt.getColumn(this.dsReqMt.rowposition, 'WF_PROC_CD');

        			Ex.core.popup(this,
        						'apprPop',
        						"sr::SR0141_P01_bak.xfdl",             		// <--- 팝업창 오픈 Url
        						{ title			: '결재 상세정보',
        						  REQ_ID		: REQ_ID,
        						  WF_PROC_CD	: WF_PROC_CD
        						},     	// <--- title및 파라미터(p1,p2는 화면에서 사용할 파라미터 등)
        						"width=750,height=233"                  // <--- width/height/modeless(프레임 처리 옵션)
        			);
        		}
        	}
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.grdReqMt.addEventHandler("onkeyup",this.fnCommOnkeyup,this);
        ...
        this.loadIncludeScript("SR0141_W.xfdl");
