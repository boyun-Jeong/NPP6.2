(function()
{
    return function()
    {
        ...
        {
            this.set_name("SR5015_D03");
            this.set_titletext("전산기기 PL 접수의견");
            ...
            obj = new Static("stcProcUserNm02","33.25%","33","130","34",null,null,null,null,null,null,this.divContent.form);
            obj.set_taborder("13");
            obj.set_text("합의완료일시");
            obj.set_cssclass("sta_WF_inputTitle_E");
            this.divContent.addChild(obj.name, obj);

            obj = new Calendar("calPlanDt","stcProcUserNm02:5.00","39","112","24",null,null,null,null,null,null,this.divContent.form);
            obj.set_taborder("1");
            ...
            obj = new MaskEdit("mskPlanStime","calPlanDt:3.00","39","56","24",null,null,null,null,null,null,this.divContent.form);
            obj.set_taborder("2");
            obj.set_type("string");
            ...
            obj = new TextArea("txaOpinion","stcProcExamOpin:5","71",null,null,"5","5",null,null,null,null,this.divContent.form);
            obj.set_taborder("4");
            ...
            obj = new BindItem("item0","divContent.form.mskProcDate","value","dsWfSrm","APPR_RECP_DATE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","divContent.form.edtUserNm","value","dsWfSrm","APPR_USER_NM");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item8","divContent.form.txaOpinion","value","dsWfSrm","APPR_EXAM_OPIN");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("SR5015_D03.xfdl","lib::lib_WorkFlow.xjs");
        this.registerScript("SR5015_D03.xfdl", function() {
        /***********************************************************************************
        * 화면 ID	︰ SR5015_D03
        * 화면(명)	︰ 전산기기 PL 접수의견
        * 메뉴(경로)	︰
        ...
        ***********************************************************************************/
        		...
        		case "select24" :
        			...
        			if( this.dsRevProc.rowcount == 0)
        			{
        					...
        					(this.reqInfo.SAVE_BTN_YN == "Y" || this.reqInfo.REV_BTN_YN == "Y") )
        				{
        					...
        					this.dsWfSrm.setColumn(0, "APPR_USER_ID", Ex.util.getSession('gvUserId'));
        					this.dsWfSrm.setColumn(0, "APPR_USER_NM", Ex.util.getSession('gvUserNm'));
        				}
        			}
        			break;
        	}
        ...
        this.fnSaveCheck = function(isReg)
        {
        	...
        	if( Ex.isEmpty(this.dsWfSrm.getColumn(0,"APPR_EXAM_OPIN")) )
        	{
        		var param = {
        			  id	: "txaOpinion"
        ...
        this.loadIncludeScript("SR5015_D03.xfdl");
