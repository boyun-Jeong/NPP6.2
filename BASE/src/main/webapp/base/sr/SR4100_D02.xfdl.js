(function()
{
    return function()
    {
        ...
        {
            this.set_name("SR4100_D02");
            this.set_titletext("문제검토");
            if (Form == this.constructor)
            {
                this._setFormPosition(1820,160);
            }
            ...
            obj = new Dataset("dsDifficulty", this);
            obj._setContents("<ColumnInfo><Column id=\"CMM_CD\" type=\"STRING\" size=\"256\"/><Column id=\"CMM_CD_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CMM_CD_NM\">상</Col><Col id=\"CMM_CD\">3</Col></Row><Row><Col id=\"CMM_CD_NM\">중</Col><Col id=\"CMM_CD\">2</Col></Row><Row><Col id=\"CMM_CD_NM\">하</Col><Col id=\"CMM_CD\">1</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            
            // UI Components Initialize
            obj = new Static("stcBg01_01","0","126",null,"34","0",null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_cssclass("sta_WF_inputBg");
            this.addChild(obj.name, obj);

            obj = new Static("stcBg01_00_00","0","37",null,"90","0",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_cssclass("sta_WF_inputBg");
            this.addChild(obj.name, obj);

            obj = new Static("stcProcExamOpin","0","37","130","90",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("검토의견");
            obj.set_cssclass("sta_WF_inputTitle_E");
            this.addChild(obj.name, obj);

            obj = new TextArea("txaRecpCont","stcProcExamOpin:5.00","42",null,"81","5",null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj.set_displaynulltext("※ 개발적성에 대한 의견 등 기재");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Static("sta_title","0","0","75","24",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("문제검토");
            ...
            obj = new Static("stcProcUserNm00","0","126","130","34",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("난이도");
            obj.set_cssclass("sta_WF_inputTitle");
            this.addChild(obj.name, obj);

            obj = new Combo("cboDifficulty","135.00","131","50","24",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_cssclass("cbo_WF_normal");
            obj.set_innerdataset("dsDifficulty");
            ...
            obj = new Static("sta_title00","75","1","515","24",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1820,160,this,function(p){});
            this.addLayout(obj.name, obj);
            
            // BindItem Information
            obj = new BindItem("item0","txaRecpCont","value","dsWfPbm","RECP_CONT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","cboDifficulty","value","dsWfPbm","SRL_EXM");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("SR4100_D02.xfdl","lib::lib_WorkFlow.xjs");
        this.registerScript("SR4100_D02.xfdl", function() {
        /***********************************************************************************
        * 화면 ID	︰ SR4100_D02
        * 화면(명)	︰ 문제검토
        * 메뉴(경로)	︰
        ...
        ***********************************************************************************/
        ...
        this.selectServiceInfo = {
        	...
        	CALL_SVC		: ["sr/SR5100D/select03"],

        	IN_DS_WHERE		: [this.dsCond],
        	OUT_DS_OBJ		: [new Array(this.dsRevProc)]
        };

        this.saveServiceInfo = {
        	CALLBACK_ID		: ["save01"],
        	CALL_SVC		: ["sr/SR5100D/save02"],
        ...
        */
        ...
        this.form_onload = function(obj, e)
        {
        	...
        	this.dsCond.setColumn(0, "APPR_NM", this.reqInfo.WF_PROC_NM);
        		...
        		case "select" :
        			if( this.dsRevProc.rowcount == 0)
        			{
        				...
        				if(this.reqInfo.WF_FUNC_CD == "WF_FUNC_04" && (this.reqInfo.SAVE_BTN_YN == "Y" || this.reqInfo.REV_BTN_YN == "Y") )
        				{
        					...
        					this.dsWfPbm.setColumn(0, "PRE_CONF_USER_ID", Ex.util.getSession('gvUserId'));
        				}
        			}
        		break;
         ...
         this.fnCompInit = function()
        {
        	...
        	this.sta_title00.set_text(" ※ 협력사 개발자의 처리(승인)요청건은 반드시 <fc v='red'>현장대리인</fc> 처리(승인) 하십시오");
        	//this.txaRecpCont.set_value("※ 개발적성에 대한 의견 등 기재\n\n");
        	this.cboDifficulty.set_index(2);
        }
        ...
        {
        	this.dsNextWfProcCd.setColumn(0, "PROC_USER_ID", e.postvalue);
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.cboDifficulty.addEventHandler("onitemchanged",this.cboProcUserId00_onitemchanged,this);
        ...
        this.loadIncludeScript("SR4100_D02.xfdl");
