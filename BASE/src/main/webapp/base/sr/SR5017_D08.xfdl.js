(function()
{
    return function()
    {
        ...
        {
            this.set_name("SR5017_D08");
            this.set_titletext("인프라PL 접수의견");
        ...
        // User Script
        this.addIncludeScript("SR5017_D08.xfdl","lib::lib_WorkFlow.xjs");
        this.registerScript("SR5017_D08.xfdl", function() {
        /***********************************************************************************
        * 화면 ID	︰ SR5017_D08
        * 화면(명)	︰ 인프라 PL 접수의견
        * 메뉴(경로)	︰
        ...
        ***********************************************************************************/
        ...
        this.fnCallback = function (sSvcId, nErrorCode, sErrorMsg)
        {
        	...
        	switch(sSvcId)
        	{
        		case "select" :
        			...
        			if( Ex.isEmpty(this.dsWfSrm.getColumn(0, "BA2_USER_NM")) && !Ex.isEmpty(this.dsRevProc.getColumn(0, "USER_NM")))
        			{
        				this.dsWfSrm.setColumn(0, "BA2_USER_NM", this.dsRevProc.getColumn(0, "USER_NM"));
        			}

        			if( Ex.isEmpty(this.dsWfSrm.getColumn(0, "BA2_RECP_DATE")) && !Ex.isEmpty(this.dsRevProc.getColumn(0, "PROC_DATE")))
        			{
        				this.dsWfSrm.setColumn(0, "BA2_RECP_DATE", this.dsRevProc.getColumn(0, "PROC_DATE"));
        			}

        			// 현장대리인은 담당개발자 변경가능
        			if(this.dsWfSrm.getColumn(0, "SITE_USER_ID") == Ex.util.getSession("gvUserId") && this.dsSrBaseInfo.getColumn(0,"WF_PROC_NM") == "현장대리인 승인"){
        		...
        		case "select10" :
        			...
        			if( !this.dsWfSrm.getColumn(0, "WORK_USER_ID") )
        			{
        				...
        				this.divContent.form.cboWorkUserNm.set_text("- 선택 -");
        			}
        			else
        			{
        				var aRow = this.dsWorkUser.insertRow();
        		...
        		case "select16" :
        			...
        			if(!this.dsWfSrm.getColumn(0, "SITE_USER_ID"))
        			{
        				...
        				this.divContent.form.cboSiteUserNm.set_text("- 선택 -");
        			} else {
        				var aRow = this.dsSiteUser.insertRow();
        				this.dsSiteUser.setColumn(aRow, "STAFF_NM", "- 선택 -");
        			}
        ...
        {
        	var sTranId = "select10";										// transaction 서비스 실행 ID / 콜백에서 수신할 서비스ID
            var sService = "SR5000D/select10";								// 서비스명
        ...
        this.loadIncludeScript("SR5017_D08.xfdl");
