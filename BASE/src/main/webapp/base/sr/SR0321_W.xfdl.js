(function()
{
    return function()
    {
        ...
        {
            this.set_name("SR0321_W");
            this.set_titletext("서비스요청서목록");
            ...
            obj = new Static("Static00","0","80",null,"10","0",null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Static("stcReqUsertNm","51.31%","42","58","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("11");
            obj.set_text("요청자");
            obj.set_cssclass("sta_WF_schTitle");
            this.divSearchArea.addChild(obj.name, obj);

            obj = new Div("divReqUser","stcReqUsertNm:0","42","245","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("26");
            ...
            obj = new Static("stcLMNM","divReqUser:30","42","58","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("12");
            obj.set_text("처리자");
            obj.set_cssclass("sta_WF_schTitle");
            this.divSearchArea.addChild(obj.name, obj);

            obj = new Static("stcReqStatCd","edtReqTitle:30","13","70","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("13");
            obj.set_text("진행상태");
            obj.set_cssclass("sta_WF_schTitle");
            this.divSearchArea.addChild(obj.name, obj);
            ...
            obj = new Div("divActUser","stcLMNM:0","42","245","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("27");
            obj.set_url("fomm::FOMM0000_D01.xfdl");
            obj.set_enableevent("false");
            obj.set_text("");
            ...
            obj = new Static("stcReqUsertNm00","divActUser:30","42","70","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("21");
            obj.set_text("내작업");
            obj.set_cssclass("sta_WF_schTitle");
            obj.set_visible("false");
            ...
            obj = new Div("divGrdTopBtn",null,null,"425","24","0","grdSrBaseInfo:10",null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_visible("true");
            ...
            this.divGrdTopBtn.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this.divSearchArea.form.divReqUser
            obj = new Layout("default","",0,0,this.divSearchArea.form.divReqUser.form,function(p){});
            this.divSearchArea.form.divReqUser.form.addLayout(obj.name, obj);

            //-- Default Layout : this.divSearchArea.form.divActUser
            obj = new Layout("default","",0,0,this.divSearchArea.form.divActUser.form,function(p){});
            this.divSearchArea.form.divActUser.form.addLayout(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("SR0321_W.xfdl","lib::lib_WorkFlow.xjs");
        this.registerScript("SR0321_W.xfdl", function() {
        /***********************************************************************************
        * 화면 ID		︰ SR0321_W
        * 화면(명)		︰ 서비스요청함
        * 메뉴(경로)	︰ 공통
        ...
        ***********************************************************************************/
        ...
        this.isITDept = (Ex.util.getSession('gvAuthId').includes('USER2'));
        this.formObj;
        /***********************************************************************************
         * Form Function
         ***********************************************************************************/
        ...
        this.fnSearchReset = function(vType)
        {
        	...
        	this.divSearchArea.form.divReqUser.form.resetInput();
        	this.divSearchArea.form.divActUser.form.resetInput();
        	...
        	switch(vType) {
        		case "W":
        			...
        			this.divSearchArea.form.stcReqUsertNm00.visible = false;
        			this.divSearchArea.form.chk00.visible = false;

        			this.divSearchArea.form.divReqUser.visible = true;
        			this.divSearchArea.form.stcReqUsertNm.visible = true;

        			this.divSearchArea.form.stcLMNM.visible = true;
        			this.divSearchArea.form.divActUser.visible = true;
        		...
        		case "P":
        			...
        			divSearchArea.form.divReqUser.visible = true;
        			this.divSearchArea.form.stcReqUsertNm.visible = true;

        			this.divSearchArea.form.stcLMNM.visible = false;
        			this.divSearchArea.form.divActUser.visible = false;
        		...
        		case "S":
        			...
        			var evtInfo = nexacro.ItemChangeEventInfo;
        			var mId = this.getOwnerFrame().info.menuId;

        			if(mId=='777') {
        				evtInfo.postvalue = "AMM";
        			} else {
        		...
        		default:
        			...
        			this.divSearchArea.form.divActUser.left = "stcLMNM:-1px";
        ...
        this.fnSearch = function()
        {
        	...
        	this.dsCond.setColumn(0, "REQ_USER_NM", this.divSearchArea.form.divReqUser.form.dsUser.getColumn(0, "USER_NM"));
        	this.dsCond.setColumn(0, "REQ_USER_ID", this.divSearchArea.form.divReqUser.form.dsUser.getColumn(0, "USER_ID"));
        	this.dsCond.setColumn(0, "PROC_USER_NM", this.divSearchArea.form.divActUser.form.dsUser.getColumn(0, "USER_NM"));
        	this.dsCond.setColumn(0, "PROC_USER_ID", this.divSearchArea.form.divActUser.form.dsUser.getColumn(0, "USER_ID"));
        ...
        this.fnPopupAfter = function(pID, varValue)
        {
        	...
        	switch(pID)
        	{
        		...
        		case "selectReqUserPop" :
        			varValue
        			this.dsCond.setColumn(0, "REQ_USER_NM", dsTemp.getColumn(0, "USER_NM"));
        		break;

        		case "selectActUserPop" :
        			this.dsCond.setColumn(0, "PROC_USER_NM", dsTemp.getColumn(0, "USER_NM"));
        		break;
        	}
        }
        ...
        this.fnCommOnclick = function(obj, e)
        {
        	...
        	switch(obj.name)
        	{
        		...
        		case "btnSearchReqUser" :	// 요청자 조회
        			var sPopId = 'selectReqUserPop';
        			var sUrl	= 'fomm::FOMM0000_P01.xfdl';
        			var oParam	= {
        				 title : Ex.core.word('사용자') + ' ' + Ex.core.word('선택')
        				,pType : "NAME"
        				,pData : this.dsCond.getColumn(0, "REQ_USER_NM")
        				,pSelType	: 'S'
        			};
        			var sSize	= 'autosize';
        			Ex.core.popup(this, sPopId, sUrl, oParam, sSize);
        			break;

        		case "btnSearchActUser" :	// 조치자 조회
        			var sPopId = 'selectActUserPop';
        			var sUrl	= 'fomm::FOMM0000_P01.xfdl';
        			var oParam	= {
        				 title : Ex.core.word('사용자') + ' ' + Ex.core.word('선택')
        				,pType : "NAME"
        				,pData : this.dsCond.getColumn(0, "PROC_USER_NM")
        				,pSelType	: 'S'
        			};
        			var sSize	= 'autosize';
        			Ex.core.popup(this, sPopId, sUrl, oParam, sSize);
        ...
        this.grdOnCellClick = function(obj,e)
        {
        	if(e.row > - 1 && e.cell == obj.getBindCellIndex("body", "REQ_ID"))
        	{
        		...
        		trace(" :::::::::::::::::::::::::::::: " + this.isITDept);
        		// IT지원부만 열람 가능 (SLA)
        		if(!this.isITDept && (reqId.startsWith("SLA") || reqId.startsWith("REP"))){
        			var param = {
        				  id	: "openPopAlert"										//fnMsgAfter에서 식별자로 사용되는 ID
        				, msg	: "해당 요청서는 IT지원부만 열람 가능합니다."		//메시지 내용
        				, arrparam : [""]												//메시지의 변수에 들어갈 실제값
        				, msgtype : "I"													//메시지 타입 '' : [No icon]아이콘 없는 기본 alert, 'I' : [Info]일반 alert, 'W' : [Warning]경고 Alert, 'S' : [Success]성공 alert(저장 등에 사용)&#13;
        				};
        				Ex.core.alert(this, param);
        ...
        this.loadIncludeScript("SR0321_W.xfdl");
