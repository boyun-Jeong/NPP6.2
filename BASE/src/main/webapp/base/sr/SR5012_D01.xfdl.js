(function()
{
    return function()
    {
        ...
        {
            this.set_name("SR5012_D01");
            this.set_titletext("시스템작업요청서");
            ...
            obj = new Div("divWebEditor","129","100",null,null,"0","572",null,null,null,null,this);
            obj.set_taborder("9");
            ...
            obj = new Static("stcInfoTitle3_00_01_00_00","0","791","200","24",null,null,null,null,null,null,this);
            obj.set_taborder("39");
            obj.set_cssclass("sta_WF_gridTitle");
        ...
        // User Script
        this.addIncludeScript("SR5012_D01.xfdl","lib::lib_WorkFlow.xjs");
        this.registerScript("SR5012_D01.xfdl", function() {
        /***********************************************************************************
        * 화면 ID	︰ SR5012_D01
        * 화면(명)	︰ 시스템작업요청서
        * 메뉴(경로)	︰
        ...
        ***********************************************************************************/
        ...
        // 		this.cboReq2.set_index(7);
        	...
        	else
        	{
        		...
        		// 백업신청서
        		this.cboReq1.set_index(1);
        		this.cboReq2.set_index(7); // 시스템작업요청서
        		this.fnCategoryNh();	// 카테고리 조회
        	}
        }
        ...
        this.fnSvcStaffMng = function()
        {
        	...
        	this.dsStaff.setColumn(0, "BSE_LVL2_CD", "SPA05225"); 	// 시스템작업요청서
        ...
        this.on_initEvent = function()
        {
            ...
            this.dsSrSysWorkReq.addEventHandler("oncolumnchanged",this.dsSrSysWorkReq_oncolumnchanged,this);
            this.dsSrSysWorkReqSub1.addEventHandler("oncolumnchanged",this.dsSrSysWorkReqSub1_oncolumnchanged,this);
        };
        this.loadIncludeScript("SR5012_D01.xfdl");
