(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("요청정보-사업계획결재기본");
            if (Form == this.constructor)
            {
                this._setFormPosition(1280,134);
            }
            ...
            obj = new Static("stcBg01_00","80%","stcEmpty01:0",null,null,"0","0",null,null,null,null,this);
            obj.set_taborder("25");
            ...
            obj = new Static("stcReqDt","25%","34","114","34",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("신청일자");
            ...
            obj = new Static("stcLabel06","0.00%","67","114","34",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("요청서명");
            obj.set_cssclass("sta_WF_inputTitle");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("stcLabel05","50%","100","114","34",null,null,null,null,null,null,this);
            obj.set_taborder("26");
            obj.set_text("관련 요청번호");
            obj.set_cssclass("sta_WF_inputTitle");
            this.addChild(obj.name, obj);

            obj = new Static("stcReqDesc","75.00%","34","114",null,null,"0",null,null,null,null,this);
            obj.set_taborder("20");
            obj.set_text("작성요령");
            obj.set_cssclass("sta_WF_inputTitle");
            this.addChild(obj.name, obj);

            obj = new Edit("edtRefReqId","stcLabel05:5","107",null,"24","stcReqDesc:5",null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_cssclass("edt_WF_normal");
            ...
            obj = new Static("stcReqUserNm00","25.00%","67","114","34",null,null,null,null,null,null,this);
            obj.set_taborder("19");
            obj.set_text("요청부서");
            obj.set_cssclass("sta_WF_inputTitle");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("stcReqUserNm","50.00%","68","114","34",null,null,null,null,null,null,this);
            obj.set_taborder("24");
            obj.set_text("작성자");
            obj.set_cssclass("sta_WF_inputTitle");
            this.addChild(obj.name, obj);

            obj = new Edit("edtReqDept","stcReqUserNm00:5.00","72",null,"24","stcReqUserNm:5",null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_cssclass("edt_WF_normal");
            ...
            obj = new Edit("edtReqTitle","stcReqTitle:5.00","105",null,"24","stcLabel05:5",null,null,null,null,null,this);
            obj.set_taborder("18");
            obj.set_validationGroup("group01");
            ...
            obj = new Button("btn00","stcReqDesc:-64","101","55","24",null,null,null,null,null,null,this);
            obj.set_taborder("21");
            obj.set_text("도움말");
            ...
            obj = new WebView("wevReqDesc","stcReqDesc:5.00","stcEmpty01:6",null,null,"5","6",null,null,null,null,this);
            obj.set_taborder("22");
            this.addChild(obj.name, obj);

            obj = new Edit("edtReqUserNm","stcReqUserNm:5.00","73",null,"24","stcReqDesc:5",null,null,null,null,null,this);
            obj.set_taborder("23");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_cssclass("edt_WF_normal");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1280,134,this,function(p){});
            this.addLayout(obj.name, obj);
            
            // BindItem Information
            obj = new BindItem("srCatType","edtRefReqId","value","dsSrBaseInfo","REF_REQ_ID");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item5","edtReqDept","value","dsSrBaseInfo","REQ_DEPT_NM");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item1","edtReqUserNm","value","dsSrBaseInfo","REQ_USER_NM");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("SR0000_D08.xfdl", function() {
        /***********************************************************************************
        * 화면 ID		︰ SR0110_D
        * 화면(명)		︰ 요청서 등록
        * 메뉴(경로)	︰ 공통
        ...
        */
        ...
        this.stcBg01_onclick = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.btn00.addEventHandler("onclick",this.fnCommOnclick,this);
        ...
        this.loadIncludeScript("SR0000_D08.xfdl");
