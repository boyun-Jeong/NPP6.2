(function()
{
    return function()
    {
        ...
        {
            this.set_name("SR5011_D01");
            this.set_titletext("월간점검일지");
            if (Form == this.constructor)
            {
                this._setFormPosition(1820,1200);
            }
            ...
            obj = new Dataset("dsSrDayChkDiar", this);
            obj._setContents("<ColumnInfo><Column id=\"PROC_NUMBER\" type=\"STRING\" size=\"256\"/><Column id=\"CHK_DT\" type=\"STRING\" size=\"256\"/><Column id=\"CHK_STIME\" type=\"STRING\" size=\"256\"/><Column id=\"CHK_ETIME\" type=\"STRING\" size=\"256\"/><Column id=\"CHK_WKP\" type=\"STRING\" size=\"256\"/><Column id=\"CHK_TGT\" type=\"STRING\" size=\"256\"/><Column id=\"CHK_RST\" type=\"STRING\" size=\"256\"/><Column id=\"CHK_BIGO\" type=\"STRING\" size=\"256\"/><Column id=\"REG_USER_ID\" type=\"STRING\" size=\"256\"/><Column id=\"REG_USER_NM\" type=\"STRING\" size=\"256\"/><Column id=\"REG_STIME\" type=\"STRING\" size=\"256\"/><Column id=\"LMOD_USER_ID\" type=\"STRING\" size=\"256\"/><Column id=\"LMOD_USER_NM\" type=\"STRING\" size=\"256\"/><Column id=\"SYSMODTIME\" type=\"STRING\" size=\"256\"/><Column id=\"ROWFLAG\" type=\"STRING\" size=\"256\"/><Column id=\"REQ_ID\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divWebEditor","129.00","100",null,null,"0","796",null,null,null,null,this);
            obj.set_taborder("9");
            ...
            obj = new Calendar("calChkDt","135.00","459","106","24",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_cssclass("cal_WF_normal");
            obj.getSetter("validate").set("");
            obj.set_enable("true");
            obj.set_visible("true");
            obj.set_validation("점검일자;NULL");
            obj.set_validationGroup("input02");
            obj.set_text("    -  -  ");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("mskChkStime","244.00","459","45","24",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_type("string");
            obj.set_cssclass("msk_WF_normal");
            obj.set_format("##:##");
            ...
            obj.set_visible("true");
            obj.set_validationGroup("input02");
            obj.set_validation("점검시작시간;NULL");
            obj.set_text("__:__");
            this.addChild(obj.name, obj);

            obj = new Static("Static01","288.00","459","15","24",null,null,null,null,null,null,this);
            obj.set_taborder("31");
            obj.set_text("~");
            obj.set_textAlign("center");
            obj.set_verticalAlign("middle");
            ...
            obj = new MaskEdit("mskChkEtime","304.00","459","45","24",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_type("string");
            obj.set_cssclass("msk_WF_normal");
            obj.set_format("##:##");
            ...
            obj.set_visible("true");
            obj.set_validationGroup("input02");
            obj.set_validation("점검종료시간;NULL");
            obj.set_text("__:__");
            this.addChild(obj.name, obj);

            obj = new Static("Static02","0","487",null,"100","0",null,null,null,null,null,this);
            obj.set_taborder("32");
            obj.set_cssclass("sta_WF_inputBg");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Static("stcJobImpt00_00","0","487","130","100",null,null,null,null,null,null,this);
            obj.set_taborder("33");
            obj.set_text("점검대상");
            obj.set_cssclass("sta_WF_inputTitle_E");
            this.addChild(obj.name, obj);

            obj = new TextArea("txaReqSayu00","134.00","491",null,"92","5",null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_validationGroup("input02");
            obj.set_validation("점검대상;NULL");
            obj.set_cssclass("txa_WF_normal");
            obj.set_imemode("hangul");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Static("stcUpmu00_00_00","900.00","454","130","34",null,null,null,null,null,null,this);
            obj.set_taborder("34");
            obj.set_text("작업장소");
            obj.set_cssclass("sta_WF_inputTitle_E");
            this.addChild(obj.name, obj);

            obj = new Combo("cboJobWkp","1035.00","460","170","24",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_cssclass("cbo_WF_normal");
            obj.set_validationGroup("input02");
            ...
            obj = new Static("Static21_01","0","586",null,"414","0",null,null,null,null,null,this);
            obj.set_taborder("35");
            obj.set_cssclass("sta_WF_inputBg");
            this.addChild(obj.name, obj);

            obj = new Static("Static24_00","0","586","130","414",null,null,null,null,null,null,this);
            obj.set_taborder("36");
            obj.set_text("점검결과");
            obj.set_cssclass("sta_WF_inputTitle_E");
            this.addChild(obj.name, obj);

            obj = new Static("Static21_01_00","0","1000",null,"200","0",null,null,null,null,null,this);
            obj.set_taborder("37");
            obj.set_cssclass("sta_WF_inputBg");
            this.addChild(obj.name, obj);

            obj = new Static("Static24_00_00","0","1000","130","200",null,null,null,null,null,null,this);
            obj.set_taborder("38");
            obj.set_text("특이사항");
            obj.set_cssclass("sta_WF_inputTitle");
            this.addChild(obj.name, obj);

            obj = new TextArea("txaProcDesc00_00","134.00","1005",null,"190","4",null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_validation("특이사항;NULL");
            obj.set_cssclass("txa_WF_normal");
            obj.set_imemode("hangul");
            obj.set_text("");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divWebEditorChkRst","134","590",null,"405","4",null,null,null,null,null,this);
            obj.set_taborder("40");
            obj.set_url("comm::comWebEditor.xfdl");
            obj.set_text("");
            obj.set_async("false");
            ...
            //-- Default Layout : this.divWebEditorChkRst
            obj = new Layout("default","",0,0,this.divWebEditorChkRst.form,function(p){});
            this.divWebEditorChkRst.form.addLayout(obj.name, obj);

            //-- Default Layout : this
            obj = new Layout("default","",1820,1200,this,function(p){});
            ...
            obj = new BindItem("item8","stcInfoTitle3","value","dsSrSysDataTran","JOB_OPEN_TIME");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item12","Static02","value","dsWfSrm","BIGO");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item14","Static21_01","value","dsSrSysWorkPlan","RCV_PROC_COMMD");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item15","Static21_01_00","value","dsSrSysWorkPlan","RCV_PROC_COMMD");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item16","calChkDt","value","dsSrDayChkDiar","CHK_DT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item17","mskChkStime","value","dsSrDayChkDiar","CHK_STIME");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item18","mskChkEtime","value","dsSrDayChkDiar","CHK_ETIME");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item19","cboJobWkp","value","dsSrDayChkDiar","CHK_WKP");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item20","txaReqSayu00","value","dsSrDayChkDiar","CHK_TGT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item22","txaProcDesc00_00","value","dsSrDayChkDiar","CHK_BIGO");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("SR5011_D01.xfdl","lib::lib_WorkFlow.xjs");
        this.registerScript("SR5011_D01.xfdl", function() {
        /***********************************************************************************
        * 화면 ID	︰ SR5011_D01
        * 화면(명)	︰ 월간점검일지
        * 메뉴(경로)	︰
        ...
        ***********************************************************************************/
        ...
        this.fnInit = function()
        {
        	...
        	if(this.getOwnerFrame().pDs)
        	{
        		...
        		*/
        		...
        		this.divWebEditorChkRst.form.setContent(webConts, false);
        ...
        this.fn_initDataset = function()
        {
        	if( this.dsCond.getColumn(0, "REQ_ID").indexOf("REQ") > -1 )
        	{
        		...
        		this.dsSrDayChkDiar.setInsertRow();
        		...
        		this.dsSrDayChkDiar.setColumn(0, "CHK_DT", Ex.util.today());
        		this.dsSrDayChkDiar.setColumn(0, "CHK_STIME", "1200");
        		this.dsSrDayChkDiar.setColumn(0, "CHK_ETIME", "1800");
        	}
        	else
        	{
        ...
        this.fnCallback = function (sSvcId, nErrorCode, sErrorMsg)
        {
        	...
        	switch (sSvcId)
        	{
        		case "select" :
        			...
        			var webConts_ = this.dsSrDayChkDiar.getColumn(this.dsSrDayChkDiar.rowposition, 'CHK_RST')||'';
        			this.divWebEditorChkRst.form.setContent(webConts_, false);
        			break;
        ...
        this.fnPopupAfter = function(pID, varValue)
        {
        	...
        	switch (pID)
        	{
        		...
        		case "alikePop"	:
        			...
        			var webConts_ = tempDs.getColumn(0,"CHK_RST")||'';
        			this.divWebEditorChkRst.form.setContent(webConts_, false);
        			break;
        	}
        }
        ...
        this.fnMsgAfter = function(mID, varValue)
        {
        	...
        	switch(mID)
        	{
        		...
        		case "mskChkEtime" :
        			this.mskChkEtime.setFocusRed();
        			break;

        		case "mskChkStime" :
        			this.mskChkStime.setFocusRed();
        			break;
        	}
        }
        ...
        this.isUpdateForm = function()
        {
        	...
        	var webConts_ = this.divWebEditorChkRst.form.getContent();
        	this.dsSrDayChkDiar.setColumn(this.dsSrDayChkDiar.rowposition, 'CHK_RST', webConts_);
        ...
        this.fnSaveCheck = function(isReg)
        {
        	...
        	chkCont = nexacro.replaceAll(nexacro.replaceAll(this.divWebEditorChkRst.form.getContent(), "<p>&nbsp;</p>", "", " ", ""));

        	if( Ex.isEmpty(chkCont) )
        	{
        		var param = {
                	  msg	: "점검결과는 필수 입력 항목입니다."	//메시지 내용
                	, arrparam : []										//메시지의 변수에 들어갈 실제값
                	, msgtype : "E"										//메시지 타입 '' : [No icon]아이콘 없는 기본 alert, 'I' : [Info]일반 alert, 'W' : [Warning]경고 Alert, 'S' : [Success]성공 alert(저장 등에 사용)&#13;
                	};
                Ex.core.alert(this, param);
        	...
        	strValue = this.dsSrDayChkDiar.getColumn(0, "CHK_STIME");
        	if(strValue < '0000' || strValue > '2459')
        	{
        		var param = {
        			  id	: "mskChkStime"
        			, msg	: "점검시작시간을 확인하시기 바랍니다."	//메시지 내용
        			, arrparam : []						//메시지의 변수에 들어갈 실제값
        			, msgtype : "E"						//메시지 타입 '' : [No icon]아이콘 없는 기본 alert, 'I' : [Info]일반 alert, 'W' : [Warning]경고 Alert, 'S' : [Success]성공 alert(저장 등에 사용)&#13;
               	};
        		Ex.core.alert(this, param);
        	...
        	strValue = this.dsSrDayChkDiar.getColumn(0, "CHK_ETIME");
        	if(strValue < '0000' || strValue > '2459')
        	{
        		var param = {
        			  id	: "mskChkEtime"
        			, msg	: "점검종료시간을 확인하시기 바랍니다."	//메시지 내용
        			, arrparam : []						//메시지의 변수에 들어갈 실제값
        			, msgtype : "E"						//메시지 타입 '' : [No icon]아이콘 없는 기본 alert, 'I' : [Info]일반 alert, 'W' : [Warning]경고 Alert, 'S' : [Success]성공 alert(저장 등에 사용)&#13;
                	};
        		Ex.core.alert(this, param);
        ...
        this.fnSvcStaffMng = function()
        {
        	...
        	this.dsStaff.setColumn(0, "BSE_LVL2_CD", "SPA05400"); 	// 월간점검일지 생성 작업요청서
        	//this.dsStaff.setColumn(0, "BSE_LVL2_CD", "SPA05224"); 	// AS-IS에서는 SPA05224로 보내고있음 DB상에 테이터가 없어서 추후 확인필요
        ...
        this.setChangeEditAfter = function()
        {
        	...
        	this.divWebEditorChkRst.form.initCreate(this.parent.editYn == "Y" ? false : true);
        }
        ...
        this.dsSrDayChkDiar_oncolumnchanged = function(obj,e)
        {
        	obj.setUpdateRow(e);
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.calChkDt.addEventHandler("onchanged",this.calPjtStime_onchanged,this);
            ...
            this.dsSrDayChkDiar.addEventHandler("oncolumnchanged",this.dsSrDayChkDiar_oncolumnchanged,this);
        };
        this.loadIncludeScript("SR5011_D01.xfdl");
