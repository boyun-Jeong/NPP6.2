(function()
{
    return function()
    {
        ...
        {
            this.set_name("SR5015_D01");
            this.set_titletext("전산기기신청");
            if (Form == this.constructor)
            {
                this._setFormPosition(1820,510);
            }
            ...
            obj = new Combo("cboReq1","stcUpmu:5.00","39","238","24",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Static("stcUpmu00","cboReq2:45.00","34","130","34",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_text("업무분류");
            obj.set_cssclass("sta_WF_inputTitle_E");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static21","0","100",null,"410","0",null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_cssclass("sta_WF_inputBg");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Static("Static24","0","100","130","410",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_text("요청내용");
            obj.set_cssclass("sta_WF_inputTitle_E");
            this.addChild(obj.name, obj);

            obj = new Div("divWebEditor","135.00","100",null,null,"-6","0",null,null,null,null,this);
            obj.set_taborder("8");
            ...
            obj = new Static("stcProcUserNm02","590","67","130","34",null,null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_text("합의완료일시");
            obj.set_cssclass("sta_WF_inputTitle");
            this.addChild(obj.name, obj);

            obj = new Calendar("calPlanDt","stcProcUserNm02:5","73","112","24",null,null,null,null,null,null,this);
            obj.set_taborder("18");
            ...
            obj = new MaskEdit("mskPlanStime","calPlanDt:3","73","45","24",null,null,null,null,null,null,this);
            obj.set_taborder("19");
            obj.set_type("string");
            ...
            obj = new Button("btn_agreeCompDtChg","cbo_preConfUserNm:2","73","120","23",null,null,null,null,null,null,this);
            obj.set_taborder("21");
            ...
            //-- Default Layout : this
            obj = new Layout("default","",1820,510,this,function(p){});
            ...
            obj = new BindItem("item8","stcProcUserNm02","value","dsWfSrm","AGREE_COMP_TIME");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item9","calPlanDt","value","dsWfSrm","AGREE_COMP_DT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item10","mskPlanStime","value","dsWfSrm","AGREE_COMP_TIME");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("SR5015_D01.xfdl","lib::lib_WorkFlow.xjs");
        this.registerScript("SR5015_D01.xfdl", function() {
        /***********************************************************************************
        * 화면 ID	︰ SR5015_D01
        * 화면(명)	︰ 전산기기신청
        * 메뉴(경로)	︰
        ...
        ***********************************************************************************/
        ...
        // 		this.dsOnColumnChanged(this.dsWfSrm, evt);
        		this.dsWfSrm.setColumn(0, "REQ_ID1", "REQC0F00");	//전산기기신청(신규/교체/반납/이동) - [기본값]

        // 		evt.columnid	= "REQ_ID2";
        // 		evt.newvalue	= undefined;
        // 		this.dsOnColumnChanged(this.dsWfSrm, evt);
        		this.dsWfSrm.setColumn(0, "REQ_ID2", "REQC0FA0");	//신규(추가) - [기본값]

        		// 전산기기신청
        		//this.cboReq1.set_index(3);
        		this.dsReq2.deleteRow(0);
        		//this.cboReq2.set_index(0);
        		//this.fnCategoryNh();	// 카테고리 조회

        		// 업무분류
        		this.dsWfSrm.setColumn(0, "UPMU_ID1", "BIZC0V00");	//(인프라)전산기기관리 - [기본값]
        // 		evt.columnid	= "UPMU_ID1";
        // 		evt.newvalue	= "BIZC0V00";
        // 		this.dsOnColumnChanged(this.dsWfSrm, evt);
        		...
        		this.divWebEditor.form.setContent("<font size=3><b>*신규지급 요청은 사번/IP 발급 이후 요청</b><br><b>○ 요청사유</b></font><br><br><font size=3><b>○ 요청사항</b></font><br>- 소속 : <br> - 사용자명 : <br> - 사번 / IP : <br> - 연락처 : <br><br> - 신규요청기기 : <br> - 설치요청장소 : <br> - 설치희망일 : <br><br> - 기타사항 : ");
        	}
        	else
        	{
        ...
        this.fnCallback = function (sSvcId, nErrorCode, sErrorMsg)
        {
        	...
        	switch (sSvcId)
        	{
        		case "select" :
        			...
        			if(this.dsSrBaseInfo.getColumn(0,"WF_PROC_NM") == "요청검토" && this.dsWfSrm.getColumn(0,"PRE_CONF_USER_ID")  == Ex.util.getSession("gvUserId") )
        			{	//사전협의자 PL만 수정가능
        ...
        {
        	this.dsStaff.setColumn(0, "SVC_CLSS_CD", "SR"); 		// 인프라
        	this.dsStaff.setColumn(0, "BSE_LVL2_CD", this.dsWfSrm.getColumn(0,"UPMU_ID2")); 	// 전산기기신청
        ...
        this.cbo_preConfUserNm_onitemchanged = function(obj,e)
        {
        	...
        	{
        		this.dsWfSrm.setColumn(0, "PRE_CONF_USER_ID", "");
        ...
        {
        	// PC클리닝 - (인프라)전산기기관리 - 현장방문요청
        	if(this.dsWfSrm.getColumn(0, "REQ_ID2") == "REQC0FE0")
        	{
        		if(this.dsUpmu1.findRow("CMM_CD","BIZC0V00") > 0 ) this.cboUpmu1.set_index(this.dsUpmu1.findRow("CMM_CD","BIZC0V00"));
        		if(this.dsUpmu2.findRow("CMM_CD","BIZC0VD0") > 0 ) this.cboUpmu2.set_index(this.dsUpmu2.findRow("CMM_CD","BIZC0VD0"));
        // 		this.cboUpmu1.set_index(27);
        // 		this.cboUpmu2.set_index(3);
        	}
        };

        this.dsSrBackupDataRestore_oncolumnchanged = function(obj,e)
        {
        	obj.setUpdateRow(e);
        };
        ...
        this.dsOnColumnChanged = function(obj,e)
        {
        	if(e.columnid == "REQ_ID1" || e.columnid == "REQ_ID2" ||e.columnid == "UPMU_ID1" || e.columnid == "UPMU_ID2")
        	{
        		...
        		if( !Ex.isEmpty(e.newvalue) )
        		{
        			...
        			{
        				this.fnSvcStaffMng(); // 서비스별 담당자
        			}
        			else if(e.columnid == "REQ_ID2" && this.dsCond.getColumn(0, "REQ_ID").indexOf("REQ") > -1)
        			{
        				if(this.dsWfSrm.getColumn(0, "REQ_ID2") == "REQC0FA0")
        				{
        					// 신규(추가)
        					this.divWebEditor.form.setContent("<font size=3><b>*신규지급 요청은 사번/IP 발급 이후 요청</b><br><b>○ 요청사유</b></font><br><br><font size=3><b>○ 요청사항</b></font><br>- 소속 : <br> - 사용자명 : <br> - 사번 / IP : <br> - 연락처 : <br><br> - 신규요청기기 : <br> - 설치요청장소 : <br> - 설치희망일 : <br><br> - 기타사항 : ");
        				}
        				else if(this.dsWfSrm.getColumn(0, "REQ_ID2") == "REQC0FB0")
        				{
        					// 변경(교체)
        					this.divWebEditor.form.setContent("<font size=3><b>* 기기장애로 인한 교체일 경우 사유에 장애증상 기입</b><br><b>○ 요청사유</b></font><br><br><font size=3><b>○ 요청사항</b></font><br>- 소속 : <br> - 사용자명 : <br> - 사번 / IP : <br> - 연락처 : <br><br> - 교체요청기기 : <br> - 교체희망일자 : <br> - 설치장소 : <br> - 모델명 및 제조번호(S/N) : <br><br> - 기타사항 : ");
        				}
        				else if(this.dsWfSrm.getColumn(0, "REQ_ID2") == "REQC0FC0")
        				{
        					// 반납(폐기)
        					this.divWebEditor.form.setContent("<font size=3><b>* 퇴직 및 휴직자는 전산기기 반납 확인증 및 기기별 시리얼 번호 사진 촬영후 첨부</b><br><b> - 미사용 장비는 사용자명에 미사용기기로 입력 후 모델명 및 제조번호 기재 </b><br><b>○ 회수 및 반납요청사유</b></font><br><br><font size=3><b>○ 요청사항</b></font><br>- 소속 : <br> - 사번 : <br> - 사용자명 : <br> - 연락처 : <br><br> - 회수요청기기 : <br> - 회수요청일 : <br> - 회수요청장소 : <br> - 모델명 및 제조번호(S/N) : <br><br> - 기타사항 : ");
        				}
        				else if(this.dsWfSrm.getColumn(0, "REQ_ID2") == "REQC0FD0")
        				{
        					// 이동설치(전배)
        					this.divWebEditor.form.setContent("<font size=3><b>*이동설치의 경우 작성전 IT지원팀 주임 또는 서비스데스크로 문의 바랍니다.</b><br><b>○ 요청사유</b></font><br><br><font size=3><b>○ 요청사항</b></font><br>- 소속 : <br> - 사번 : <br> - <font color =red>*</font>사용자명 : <br> - <font color =red>*</font>연락처 : <br><br> - 이동요청기기 : <br> - 이동희망일자 : <br> - 설치장소 : <br> - 이동장소 : <br> - 모델명 및 제조번호(S/N) : <br><br> - 기타사항 : ");
        				}
        				else if(this.dsWfSrm.getColumn(0, "REQ_ID2") == "REQC0FE0")
        				{
        					// PC클리닝
        					this.divWebEditor.form.setContent("<font size=3><b>*PC클리닝의 경우 작성전 IT지원팀 주임 또는 서비스데스크로 문의 바랍니다.</b><br><font size=3><b>*PC클리닝은 클리닝 희망일이 사용자 연차일때 진행</b><br> <b>○ 요청사유</b></font><br><br><font size=3><b>○ 요청사항</b></font><br>- 소속 : <br> - 사번 : <br> - <font color =red>*</font>사용자명 : <br> - <font color =red>*</font>연락처 : <br><br> - 클리닝 요청기기 : <br> - 클리닝 희망일자 : <br> - 설치장소 : <br> - 모델명 및 제조번호(S/N) : <br><br> - 기타사항 : ");
        				}
        			}
        			else
        			{
        			...
        			if(e.columnid == "REQ_ID1")
        			{
        				...
        				/*	var oParam = {
        					...
        					Ex.util.getCmmCode(oParam);	// 공통코드 gaetter util; (oParam);
        					*/
        				}
        				else
        				{
        ...
        this.on_initEvent = function()
        {
            ...
            this.calPlanDt.addEventHandler("onchanged",this.calPjtStime_onchanged,this);
        ...
        this.loadIncludeScript("SR5015_D01.xfdl");
