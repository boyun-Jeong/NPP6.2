(function()
{
    return function()
    {
        ...
        {
            this.set_name("SR5016_D01");
            this.set_titletext("일반문의");
            ...
            obj = new Static("Static12_00_00","32.47%","67","129","34",null,null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_text("희망완료일시");
            obj.set_cssclass("sta_WF_inputTitle");
            obj.set_visible("false");
            ...
            obj = new Calendar("calPjtStime00","Static12_00_00:5","73","106","24",null,null,null,null,null,null,this);
            obj.set_taborder("8");
        ...
        // User Script
        this.addIncludeScript("SR5016_D01.xfdl","lib::lib_WorkFlow.xjs");
        this.registerScript("SR5016_D01.xfdl", function() {
        /***********************************************************************************
        * 화면 ID	︰ SR5016_D01
        * 화면(명)	︰ 일반문의
        * 메뉴(경로)	︰
        ...
        ***********************************************************************************/
        ...
        this.fn_initDataset = function()
        {
        	if( this.dsCond.getColumn(0, "REQ_ID").indexOf("REQ") > -1 )
        	{
        		...
        		this.cbo_preConfUserNm.set_text(Ex.core.word("- 선택 -"));
        	}
        	else
        	{
        ...
        this.loadIncludeScript("SR5016_D01.xfdl");
