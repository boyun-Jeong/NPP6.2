(function()
{
    return function()
    {
        ...
        {
            this.set_name("SR5000_P04");
            this.set_titletext("회의 참석,불참자 조회");
            if (Form == this.constructor)
            {
                this._setFormPosition(550,514);
            }
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\" band=\"left\"/><Column size=\"120\"/><Column size=\"220\"/><Column size=\"125\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"32\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" text=\"이름\"/><Cell col=\"2\" text=\"부서\"/><Cell col=\"3\" text=\"확인 일자\"/></Band><Band id=\"body\"><Cell expr=\"currow+1\"/><Cell col=\"1\" style=\"align:center;\" text=\"bind:ATN_USER_NM\"/><Cell col=\"2\" style=\"align:left;\" text=\"bind:ATN_USER_DEPT\"/><Cell col=\"3\" text=\"bind:CONF_TIME\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("stcGrdTitle","20","90","96","21",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("참석자 목록");
            obj.set_cssclass("sta_WF_gridTitle");
            this.addChild(obj.name, obj);

            obj = new Static("stcCnt","stcGrdTitle:5","90","50","21",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            ...
            //-- Default Layout : this
            obj = new Layout("default","",550,514,this,function(p){});
        ...
        // User Script
        this.registerScript("SR5000_P04.xfdl", function() {
        /***********************************************************************************
        * 화면(ID)	︰ SR5000_P04
        * 화면(명)	︰ 회의 참석,불참자 조회
        * 메뉴(경로)	︰ 회의 참석자 및 불참자를 검색한다.
        * 화면 설명	︰
        * 작성자		︰ WEMB
        * 작성일		︰ 2025.02.20
        * 수정이력		︰
        ...
        ***********************************************************************************/
        ...
        this.loadIncludeScript("SR5000_P04.xfdl");
