(function()
{
    return function()
    {
        ...
        {
            this.set_name("SR5003_D02");
            this.set_titletext("시스템작업계획서(DB)");
            ...
            obj = new Button("btnIdentifyDelete",null,"1248","60","24","10",null,null,null,null,null,this);
            obj.set_taborder("73");
            obj.set_text("삭제");
            obj.set_cssclass("btn_WF_del");
            this.addChild(obj.name, obj);

            obj = new Button("btnIdentifyAdd",null,"1248","60","24","75",null,null,null,null,null,this);
            obj.set_taborder("74");
            obj.set_text("추가");
            obj.set_cssclass("btn_WF_add");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("SR5003_D02.xfdl","lib::lib_WorkFlow.xjs");
        this.registerScript("SR5003_D02.xfdl", function() {
        /***********************************************************************************
        * 화면 ID	︰ SR5003_D02
        * 화면(명)	︰ 시스템작업계획서(DB)
        * 메뉴(경로)	︰
        ...
        ***********************************************************************************/
        ...
        this.fn_initDataset = function()
        {
        	if( this.dsCond.getColumn(0, "REQ_ID").indexOf("REQ") > -1 )
        	{
        		...
        		this.cboJobCat.set_index(2); // 작업장소
        		// 작업개요
        ...
        this.fnSvcStaffMng = function()
        {
        	...
        	this.dsStaff.setColumn(0, "BSE_LVL2_CD", "SPA05201D"); 	// 시스템작업계획서(DB)
        ...
        this.on_initEvent = function()
        {
            ...
            this.btn_alike.addEventHandler("onclick",this.fnCommOnclick,this);
        ...
        this.loadIncludeScript("SR5003_D02.xfdl");
