(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("SR5017_D05.xfdl", function() {
        /***********************************************************************************
        * 화면 ID	︰ SR5000_D03
        * 화면(명)	︰ PL 접수의견
        * 메뉴(경로)	︰
        ...
        ***********************************************************************************/
        ...
        this.fnCallback = function (sSvcId, nErrorCode, sErrorMsg)
        {
        	...
        	{
        		case "select" :
        			if( Ex.isEmpty(this.dsWfSrm.getColumn(0, "AGREE_COMP_DT")) )
        			{
        				this.dsWfSrm.setColumn(0, "AGREE_COMP_DT", this.dsSrBaseInfo.getColumn(0, "REQ_WISH_DT")); // 합의완료일시
        				this.dsWfSrm.setColumn(0, "AGREE_COMP_TIME", "2359");
        			}
        			this.divContent.form.edtUserNm.set_value(this.dsWfSrm.getColumn(0, "PRE_CONF_USER_NM"));
        			this.fnSetWorkUserId(this.dsWfSrm.getColumn(0, "WORK_USER_ID"));
        			this.fnSetSiteUserComp(this.dsWfSrm.getColumn(0, "SITE_USER_ID"));

        			// 현장대리인은 담당개발자 변경가능
        			/*
        			if(this.dsWfSrm.getColumn(0, "SITE_USER_ID") == Ex.util.getSession("gvUserId") && this.dsSrBaseInfo.getColumn(0,"WF_PROC_CD") == "WF_PROC_2030")
        			{
        				this.divContent.form.cboWorkUserNm.set_readonly(false);
        				this.divContent.form.cboWorkUserNm.set_enable(false);
        				this.divContent.form.cboWorkUserNm.set_enable(true);
        		...
        		case "select24" :
        			...
        			this.dsWorkUser.setColumn(aRow, "STAFF_NM", "- 선택 -");
        		...
        		case "select25" :
        			...
        			this.dsSiteUser.setColumn(aRow, "STAFF_NM", "- 선택 - ");
        			break;
        	}
        	/*
        	// 담당자 조회
        ...
        {
        	var sTranId = "select24";										// transaction 서비스 실행 ID / 콜백에서 수신할 서비스ID
            var sService = "SR5000D/select24";								// 서비스명
        ...
        this.fnSiteUser = function()
        {
            ...
            var sService = "SR5000D/select25";								// 서비스명
            var sInDs = "dsCond=dsWfSrm";									// 서버로 전송할 데이타셋 @ParamDataSet 인자와 맵핑됨
        ...
        this.isUpdateForm = function()
        {
        		...
        		(this.reqInfo.SAVE_BTN_YN == "Y" || this.reqInfo.REV_BTN_YN == "Y") )
        	{
        		...
        		this.dsWfSrm.setColumn(0, "UPMU_ID3", this.reqInfo.PARENT_FORM.divForm.form["divFormWF_PROC_1000"].form.dsWfSrm.getColumn(0, "UPMU_ID3"));
        	}
        ...
        this.fnSaveCheck = function(isReg)
        {
        	...
        	if(this.reqInfo.WF_PROC_NM == "요청접수")	// 요청서마다 WF_PROC_CD 다를수있어서 이름으로 체크
        	{
        		...
        		// 외부직원은 현장대리인 승인단계 필수, 요청접수단계에서만 체크
        		if(this.reqInfo.WF_PROC_NM == "요청접수" && this.divContent.form.cboSiteUserNm.enable && Ex.isEmpty(this.dsWfSrm.getColumn(0, "SITE_USER_ID")) )
        		{
        			var param = {
        				  id : "cboSiteUserNm"
        ...
        this.fnSetWorkUserId = function(workUserId)
        {
        	this.dsWfSrm.set_enableevent(false);
        	this.dsWfSrm.setColumn(0, "WORK_USER_ID", workUserId);	// 담당자ID
        	this.dsWfSrm.set_enableevent(true);

        	if( Ex.isEmpty(workUserId) ) workUserId = "";

        	if(workUserId.startsWith("P") || workUserId.startsWith("e"))
        	{
        		this.divContent.form.stcProcUserNm01.set_cssclass("sta_WF_inputTitle_E");
        		this.divContent.form.cboSiteUserNm.set_enable(true);
        	}
        	else
        	{
        		this.divContent.form.stcProcUserNm01.set_cssclass("sta_WF_inputTitle");
        		this.divContent.form.cboSiteUserNm.set_enable(false);
        		this.dsWfSrm.setColumn(0, "SITE_USER_ID", undefined);
        		this.divContent.form.cboSiteUserNm.set_index(0);
        	}
        }

        this.fnSetSiteUserComp = function(siteUserId)
        {
        	this.dsWfSrm.set_enableevent(false);
        	this.dsWfSrm.setColumn(0, "SITE_USER_ID", siteUserId);	// 현장대리인ID
        	this.dsWfSrm.set_enableevent(true);
        }
        ...
        this.setChangeEditAfter = function()
        {
        	if(this.parent.editYn == "Y")
        	{
        		...
        		{
        			Ex.util.setCompPropAll(this, this.reqInfo.PARENT_FORM.divForm.form["divFormWF_PROC_1000"], false);
        			this.reqInfo.PARENT_FORM.divForm.form["divFormWF_PROC_1000"].form.divWebEditor.form.initCreate(true);

        			if(this.reqInfo.PARENT_FORM.divForm.form["divFormWF_PROC_1000"].form.cboUpmu3)
        			{
        				this.reqInfo.PARENT_FORM.divForm.form["divFormWF_PROC_1000"].form.cboUpmu3.set_enable(true);
        				this.reqInfo.PARENT_FORM.divForm.form["divFormWF_PROC_1000"].form.cboUpmu3.set_readonly(false);
        			}
        		}
        	}
        }
        ...
        this.dsOnColumnChanged = function(obj,e)
        {
        	if(obj.id == "dsWfSrm")
        	{
        		if(e.columnid == "WORK_USER_ID")
        		{
        			this.fnSetWorkUserId(e.newvalue);
        		}
        		else if(e.columnid == "SITE_USER_ID")
        		{
        			this.fnSetSiteUserComp(e.newvalue);
        		}
        	}
        	obj.setUpdateRow(e);
        };
        ...
        this.loadIncludeScript("SR5017_D05.xfdl");
