(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"BOARD_TYPE_CD\" type=\"STRING\" size=\"256\"/><Column id=\"TITLE\" type=\"STRING\" size=\"256\"/><Column id=\"DEL_YN\" type=\"STRING\" size=\"256\"/><Column id=\"POST_YN\" type=\"STRING\" size=\"256\"/><Column id=\"DAT_TYPE_CD\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            ...
            obj = new Static("stcDatTypeCd","260","13","70","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("7");
            obj.set_text("공지구분");
            obj.set_cssclass("sta_WF_schTitle");
            this.divSearchArea.addChild(obj.name, obj);

            obj = new Combo("cboDatTypeCd","328","13","150","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("1");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\" band=\"left\"/><Column size=\"48\" band=\"left\"/><Column size=\"60\" band=\"left\"/><Column size=\"100\"/><Column size=\"600\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"250\"/><Column size=\"120\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"32\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"행상태\"/><Cell col=\"2\" text=\"번호\"/><Cell col=\"3\" text=\"공지구분\"/><Cell col=\"4\" text=\"제목\"/><Cell col=\"5\" text=\"첨부파일\"/><Cell col=\"6\" text=\"작성자\"/><Cell col=\"7\" text=\"부서/팀명\"/><Cell col=\"8\" text=\"등록일시\"/></Band><Band id=\"body\"><Cell displaytype=\"expr:FRID==Ex.util.getSession(&apos;gvUserId&apos;)? &apos;checkboxcontrol&apos; : &apos;none&apos;\" edittype=\"expr:FRID==Ex.util.getSession(&apos;gvUserId&apos;)? &apos;checkbox&apos; : &apos;none&apos;\" text=\"bind:CHK\"/><Cell col=\"1\" text=\"bind:ROWFLAG\"/><Cell col=\"2\" text=\"bind:BOARD_NO\" displaytype=\"text\" edittype=\"none\"/><Cell col=\"3\" text=\"bind:DAT_TYPE_CD\" displaytype=\"combotext\" combocodecol=\"CMM_CD\" combodatacol=\"CMM_CD_NM\" combodataset=\"dsDatTypeCd\"/><Cell col=\"4\" text=\"bind:TITLE\" cssclass=\"grdBCell_WF_event\" textAlign=\"left\"/><Cell col=\"5\" text=\"expr:ATCHFILE_YN==&apos;Y&apos;? &apos;theme://SPP_IMAGE_SET/WF/btn_WF_download_N.png&apos; : &apos;&apos;\" displaytype=\"imagecontrol\"/><Cell col=\"6\" text=\"bind:FRNM\"/><Cell col=\"7\" text=\"bind:FR_DEPT_NM\"/><Cell col=\"8\" text=\"bind:FRDT\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd HH:mm:ss\" calendareditformat=\"yyyy-MM-dd HH:mm:ss\"/></Band></Format><Format id=\"default_excel\"><Columns><Column size=\"40\"/><Column size=\"60\"/><Column size=\"100\"/><Column size=\"250\"/><Column size=\"250\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"32\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" autosizecol=\"none\"/><Cell col=\"1\" text=\"행상태\" autosizecol=\"none\"/><Cell col=\"2\" text=\"단어번호\"/><Cell col=\"3\" text=\"시스템언어 단어\"/><Cell col=\"4\" text=\"현재언어 단어\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:CHK\" autosizecol=\"none\"/><Cell col=\"1\" text=\"bind:ROWFLAG\" autosizecol=\"none\"/><Cell col=\"2\" text=\"bind:WORD_NO\"/><Cell col=\"3\" text=\"bind:SYS_WORD\"/><Cell col=\"4\" text=\"bind:SEL_WORD\" validation=\"단어;NULL\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("stcCnt","117.00","70","60","24",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("0 건");
        ...
        // User Script
        this.registerScript("FOMM0211_W.xfdl", function() {
        /***********************************************************************************
        * 화면(ID)		︰ FOMM0211_W
        * 화면(명)		︰ 공지사항조회
        * 메뉴(경로)	︰ 관리자 > 커뮤니티관리 > 공지사항조회
        * 화면 설명	︰ SPP 공지사항 조회
        * 작성자		︰ WEMB
        * 작성일		︰ 2023.04.06
        * 수정이력		︰
        ...
        ***********************************************************************************/
        ...
        this.fnSearchReset = function()
        {
        	...
        	this.dsCond.setColumn(this.dsCond.rowposition, 'POST_YN', 'Y');
        }
        ...
        this.loadIncludeScript("FOMM0211_W.xfdl");
