(function()
{
    return function()
    {
        ...
        {
            this.set_name("frmFOMM0220_W");
            this.set_titletext("자료실관리");
            ...
            obj._setContents("<ColumnInfo><Column id=\"BOARD_TYPE_CD\" type=\"STRING\" size=\"256\"/><Column id=\"TITLE\" type=\"STRING\" size=\"256\"/><Column id=\"DEL_YN\" type=\"STRING\" size=\"256\"/><Column id=\"DAT_TYPE_CD\" type=\"STRING\" size=\"256\"/><Column id=\"MENU_PARAM_CD\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            ...
            obj = new Static("stcExtCol1","Static00_00:0.00","13","85","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("12");
            obj.set_text("자료실구분");
            obj.set_cssclass("sta_WF_schTitle");
            this.divSearchArea.addChild(obj.name, obj);

            obj = new Combo("cboExtCol1","stcExtCol1:0","13","150","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("1");
            obj.set_cssclass("cbo_WF_normal");
            obj.set_codecolumn("CMM_CD");
            obj.set_datacolumn("CMM_CD_NM");
            obj.set_innerdataset("dsMenuParamCd");
            this.divSearchArea.addChild(obj.name, obj);

            obj = new Static("stcDatTypeCd","cboExtCol1:30.00","13","75","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("9");
            obj.set_text("자료구분");
            obj.set_cssclass("sta_WF_schTitle");
            this.divSearchArea.addChild(obj.name, obj);

            obj = new Combo("cboDatTypeCd","stcDatTypeCd:0","13","150","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("2");
            obj.set_cssclass("cbo_WF_normal");
            obj.set_codecolumn("CMM_CD");
            obj.set_datacolumn("CMM_CD_NM");
            ...
            obj = new Static("Static00_00_00","cboDatTypeCd:0.00","13","30","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("11");
            obj.set_background("#e5dbfa");
            obj.set_text("30");
            obj.set_textAlign("center");
            ...
            obj = new Static("stcDelYn","Static00_00_00:0.00","13","75","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("10");
            obj.set_text("삭제여부");
            obj.set_cssclass("sta_WF_schTitle");
            this.divSearchArea.addChild(obj.name, obj);

            obj = new Combo("cboDelYn","stcDelYn:0","13","150","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("3");
            obj.set_cssclass("cbo_WF_normal");
            obj.set_codecolumn("CMM_CD");
            obj.set_datacolumn("CMM_CD_NM");
            ...
            obj = new Grid("grdBoardMt","0","104",null,null,"0","40",null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\" band=\"left\"/><Column size=\"60\" band=\"left\"/><Column size=\"60\"/><Column size=\"150\"/><Column size=\"120\"/><Column size=\"450\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"80\"/><Column size=\"200\"/><Column size=\"120\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"32\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" autosizecol=\"none\"/><Cell col=\"1\" text=\"행상태\" autosizecol=\"none\"/><Cell col=\"2\" text=\"번호\"/><Cell col=\"3\" text=\"자료실구분\"/><Cell col=\"4\" text=\"자료구분\"/><Cell col=\"5\" text=\"제목\"/><Cell col=\"6\" text=\"첨부파일\"/><Cell col=\"7\" text=\"삭제여부\"/><Cell col=\"8\" text=\"작성자\"/><Cell col=\"9\" text=\"부서/팀명\"/><Cell col=\"10\" text=\"등록일시\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:CHK\" autosizecol=\"none\"/><Cell col=\"1\" text=\"bind:ROWFLAG\" autosizecol=\"none\"/><Cell col=\"2\" text=\"bind:BOARD_NO\" displaytype=\"expr:ROWFLAG==&apos;I&apos;? &apos;editcontrol&apos; : &apos;text&apos;\" edittype=\"expr:ROWFLAG==&apos;I&apos;? &apos;normal&apos; : &apos;none&apos;\" validation=\"시스템 기준 단어;NULL|DUP\"/><Cell col=\"3\" text=\"bind:EXT_COL1\" displaytype=\"combotext\" combocodecol=\"CMM_CD\" combodatacol=\"CMM_CD_NM\" combodataset=\"dsMenuParamCd\"/><Cell col=\"4\" text=\"bind:DAT_TYPE_CD\" displaytype=\"combotext\" combocodecol=\"CMM_CD\" combodatacol=\"CMM_CD_NM\" combodataset=\"dsDatTypeCd\"/><Cell col=\"5\" text=\"bind:TITLE\" cssclass=\"grdBCell_WF_event\" textAlign=\"left\"/><Cell col=\"6\" text=\"expr:ATCHFILE_YN==&apos;Y&apos;? &apos;theme://SPP_IMAGE_SET/WF/btn_WF_download_N.png&apos; : &apos;&apos;\" displaytype=\"imagecontrol\"/><Cell col=\"7\" text=\"bind:DEL_YN\" displaytype=\"combotext\" combocodecol=\"CMM_CD\" combodatacol=\"CMM_CD_NM\" combodataset=\"dsYnCd\"/><Cell col=\"8\" text=\"bind:FRNM\"/><Cell col=\"9\" text=\"bind:FR_DEPT_NM\"/><Cell col=\"10\" text=\"bind:FRDT\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd HH:mm:ss\" calendareditformat=\"yyyy-MM-dd HH:mm:ss\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item1","divSearchArea.form.cboDatTypeCd","value","dsCond","DAT_TYPE_CD");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","divSearchArea.form.cboDelYn","value","dsCond","DEL_YN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","divSearchArea.form.stcExtCol1","value","dsCond","DAT_TYPE_CD");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","divSearchArea.form.cboExtCol1","value","dsCond","MENU_PARAM_CD");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("FOMM0220_W.xfdl", function() {
        /***********************************************************************************
        * 화면(ID)		︰ FOMM0220_W
        * 화면(명)		︰ 자료실관리
        * 메뉴(경로)	︰ 관리자 > 커뮤니티관리 > 자료실관리
        * 화면 설명	︰ SPP 자료실 관리
        * 작성자		︰ WEMB
        * 작성일		︰ 2023.04.06
        * 수정이력		︰
        ...
        ***********************************************************************************/
        ...
        this.fnSearchReset = function()
        {
        	...
        	this.dsCond.setColumn(this.dsCond.rowposition, 'BOARD_TYPE_CD', 'REF');
        ...
        this.fnDelete = function(objDs)
        {
        	...
        	for(var i = objDs.rowcount-1; i >= 0; i--)
        		...
        		trace("----delete : ", this.dsFommBoardMt.getRowType(i))
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearchArea.form.cboExtCol1.addEventHandler("onkeydown",this.fnCommOnkeydown,this);
        ...
        this.loadIncludeScript("FOMM0220_W.xfdl");
