(function()
{
    return function()
    {
        ...
        {
            this.set_name("frmFOMM0221_W");
            this.set_titletext("자료실조회");
            ...
            obj = new Static("Static00_00","230","13","30","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("7");
            obj.set_background("#e5dbfa");
            obj.set_text("30");
            obj.set_textAlign("center");
            ...
            obj = new Static("stcDatTypeCd","edtTitle:30","13","70","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("6");
            obj.set_text("자료구분");
            obj.set_cssclass("sta_WF_schTitle");
            this.divSearchArea.addChild(obj.name, obj);

            obj = new Combo("cboDatTypeCd","stcDatTypeCd:-2","13","150","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("1");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\" band=\"left\"/><Column size=\"50\" band=\"left\"/><Column size=\"60\" band=\"left\"/><Column size=\"100\"/><Column size=\"600\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"250\"/><Column size=\"120\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"32\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"행상태\"/><Cell col=\"2\" text=\"번호\"/><Cell col=\"3\" text=\"자료구분\"/><Cell col=\"4\" text=\"제목\"/><Cell col=\"5\" text=\"첨부파일\"/><Cell col=\"6\" text=\"작성자\"/><Cell col=\"7\" text=\"부서/팀명\"/><Cell col=\"8\" text=\"등록일시\"/></Band><Band id=\"body\"><Cell text=\"bind:CHK\" displaytype=\"expr:FRID==Ex.util.getSession(&apos;gvUserId&apos;)? &apos;checkboxcontrol&apos; : &apos;none&apos;\" edittype=\"expr:FRID==Ex.util.getSession(&apos;gvUserId&apos;)? &apos;checkbox&apos; : &apos;none&apos;\"/><Cell col=\"1\" text=\"bind:ROWFLAG\"/><Cell col=\"2\" text=\"bind:BOARD_NO\" displaytype=\"expr:ROWFLAG==&apos;I&apos;? &apos;editcontrol&apos; : &apos;text&apos;\" edittype=\"expr:ROWFLAG==&apos;I&apos;? &apos;normal&apos; : &apos;none&apos;\" validation=\"시스템 기준 단어;NULL|DUP\"/><Cell col=\"3\" displaytype=\"combotext\" text=\"bind:DAT_TYPE_CD\" combocodecol=\"CMM_CD\" combodatacol=\"CMM_CD_NM\" combodataset=\"dsDatTypeCd\"/><Cell col=\"4\" text=\"bind:TITLE\" cssclass=\"grdBCell_WF_event\" textAlign=\"left\"/><Cell col=\"5\" text=\"expr:ATCHFILE_YN==&apos;Y&apos;? &apos;theme://SPP_IMAGE_SET/WF/btn_WF_download_N.png&apos; : &apos;&apos;\" displaytype=\"imagecontrol\"/><Cell col=\"6\" text=\"bind:FRNM\"/><Cell col=\"7\" text=\"bind:FR_DEPT_NM\"/><Cell col=\"8\" text=\"bind:FRDT\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd HH:mm:ss\" calendareditformat=\"yyyy-MM-dd HH:mm:ss\"/></Band></Format><Format id=\"default_excel\"><Columns><Column size=\"40\"/><Column size=\"60\"/><Column size=\"100\"/><Column size=\"250\"/><Column size=\"250\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"32\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" autosizecol=\"none\"/><Cell col=\"1\" text=\"행상태\" autosizecol=\"none\"/><Cell col=\"2\" text=\"단어번호\"/><Cell col=\"3\" text=\"시스템언어 단어\"/><Cell col=\"4\" text=\"현재언어 단어\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:CHK\" autosizecol=\"none\"/><Cell col=\"1\" text=\"bind:ROWFLAG\" autosizecol=\"none\"/><Cell col=\"2\" text=\"bind:WORD_NO\"/><Cell col=\"3\" text=\"bind:SYS_WORD\"/><Cell col=\"4\" text=\"bind:SEL_WORD\" validation=\"단어;NULL\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("stcGridTitle","0","70","131","24",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("자료실 목록");
            ...
            obj = new Static("stcCnt","111.00","70","60","24",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("0 건");
        ...
        // User Script
        this.registerScript("FOMM0221_W.xfdl", function() {
        /***********************************************************************************
        * 화면(ID)		︰ FOMM0221_W
        * 화면(명)		︰ 자료실조회
        * 메뉴(경로)	︰ 관리자 > 커뮤니티관리 > 자료실조회
        * 화면 설명	︰ SPP 자료실 조회
        * 작성자		︰ WEMB
        * 작성일		︰ 2023.04.06
        * 수정이력		︰
        ...
        ***********************************************************************************/
        ...
        this.fnSearchReset = function()
        {
        	...
        	this.dsCond.setColumn(this.dsCond.rowposition, 'MENU_PARAM_CD', this.MENU_PARAM_CD);
        }
        ...
        this.fnCompInit = function()
        {
        	...
        	// grid title setting
        	this.TITLE = this.dsMenuParamCd.getColumn( this.dsMenuParamCd.findRow('CMM_CD', this.MENU_PARAM_CD), 'CMM_CD_NM' )||'';
        	this.stcGridTitle.set_text(this.TITLE + ' 목록');
        	this.stcGridTitle.set_visible(true);
        ...
        this.fnOpenPop = function(BOARD_NO)
        {
        	...
        	if( Ex.isEmpty(BOARD_NO) ) {
        		...
        		var FRID = this.dsFommBoardMt.getColumn(this.dsFommBoardMt.rowposition, 'FRID');
        	...
        	Ex.core.popup(
        			...
        			{ title			: Ex.core.word(this.TITLE) + ' ' + Ex.core.word('상세'),
        			  pPopType		: pPopType,
        			  pBoardNo		: BOARD_NO,
        ...
        this.loadIncludeScript("FOMM0221_W.xfdl");
