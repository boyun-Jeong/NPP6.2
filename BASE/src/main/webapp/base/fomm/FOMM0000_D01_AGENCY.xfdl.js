(function()
{
    return function()
    {
        ...
        {
            this.set_name("FOMM0000_D01");
            this.set_titletext("직원FORM(DIV)");
            this.set_tooltiptext("초기화");
            this.set_visible("false");
            this.getSetter("scrollbars").set("none");
            if (Form == this.constructor)
            {
                this._setFormPosition(245,24);
            }
            ...
            obj = new Edit("edtUserId",null,"0","40%","24","0",null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Button("btnClear",null,"0","24","24","edtUserId:0.00%",null,null,null,null,null,this);
            obj.set_taborder("3");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",245,24,this,function(p){});
        ...
        // User Script
        this.addIncludeScript("FOMM0000_D01_AGENCY.xfdl","lib::lib_FommComm.xjs");
        this.registerScript("FOMM0000_D01_AGENCY.xfdl", function() {
        /***********************************************************************************
        ...
        ***********************************************************************************/
         ...
         * return Type 	: None
         */
        this.setValue = function (userId, userNm)
        {
        ...
        this.openUserPop = function(searchText)
        {
        	...
        	Ex.core.popup(
        		this,
        		'selectUserPop',
        		"fomm::FOMM0000_P01_AGENCY.xfdl",             		// <--- 팝업창 오픈 Url
        		{
        			title		: Ex.core.word('대직 위임관리 사용자'),
        			pSelType	: 'S',
        			pType		: "ID_NM",
        			...
        			pDepYn      : 'Y',       // <--- 본인 부서만 조회 되도록 하려면 'Y' 값 넘겨주면 됩니다.
        ...
        this.loadIncludeScript("FOMM0000_D01_AGENCY.xfdl");
