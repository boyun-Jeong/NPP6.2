(function()
{
    return function()
    {
        ...
        {
            this.set_name("frmFOMM0230_W");
            this.set_titletext("FAQ관리");
            ...
            obj = new Static("Static00_00_00","cboDatTypeCd:0","13","30","24",null,null,null,null,null,null,this.divSearchArea.form);
            obj.set_taborder("10");
            obj.set_background("#e5dbfa");
            obj.set_text("30");
            obj.set_textAlign("center");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\" band=\"left\"/><Column size=\"60\" band=\"left\"/><Column size=\"60\"/><Column size=\"120\"/><Column size=\"450\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"80\"/><Column size=\"200\"/><Column size=\"120\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"32\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" autosizecol=\"none\"/><Cell col=\"1\" text=\"행상태\" autosizecol=\"none\"/><Cell col=\"2\" text=\"번호\"/><Cell col=\"3\" text=\"FAQ구분\"/><Cell col=\"4\" text=\"제목\"/><Cell col=\"5\" text=\"첨부파일\"/><Cell col=\"6\" text=\"삭제여부\"/><Cell col=\"7\" text=\"작성자\"/><Cell col=\"8\" text=\"부서/팀명\"/><Cell col=\"9\" text=\"등록일시\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:CHK\" autosizecol=\"none\"/><Cell col=\"1\" text=\"bind:ROWFLAG\" autosizecol=\"none\"/><Cell col=\"2\" text=\"bind:BOARD_NO\" displaytype=\"expr:ROWFLAG==&apos;I&apos;? &apos;editcontrol&apos; : &apos;text&apos;\" edittype=\"expr:ROWFLAG==&apos;I&apos;? &apos;normal&apos; : &apos;none&apos;\" validation=\"시스템 기준 단어;NULL|DUP\"/><Cell col=\"3\" text=\"bind:DAT_TYPE_CD\" displaytype=\"combotext\" combocodecol=\"CMM_CD\" combodatacol=\"CMM_CD_NM\" combodataset=\"dsDatTypeCd\"/><Cell col=\"4\" text=\"bind:TITLE\" cssclass=\".Grid.grd_WF_normal .body .row .cell.grdBCell_WF_event\" textAlign=\"left\"/><Cell col=\"5\" text=\"expr:ATCHFILE_YN==&apos;Y&apos;? &apos;theme://SPP_IMAGE_SET/WF/btn_WF_download_N.png&apos; : &apos;&apos;\" displaytype=\"imagecontrol\"/><Cell col=\"6\" text=\"bind:DEL_YN\" displaytype=\"combotext\" combocodecol=\"CMM_CD\" combodatacol=\"CMM_CD_NM\" combodataset=\"dsYnCd\"/><Cell col=\"7\" text=\"bind:FRNM\"/><Cell col=\"8\" text=\"bind:FR_DEPT_NM\"/><Cell col=\"9\" text=\"bind:FRDT\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd HH:mm:ss\" calendareditformat=\"yyyy-MM-dd HH:mm:ss\"/></Band></Format><Format id=\"default_excel\"><Columns><Column size=\"40\"/><Column size=\"60\"/><Column size=\"100\"/><Column size=\"250\"/><Column size=\"250\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"32\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" autosizecol=\"none\"/><Cell col=\"1\" text=\"행상태\" autosizecol=\"none\"/><Cell col=\"2\" text=\"단어번호\"/><Cell col=\"3\" text=\"시스템언어 단어\"/><Cell col=\"4\" text=\"현재언어 단어\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:CHK\" autosizecol=\"none\"/><Cell col=\"1\" text=\"bind:ROWFLAG\" autosizecol=\"none\"/><Cell col=\"2\" text=\"bind:WORD_NO\"/><Cell col=\"3\" text=\"bind:SYS_WORD\"/><Cell col=\"4\" text=\"bind:SEL_WORD\" validation=\"단어;NULL\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("FOMM0230_W.xfdl", function() {
        /***********************************************************************************
        * 화면(ID)		︰ FOMM0230_W
        * 화면(명)		︰ FAQ관리
        * 메뉴(경로)	︰ 관리자 > 커뮤니티관리 > FAQ관리
        * 화면 설명	︰ SPP FAQ 관리
        * 작성자		︰ WEMB
        * 작성일		︰ 2023.04.06
        * 수정이력		︰
        ...
        ***********************************************************************************/
        ...
        this.fnSearchReset = function()
        {
        	...
        	this.dsCond.setColumn(this.dsCond.rowposition, 'BOARD_TYPE_CD', 'FAQ');
        ...
        this.fnOpenPop = function(BOARD_NO)
        {
        	...
        	Ex.core.popup(
        			this,
        			'noticePop',
        			"fomm::FOMM0230_P01.xfdl",             		// <--- 팝업창 오픈 Url
        			{ title			: Ex.core.word('FAQ') + ' ' + Ex.core.word('상세'),
        			  pPopType		: pPopType,
        			  pBoardNo		: BOARD_NO
        ...
        this.loadIncludeScript("FOMM0230_W.xfdl");
