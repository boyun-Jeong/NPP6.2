(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("직원/부서FORM(DIV)");
            ...
            obj = new Edit("edtDeptNm","136","0",null,"24","0",null,null,null,null,null,this);
            obj.set_taborder("3");
            ...
            obj = new Button("btnClear",null,"0","24","24","edtDeptNm:-1",null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Edit("edtDeptCd","376","0","90","24",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_visible("false");
            obj.set_cssclass("edt_WF_normal");
            obj.set_tabstop("false");
            ...
            obj = new BindItem("item2","edtDeptCd","value","dsUser","DEPT_CD");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","edtDeptNm","value","dsUser","DEPT_NM");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("FOMM0000_D02.xfdl","lib::lib_FommComm.xjs");
        this.registerScript("FOMM0000_D02.xfdl", function() {
        /***********************************************************************************
        ...
        ***********************************************************************************/
        	...
        	switch(pID)
        	{
        		case "selectUserPop" :
        			...
        			if(varValue.indexOf("Dataset id=") > -1)
        			{
        				...
        				this.edtDeptNm.set_tooltiptext(this.dsUser);
        ...
        {
        	trace("this.parent.BTN_SEARCH_V : " + this.parent.BTN_SEARCH_V);
        	trace("this.parent.BTN_CLEAR_V : " + this.parent.BTN_CLEAR_V);
        	trace("this.parent.DEPT_NM_V : " + this.parent.DEPT_NM_V);
        	...
        	if(Ex.isNvl(this.parent.DEPT_NM_V, "Y") != "Y")
        	{
        		this.edtDeptNm.set_visible(false);
        	}
        ...
        this.setDisplaynulltext = function (strUser, strDept)
        {
        	...
        	if( !Ex.isEmpty(strDept) )	this.edtDeptNm.set_displaynulltext(strDept);
        }
        /*
         * 함수명  	: setValue
         * 설명 		: 선택된 사용자 정보를 가져온다
        ...
        this.searchUserCallBack = function(rtnObj)
        {
        	...
        	if(rtnObj.ROWCOUNT == 1)
        	{
        		...
        		this.edtDeptNm.set_tooltiptext(rtnObj["USER_INFO"]);
        ...
        {
        	var comps = ["edtDeptNm", "btnClear", "btnSearchPop", "edtUserNm"];
        	...
        	for(var i=0; i<comps.length; i++)
        	{
        		...
        		{
        			if(this[comps[i]].id == "edtDeptNm")
        			{
        				this[comps[i]].set_left(136);
        				this[comps[i]].set_right(0);
        			}
        ...
        this.on_initEvent = function()
        {
            ...
            this.edtDeptNm.addEventHandler("onkeydown",this.edtUserNm_onkeydown,this);
        ...
        this.loadIncludeScript("FOMM0000_D02.xfdl");
