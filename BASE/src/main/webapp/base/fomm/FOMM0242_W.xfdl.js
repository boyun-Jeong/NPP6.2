(function()
{
    return function()
    {
        ...
        {
            this.set_name("FOMM0242_W");
            this.set_titletext("업무위임관리(PL권한)");
            ...
            obj = new Static("stcGrdTitle","0","70","105","24",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("위임 목록");
            ...
            obj = new Static("stcCnt","stcGrdTitle:0","70","60","24",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("0 건");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\" band=\"left\"/><Column size=\"200\"/><Column size=\"150\"/><Column size=\"200\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"500\"/><Column size=\"100\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"32\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" text=\"현재 업무담당자\"/><Cell col=\"2\" text=\"등록일자\"/><Cell col=\"3\" text=\"변경 업무담당자\"/><Cell col=\"4\" text=\"시작일\"/><Cell col=\"5\" text=\"종료일\"/><Cell col=\"6\" text=\"중단일자\"/><Cell col=\"7\" text=\"사유\"/><Cell col=\"8\" text=\"취소여부\"/></Band><Band id=\"body\"><Cell displaytype=\"text\" edittype=\"none\" expr=\"expr:currow+1\"/><Cell col=\"1\" text=\"bind:USER_INFO\" textAlign=\"left\"/><Cell col=\"2\" text=\"bind:FRDT\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd\"/><Cell col=\"3\" text=\"bind:AGENCY_USER_INFO\" textAlign=\"left\"/><Cell col=\"4\" text=\"bind:AGENCY_SDT\" textAlign=\"center\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd\"/><Cell col=\"5\" text=\"bind:AGENCY_EDT\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd\" textAlign=\"center\"/><Cell col=\"6\" text=\"bind:STOP_DT\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd\" textAlign=\"center\"/><Cell col=\"7\" text=\"bind:AGENCY_DESC\" textAlign=\"left\"/><Cell col=\"8\" text=\"bind:IS_ACTIVE\" combodataset=\"dsCancelCd\" combocodecol=\"CMM_CD\" combodatacol=\"CMM_CD_NM\" displaytype=\"combotext\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("7");
            obj.set_url("fomm::FOMM0000_D01_AGENCY.xfdl");
            ...
            //-- Default Layout : this.divChange.form.divOutChangeUser
            ...
            //-- Default Layout : this.divChange.form.divOutChangeAgencyUser
            ...
            obj = new BindItem("item0","divSearchArea.form.calBeginDate","value","dsCond","START_WRK_DTTM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","divSearchArea.form.calEndDate","value","dsCond","END_WRK_DTTM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","divSearchArea.form.edtSvcId","value","dsCond","SVC_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","divSearchArea.form.edtHostNm","value","dsCond","EXEC_HSTNM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","divSearchArea.form.edtNotiUserNm","value","dsCond","WRK_NAME");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","divSearchArea.form.edtNotiUserDeptNm","value","dsCond","WRK_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item13","divSearchArea.form.edtAgencyUserId","value","dsCond","AGENCY_USER_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item14","divSearchArea.form.edtUserId","value","dsCond","USER_ID");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        {
            this._addPreloadList("fdl","fomm::FOMM0000_D01_AGENCY.xfdl");
            this._addPreloadList("fdl","comm::comCheckboxDiv.xfdl");
            this._addPreloadList("fdl","fomm::FOMM0000_D01.xfdl");
        };
        
        // User Script
        this.registerScript("FOMM0242_W.xfdl", function() {
        /***********************************************************************************
        * 화면(ID)		︰ FOMM0240_W
        * 화면(명)		︰ 업무위임관리
        ...
        ***********************************************************************************/
        ...
        this.fnSearch03 = function()
        {
            ...
            var sService = "FOMM0240W/select03";    // 서비스명
            var sInDs = "dsCond=dsCond";            // 서버로 전송할 데이타셋 @ParamDataSet 인자와 맵핑됨
            var sOutDs = "dsMain=dsMain";           // 서버에서 수신할 데이타셋
            var sArg = "";                   		// 서버 @ParamVariable 인자와 맵핑됨
        	Ex.core.tran(this, sTranId, sService, sInDs, sOutDs, sArg);
        ...
        this.btnSet = function(obj, e, txt)
        {
        	...
        	if(txt == 'select01')
        	{
        		...
        		this.divChange.form.divOutChangeUser.form.setValue(Ex.util.getSession('gvUserId'), Ex.util.getSession('gvUserNm'));
        		...
        		//위임하는 사람 user_id 위임받는 사람 agency_user_id
        		this.dsAgency.setColumn(0, "USER_ID", Ex.util.getSession('gvUserId'));
        		this.dsAgency.setColumn(0, "USER_NM", Ex.util.getSession('gvUserNm'));
        ...
        this.loadIncludeScript("FOMM0242_W.xfdl");
