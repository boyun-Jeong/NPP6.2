(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("FOMM0231_W.xfdl", function() {
        /***********************************************************************************
        * 화면(ID)		︰ FOMM0231_W
        * 화면(명)		︰ FAQ조회
        * 메뉴(경로)	︰ 관리자 > 커뮤니티관리 > FAQ조회
        * 화면 설명	︰ SPP FAQ 조회
        * 작성자		︰ WEMB
        * 작성일		︰ 2023.04.06
        * 수정이력		︰
        ...
        ***********************************************************************************/
        ...
        this.loadIncludeScript("FOMM0231_W.xfdl");
