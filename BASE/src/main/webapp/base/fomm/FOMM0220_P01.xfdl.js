(function()
{
    return function()
    {
        ...
        {
            this.set_name("frmFOMM0220_P01");
            this.set_titletext("자료실 팝업");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CHK\" type=\"STRING\" size=\"256\"/><Column id=\"ROWFLAG\" type=\"STRING\" size=\"256\"/><Column id=\"BOARD_NO\" type=\"STRING\" size=\"256\"/><Column id=\"BOARD_TYPE_CD\" type=\"STRING\" size=\"256\"/><Column id=\"DAT_TYPE_CD\" type=\"STRING\" size=\"256\"/><Column id=\"EXT_COL1\" type=\"STRING\" size=\"256\"/><Column id=\"TITLE\" type=\"STRING\" size=\"256\"/><Column id=\"CONTS\" type=\"STRING\" size=\"256\"/><Column id=\"BEGIN_DT\" type=\"STRING\" size=\"256\"/><Column id=\"BEGIN_DATE\" type=\"STRING\" size=\"256\"/><Column id=\"BEGIN_TIME\" type=\"STRING\" size=\"256\"/><Column id=\"END_DT\" type=\"STRING\" size=\"256\"/><Column id=\"END_DATE\" type=\"STRING\" size=\"256\"/><Column id=\"END_TIME\" type=\"STRING\" size=\"256\"/><Column id=\"CHK_POP_YN\" type=\"STRING\" size=\"256\"/><Column id=\"POP_YN\" type=\"STRING\" size=\"256\"/><Column id=\"DEL_YN\" type=\"STRING\" size=\"256\"/><Column id=\"READ_CNT\" type=\"STRING\" size=\"256\"/><Column id=\"RMK\" type=\"STRING\" size=\"256\"/><Column id=\"REQ_TMPLAT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"FRNM\" type=\"STRING\" size=\"256\"/><Column id=\"FR_DEPT_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj = new Static("stcDatTypeCd","510.00","53","100","34",null,null,null,null,null,null,this.divContent.form);
            obj.set_taborder("14");
            obj.set_cssclass("sta_WF_inputTitle_E");
            obj.set_text("자료구분");
            this.divContent.addChild(obj.name, obj);

            obj = new Combo("cboDatDivCd","stcDatTypeCd:5.00","58",null,"24","Static00_01_00_00:5",null,null,null,null,null,this.divContent.form);
            obj.set_taborder("1");
            ...
            obj = new Div("divWebEditor","stcConts:5.00","123",null,null,"25","divFile:26",null,null,null,null,this.divContent.form);
            obj.set_taborder("3");
            ...
            obj = new Static("stcExtCol1","20","53","100","34",null,null,null,null,null,null,this.divContent.form);
            obj.set_taborder("15");
            obj.set_cssclass("sta_WF_inputTitle_E");
            obj.set_text("자료실구분");
            this.divContent.addChild(obj.name, obj);

            obj = new Combo("cboExtCol1","stcExtCol1:5","58",null,"24","stcDatTypeCd:5",null,null,null,null,null,this.divContent.form);
            obj.set_taborder("0");
            obj.set_cssclass("cbo_WF_normal");
            obj.set_codecolumn("CMM_CD");
            obj.set_datacolumn("CMM_CD_NM");
            ...
            obj.set_validationGroup("fvValiCmp");
            obj.set_validation("자료실구분;NULL");
            obj.set_text("");
            this.divContent.addChild(obj.name, obj);

            obj = new Static("stcBg01_00_01","21.00","86",null,"34","20",null,null,null,null,null,this.divContent.form);
            obj.set_taborder("16");
            obj.set_cssclass("sta_WF_inputBg");
            obj.set_text("");
            this.divContent.addChild(obj.name, obj);

            obj = new Static("stcTitle","20","86","100","34",null,null,null,null,null,null,this.divContent.form);
            obj.set_taborder("9");
            obj.set_cssclass("sta_WF_inputTitle_E");
            obj.set_text("제목");
            this.divContent.addChild(obj.name, obj);

            obj = new Edit("edtTitle","stcTitle:5.00","91",null,"24","25",null,null,null,null,null,this.divContent.form);
            obj.set_taborder("2");
            obj.set_cssclass("edt_WF_normal");
            ...
            obj = new Div("divComment","1000","0","400",null,null,"60",null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("div00");
            obj.set_visible("false");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item6","divContent.form.divTop.form.calFrdt","value","dsBoardMt","FRDT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","divContent.form.cboExtCol1","value","dsBoardMt","EXT_COL1");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("FOMM0220_P01.xfdl", function() {
        /***********************************************************************************
        * 화면(ID)		︰ FOMM0220_P01
        * 화면(명)		︰ 자료실 팝업
        * 메뉴(경로)	︰ 공통
        ...
        ***********************************************************************************/
        ...
        this.fnCompInit = function()
        {
        	...
        	var pReqTmplatId = this.getOwnerFrame().pReqTmplatId||'';
        	trace('pReqTmplatId >>>> ' ,  pReqTmplatId);

        	this.MENU_PARAM_CD = this.getOwnerFrame().pMenuParamCd||'';
        	if( !Ex.isEmpty(this.MENU_PARAM_CD) ) {
        		this.divContent.form.cboExtCol1.set_readonly(true);
        	}
        	...
        	switch(this.pPopType)
        	{
        		case "I" :
        			...
        			this.dsBoardMt.setColumn(rowPos, 'BOARD_TYPE_CD', 'REF');
        			this.dsBoardMt.setColumn(rowPos, 'EXT_COL1', this.MENU_PARAM_CD);
        			this.dsBoardMt.setColumn(rowPos, 'REQ_TMPLAT_ID',pReqTmplatId);
        			this.dsBoardMt.setColumn(rowPos, 'FRNM', Ex.util.getSession('gvUserNm'));
        			this.dsBoardMt.setColumn(rowPos, 'FR_DEPT_NM', Ex.util.getSession('gvDeptNm'));
        		...
        		default	 :
        			...
        			var oCmtParam = {
        				...
        				,fileUpYn		: 'N'							// 파일업로드권한; 공백 시 메뉴의 추가 권한
        				,deleteYn		: 'N'							// 파일삭제권한; 	 공백 시 메뉴의 삭제 권한
        			};
        			this.fnOpencomment(oCmtParam);
        ...
        this.loadIncludeScript("FOMM0220_P01.xfdl");
