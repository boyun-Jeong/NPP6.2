(function()
{
    return function()
    {
        ...
        {
            this.set_name("FOMM0710_W");
            this.set_titletext("체크리스트관리");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CHK\" type=\"STRING\" size=\"256\"/><Column id=\"ROWFLAG\" type=\"STRING\" size=\"256\"/><Column id=\"VERIF_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"UPMU_ID1\" type=\"STRING\" size=\"256\"/><Column id=\"UPMU_ID2\" type=\"STRING\" size=\"256\"/><Column id=\"UPMU_ID3\" type=\"STRING\" size=\"256\"/><Column id=\"USE_YN\" type=\"STRING\" size=\"256\"/><Column id=\"VERIF_CONT\" type=\"STRING\" size=\"256\"/><Column id=\"VERIF_REM\" type=\"STRING\" size=\"256\"/><Column id=\"REG_USER_ID\" type=\"STRING\" size=\"256\"/><Column id=\"REG_USER_NM\" type=\"STRING\" size=\"256\"/><Column id=\"REG_STIME\" type=\"STRING\" size=\"256\"/><Column id=\"LMOD_USER_ID\" type=\"STRING\" size=\"256\"/><Column id=\"LMOD_USER_NM\" type=\"STRING\" size=\"256\"/><Column id=\"SYSMODTIME\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows/>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\" band=\"left\"/><Column size=\"40\" band=\"left\"/><Column size=\"60\" band=\"left\"/><Column size=\"91\"/><Column size=\"394\"/><Column size=\"334\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"32\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"2\" text=\"행상태\"/><Cell col=\"3\" text=\"사용여부\"/><Cell col=\"4\" text=\"검증내용\"/><Cell col=\"5\" text=\"비고\"/></Band><Band id=\"body\"><Cell expr=\"expr:currow+1\"/><Cell col=\"1\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:CHK\"/><Cell col=\"2\" text=\"bind:ROWFLAG\"/><Cell col=\"3\" edittype=\"combo\" style=\"align:center;\" text=\"bind:USE_YN\" editlimit=\"6\" editdisplay=\"display\" displaytype=\"combocontrol\" combodataset=\"dsUseYn\" combocodecol=\"CMM_CD\" combodatacol=\"CMM_CD_NM\"/><Cell col=\"4\" style=\"align:center;\" text=\"bind:VERIF_CONT\" editlimit=\"5\" editdisplay=\"edit\" edittype=\"normal\" textAlign=\"left\"/><Cell col=\"5\" edittype=\"normal\" text=\"bind:VERIF_REM\" editdisplay=\"display\" textAlign=\"left\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btnTreeExpand","Static02:206","70","24","24",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("+");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btnSearchReset",null,"13","90","24","98",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_text("초기화");
        ...
        // User Script
        this.registerScript("FOMM0710_W.xfdl", function() {
        /***********************************************************************************
        * 화면(ID)	︰ FOMM0710_W
        * 화면(명)	︰ 체크리스트관리
        * 메뉴(경로)	︰ 표준정보관리 > 표준체크리스트관리 > 체크리스트관리
        * 화면 설명	︰
        * 작성자		︰ WEMB
        * 작성일		︰ 2025.02.26
        * 수정이력		︰
        ...
        ***********************************************************************************/
        ...
        this.fnSearch01 = function()
        {
            ...
            var sService = "FOMM0710W/select01";			// 서비스명
        ...
        this.fnSearch02 = function()
        {
        	...
        	var sService = "FOMM0710W/select02";			// 서비스명
        	var sInDs = "dsCond=dsCond";				// 서버로 전송할 데이타셋 @ParamDataSet 인자와 맵핑됨
        ...
        this.fnCommOnclick = function(obj, e)
        {
        	switch(obj.name)
        	{
        		...
        		case "btnDelete" :	// 삭제
        			if(this.dsClassTree.getColumn(this.dsClassTree.rowposition, "LVL") == "2")
        			{
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.edtSrchWord.addEventHandler("onkeydown",this.fnCommOnkeydown,this);
        ...
        this.loadIncludeScript("FOMM0710_W.xfdl");
