(function()
{
    return function()
    {
        ...
        {
            this.set_name("FOMM0241_W");
            this.set_titletext("업무위임관리(일반사용자)");
        ...
        // User Script
        this.registerScript("FOMM0241_W.xfdl", function() {
        /***********************************************************************************
        * 화면(ID)		︰ FOMM0241_W
        * 화면(명)		︰ 업무위임관리 (일반사용자)
        ...
        ***********************************************************************************/
        ...
        this.fnSearch01 = function()
        {
            ...
            var sService = "FOMM0240W/select02";    // 서비스명
        ...
        // 	this.dsCond.setColumn(0, "AGENCY_EDT", this.dsAgency.getColumn(0, "AGENCY_EDT"));
            ...
            var sService = "FOMM0240W/saveAdd2";	// 서비스명
        ...
        this.fnCallback = function (sSvcId, nErrorCode, sErrorMsg)
        {
        	...
        	switch (sSvcId)
        	{
        		...
        		case "saveDelete" :
        			Ex.core.toast(this, "관리자가 삭제되었습니다.", null, {toastType:'S'});
        			break;
        ...
        {
        	Ex.util.setBtnAlign(this.divChange.form.divGrdTopBtn1, 'right', true);
        	Ex.util.setBtnAlign(this.divChange.form.divGrdTopBtn2, 'right', true);
        	Ex.util.setBtnAlign(this.divChange.form.divGrdTopBtn3, 'right', true);
        	...
        	this.divChange.form.divOutChangeUser.form.btnSearchPop.enable = false;
        	this.divChange.form.divOutChangeUser.form.btnClear.enable = false;
        ...
        // 공통코드 조회
        	...
        	this.divSearchArea.form.divOutUser.form.edtUserId.set_value(Ex.util.getSession('gvUserId'));
        	this.divSearchArea.form.divOutUser.form.edtUserNm.set_value(Ex.util.getSession('gvUserNm'));
        }
        ...
        this.fnSaveCheck = function()
        {
        	...
        	{
        		var param = {id : "pAlertSrServAccntI", msg : "변경 업무담당자은(는) 필수 입력 항목입니다."};
        		Ex.core.error(this, param);
        		return false;
        	}
        ...
        this.btnSet = function(obj, e, txt)
        {
        	...
        	if(txt == 'select01')
        	{
        		...
        		this.divChange.form.divOutChangeAgencyUser.form.resetInput(false);
        ...
        this.on_initEvent = function()
        {
            ...
            this.divChange.form.txaAgencyDesc.addEventHandler("onchanged",this.divChange_txaAgencyDesc_onchanged,this);
        ...
        this.loadIncludeScript("FOMM0241_W.xfdl");
