(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divDeptTopBtn",null,"399","200","25","0",null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Grid("grdAuthUserDt","grdAuthMt:20.00","104",null,"275","0",null,null,null,null,null,this);
            obj.set_taborder("6");
            ...
            obj = new Static("stcUserTitle","grdAuthMt:20.00","70","211","24",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            ...
            obj = new Static("stcCntUserDt","1335","70","60","24",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("0 건");
            obj.set_cssclass("sta_WF_grdCnt");
            ...
            obj = new Grid("grdAuthDeptDt","grdAuthMt:20.00","grdAuthUserDt:55",null,null,"0","40",null,null,null,null,this);
            obj.set_taborder("14");
            ...
            obj = new Static("Static00_02","1124.00","379",null,"20","0",null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_background("#e5dbfa");
            obj.set_text("20");
            obj.set_textAlign("center");
            ...
            obj = new Static("stcCntDeptDt","1284.00","399","60","24",null,null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_text("0 건");
            obj.set_cssclass("sta_WF_grdCnt");
            ...
            obj = new Static("Static00_00_00","1124.00","424",null,"10","0",null,null,null,null,null,this);
            obj.set_taborder("18");
            obj.set_background("#e5dbfa");
            obj.set_text("10");
            obj.set_textAlign("center");
            ...
            obj = new Static("stc00","214","70","336","24",null,null,null,null,null,null,this);
            obj.set_taborder("19");
            obj.set_text("※ 개인별 권한관리는 [사용자관리] 메뉴에서 가능합니다.");
            obj.set_color("blue");
            this.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("FOMM0120_W.xfdl", function() {
        /***********************************************************************************
        * 화면(ID)		︰ FOMM0120_W
        * 화면(명)		︰ 권한그룹 관리
        ...
        ***********************************************************************************/
        ...
        this.fnSave = function()
        {
            ...
            var sInDs = "dsFommAuthMt=dsFommAuthMt:U dsFommAuthUserDt=dsFommAuthUserDt:U dsFommAuthDeptDt=dsFommAuthDeptDt:U dsCond=dsCond";
        ...
        this.dsFommAuthMt_onrowposchanged = function(obj,e)
        {
        	...
        	this.stcUserTitle.set_width(nWidth);
        ...
        this.loadIncludeScript("FOMM0120_W.xfdl");
