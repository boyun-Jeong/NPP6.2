(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("외주 - 서비스 요청 목록(미접수)");
            ...
            obj = new Dataset("dsData21", this);
            obj._setContents("<ColumnInfo><Column id=\"REQ_ID\" type=\"STRING\" size=\"256\"/><Column id=\"TITLE\" type=\"STRING\" size=\"256\"/><Column id=\"REQ_DATE\" type=\"STRING\" size=\"256\"/><Column id=\"COMPANY_NM\" type=\"STRING\" size=\"256\"/><Column id=\"REQ_WISH_DTIME\" type=\"STRING\" size=\"256\"/><Column id=\"WF_PROC_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            
            // UI Components Initialize
            obj = new Static("stcGrdTitle","10.00","10","230","24",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("서비스요청(미접수)");
            ...
            obj.set_binddataset("dsData21");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"150\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"요청ID\" cssclass=\"grdHCell_HOME_fCell\"/><Cell col=\"1\" text=\"제목\" textAlign=\"center\"/><Cell col=\"2\" text=\"요청일자\"/><Cell col=\"3\" text=\"진행단계\"/><Cell col=\"4\" text=\"희망완료일\"/></Band><Band id=\"body\"><Cell text=\"bind:REQ_ID\" color=\"blue\"/><Cell col=\"1\" text=\"bind:TITLE\" textAlign=\"left\"/><Cell col=\"2\" text=\"bind:REQ_DATE\" displaytype=\"date\"/><Cell col=\"3\" text=\"bind:WF_PROC_NM\"/><Cell col=\"4\" text=\"bind:REQ_WISH_DTIME\" displaytype=\"date\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        // User Script
        this.registerScript("sr_D07.xfdl", function() {
        /***********************************************************************************
        * 화면(ID)		︰ frHome_D00
        * 화면(명)		︰ -
        * 메뉴(경로)	︰ -
        ...
        ***********************************************************************************/
        ...
        {
        	var sTranId = "select21";               // transaction 서비스 실행 ID / 콜백에서 수신할 서비스ID
            var sService = "PJHOME/select21";       // 서비스명
            var sInDs = "dsCond=dsCond";            // 서버로 전송할 데이타셋 @ParamDataSet 인자와 맵핑됨
            var sOutDs = "dsData21=dsData";      		// 서버에서 수신할 데이타셋
        ...
        this.loadIncludeScript("sr_D07.xfdl");
