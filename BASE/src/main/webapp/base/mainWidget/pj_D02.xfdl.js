(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\" band=\"left\"/><Column size=\"100\"/><Column size=\"100\" band=\"right\"/><Column size=\"100\" band=\"right\"/><Column size=\"100\" band=\"right\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"32\"/></Rows><Band id=\"head\"><Cell text=\"구분\"/><Cell col=\"1\" text=\"제목\"/><Cell col=\"2\" text=\"등록일자\"/><Cell col=\"3\" text=\"등록자\"/><Cell col=\"4\" cssclass=\"cell_rightnoline\" text=\"종류\"/></Band><Band id=\"body\"><Cell text=\"bind:GUBUN\"/><Cell col=\"1\" text=\"bind:TITLE\" cssclass=\"grdBCell_WF_event\" textAlign=\"left\" tooltiptext=\"bind:TITLE\"/><Cell col=\"2\" displaytype=\"date\" text=\"bind:REG_STIME\" calendardateformat=\"yyyy-MM-dd\"/><Cell col=\"3\" text=\"bind:REG_USER_NM\"/><Cell col=\"4\" text=\"bind:TYPE_NAME\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("stcGrdTitle","10","10","140","24",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("의사소통/회의/보고");
        ...
        // User Script
        this.registerScript("pj_D02.xfdl", function() {
        /***********************************************************************************
        * 화면(ID)		︰ frHome_D00
        * 화면(명)		︰ -
        * 메뉴(경로)	︰ -
        ...
        ***********************************************************************************/
        ...
        this.grdData_oncellclick = function(obj,e)
        {
        	...
        	if(e.cell == obj.getBindCellIndex("body","TITLE"))
        	{
        		if(gubun == "회의")
        		{
        			Ex.core.popup(
        				this,					// <--- 팝업 실행 스코프
        				"meetingPop",			// <--- 팝업창 아이디(반드시 영문으로 입력 처리)
        				"pj::PJ0620_P01.xfdl",	// <--- 팝업창 오픈 Url
        				{
        					title	: "회의 상세",
        					pPjtId	: PJT_ID,
        					pPjtNm	: PJT_NAME,
        				...
        				"width=1050,height=750"				// <--- width/height/modeless(프레임 처리 옵션)
        			);
        			return;
        		}
        		else if(gubun == "보고")
        		{
        			Ex.core.popup(
        				this,					// <--- 팝업 실행 스코프
        				"reportPop",			// <--- 팝업창 아이디(반드시 영문으로 입력 처리)
        				"pj::PJ0410_P01.xfdl",	// <--- 팝업창 오픈 Url
        				{
        					title	: "보고 상세",
        					pPjtId	: PJT_ID,
        					pPjtNm  : PJT_NAME,
        ...
        this.loadIncludeScript("pj_D02.xfdl");
