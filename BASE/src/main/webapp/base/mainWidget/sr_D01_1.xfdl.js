(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divChart","123.00","15","268",null,null,"-20",null,null,null,null,this);
            obj.set_taborder("14");
            ...
            obj = new Div("divChart2","377.00","15",null,null,"-10","-15",null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_url("comm::comHighChartDiv.xfdl");
            obj.set_async("true");
            obj.set_border("0px none");
            ...
            obj.set_taborder("1");
            obj.set_text("IT 작업신청");
            obj.set_cssclass("sta_WF_gridTitle");
            this.addChild(obj.name, obj);

            obj = new Static("Static00","57.78%","10","1",null,null,"10",null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Div("divIco01_01_01_00_00_00","9.00","53","113","33",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_edge("url(\'theme://MIRAE_IMAGE_SET/HOME/main-circlechart02-num.png\')");
            this.addChild(obj.name, obj);

            obj = new Div("divIco01_01_01_00_00_00_00","9.00","divIco01_01_01_00_00_00:14","113","33",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_edge("url(\'theme://MIRAE_IMAGE_SET/HOME/main-circlechart02-num.png\')");
            this.addChild(obj.name, obj);

            obj = new Div("divIco01_01_01_00_00_00_02","9.00","divIco01_01_01_00_00_00_00:14","113","33",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_edge("url(\'theme://MIRAE_IMAGE_SET/HOME/main-circlechart02-num.png\')");
            this.addChild(obj.name, obj);

            obj = new Div("divIco01_01_01_00_00_00_01","9.00","divIco01_01_01_00_00_00_02:14","113","33",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_edge("url(\'theme://MIRAE_IMAGE_SET/HOME/main-circlechart02-num.png\')");
            this.addChild(obj.name, obj);

            obj = new Static("stcCntStep01","7.00","53","65","26",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            ...
            obj = new Static("stcCntStep01_00","7.00","100","65","26",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            ...
            obj = new Static("stcCntStep01_00_00","7.00","147","65","26",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_color("white");
            obj.set_font("10px \'KoPubL\'");
            obj.set_verticalAlign("middle");
            ...
            obj = new Static("stcCntStep01_00_00_00","7.00","194","65","26",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("기타");
            obj.set_color("white");
            obj.set_font("10px \'KoPubL\'");
            ...
            obj = new Static("stcCntStep01_02_00_01","72.00","56","40","30",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("2");
            ...
            obj = new Static("stcCntStep01_02_00_00_01","72.00","103","40","30",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("1");
            obj.set_color("#3e3e46");
            obj.set_font("18px \'KoPubL\'");
            ...
            obj = new Static("stcCntStep01_02_00_00_00_01","72.00","150","40","30",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("1");
            obj.set_color("#3e3e46");
            obj.set_font("18px \'KoPubL\'");
            ...
            obj = new Static("stcCntStep01_02_00_00_00_00_00","72.00","197","40","30",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("4");
            obj.set_color("#3e3e46");
            obj.set_font("18px \'KoPubL\'");
            ...
            obj = new BindItem("item0","stcCntStep01_02_00_01","text","dsData","CHM_SUM0");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","stcCntStep01_02_00_00_01","text","dsData","CHM_SUM1");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","stcCntStep01_02_00_00_00_00_00","text","dsData","CHM_SUM3");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","stcCntStep01_02_00_00_00_01","text","dsData","CHM_SUM2");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","stcCntStep01","text","dsData","SUM1_NAME0");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","stcCntStep01_00","text","dsData","SUM1_NAME1");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","stcCntStep01_00_00","text","dsData","SUM1_NAME2");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item7","stcCntStep01_00_00_00","text","dsData","SUM1_NAME3");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("sr_D01_1.xfdl", function() {
        /***********************************************************************************
        * 화면(ID)		︰ frHome_D00
        * 화면(명)		︰ -
        * 메뉴(경로)	︰ -
        ...
        ***********************************************************************************/
        ...
        this.fnDrawChart = function()
        {
        	...
        	this.divChart.form.drawChart(chartScript);
        		...
        		//데이터 가공 시작
        	this.dsChart2.clearData();
        	for(var i=0; i<4; i++)
        	{
        		var aRow = this.dsChart2.addRow();
        		this.dsChart2.setColumn(aRow, "GBN",  this.dsData.getColumn(0, "SUM1_NAME"+aRow));
        		this.dsChart2.setColumn(aRow, "CNT", this.dsData.getColumn(0, "CHM_SUM"+aRow));
        	}
        	//데이터 가공 끝
        ...
        this.loadIncludeScript("sr_D01_1.xfdl");
