(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("sr_D08.xfdl", function() {
        /***********************************************************************************
        * 화면(ID)		︰ frHome_D00
        * 화면(명)		︰ -
        * 메뉴(경로)	︰ -
        ...
        ***********************************************************************************/
        ...
        this.fnSearch = function()
        {
        	...
        	var sTranId = "select22";               // transaction 서비스 실행 ID / 콜백에서 수신할 서비스ID
            var sService = "PJHOME/select22";       // 서비스명
            var sInDs = "dsCond=dsCond";            // 서버로 전송할 데이타셋 @ParamDataSet 인자와 맵핑됨
            var sOutDs = "dsData22=dsData";      		// 서버에서 수신할 데이타셋
        ...
        this.loadIncludeScript("sr_D08.xfdl");
