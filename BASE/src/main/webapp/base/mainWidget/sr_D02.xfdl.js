(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("현업 - 서비스 요청 현황");
        ...
        // User Script
        this.registerScript("sr_D02.xfdl", function() {
        /***********************************************************************************
        * 화면(ID)		︰ frHome_D00
        * 화면(명)		︰ -
        * 메뉴(경로)	︰ -
        ...
        ***********************************************************************************/
        ...
        {
        	var sTranId = "select14";                       // transaction 서비스 실행 ID / 콜백에서 수신할 서비스ID
            var sService = "PJHOME/select14";            // 서비스명
        ...
        this.loadIncludeScript("sr_D02.xfdl");
