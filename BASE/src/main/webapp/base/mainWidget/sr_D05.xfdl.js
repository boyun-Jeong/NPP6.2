(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("외주 - 서비스 처리 현황");
        ...
        // User Script
        this.registerScript("sr_D05.xfdl", function() {
        /***********************************************************************************
        * 화면(ID)		︰ frHome_D00
        * 화면(명)		︰ -
        * 메뉴(경로)	︰ -
        ...
        ***********************************************************************************/
        ...
        this.fnSearch = function()
        {
            ...
            var sService = "PJHOME/select24";       // 서비스명
        ...
        this.loadIncludeScript("sr_D05.xfdl");
