(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"260\"/><Column size=\"60\" band=\"right\"/><Column size=\"90\" band=\"right\"/><Column size=\"90\" band=\"right\"/><Column size=\"80\" band=\"right\"/><Column size=\"70\" band=\"right\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"32\"/></Rows><Band id=\"head\"><Cell text=\"제목\"/><Cell col=\"1\" text=\"구분\"/><Cell col=\"2\" text=\"식별일자\"/><Cell col=\"3\" text=\"처리기한\"/><Cell col=\"4\" text=\"담당자\"/><Cell col=\"5\" cssclass=\"cell_rightnoline\" text=\"상태\"/></Band><Band id=\"body\"><Cell cssclass=\"grdBCell_WF_event\" text=\"bind:TITLE\" textAlign=\"left\" tooltiptext=\"bind:TITLE\"/><Cell col=\"1\" text=\"bind:GUBUN\"/><Cell col=\"2\" displaytype=\"date\" text=\"bind:ACK_DATE\" calendardateformat=\"yyyy-MM-dd\"/><Cell col=\"3\" displaytype=\"date\" text=\"bind:DUE_DATE\" calendardateformat=\"yyyy-MM-dd\"/><Cell col=\"4\" text=\"bind:CHARGE_NM\"/><Cell col=\"5\" cssclass=\"cell_rightnoline\" text=\"bind:STATUS_NAME\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("pj_D03.xfdl", function() {
        /***********************************************************************************
        * 화면(ID)		︰ frHome_D00
        * 화면(명)		︰ -
        * 메뉴(경로)	︰ -
        ...
        ***********************************************************************************/
        ...
        this.fnSearch = function()
        {
            ...
            var sService = "PJHOME/select04";            // 서비스명
        ...
        this.grdData_oncellclick = function(obj,e)
        {
        	if( e.cell == obj.getBindCellIndex('body', 'TITLE') ) {
        		...
        		var gubun		= ds.getColumn(e.row, "GUBUN");
        		...
        		if(gubun == "위험")
        		{
        			Ex.core.popup(
        				this,					// <--- 팝업 실행 스코프
        				"riskPop",			// <--- 팝업창 아이디(반드시 영문으로 입력 처리)
        		...
        		else if(gubun == "이슈")
        		{
        			Ex.core.popup(
        				this,					// <--- 팝업 실행 스코프
        				"issuePop",			// <--- 팝업창 아이디(반드시 영문으로 입력 처리)
        				"pj::PJ3200_P01.xfdl",	// <--- 팝업창 오픈 Url
        				{
        					title		: "이슈관리 상세",
        					pPjtId		: PJT_ID,
        					pPjtNm		: PJT_NAME,
        ...
        this.loadIncludeScript("pj_D03.xfdl");
