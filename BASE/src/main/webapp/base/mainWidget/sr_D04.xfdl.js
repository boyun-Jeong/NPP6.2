(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_binddataset("dsReqData");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"150\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"요청번호\" cssclass=\"grdHCell_HOME_fCell\"/><Cell col=\"1\" text=\"요청제목\"/><Cell col=\"2\" text=\"요청일자\"/><Cell col=\"3\" text=\"상태\"/><Cell col=\"4\" text=\"완료예정\"/></Band><Band id=\"body\"><Cell text=\"bind:REQ_ID\" color=\"blue\" cursor=\"pointer\"/><Cell col=\"1\" text=\"bind:TITLE\" textAlign=\"left\"/><Cell col=\"2\" text=\"bind:REQ_DATE\"/><Cell col=\"3\" text=\"bind:WF_PROC_NM\"/><Cell col=\"4\" text=\"bind:REQ_WISH_D\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("sr_D04.xfdl", function() {
        /***********************************************************************************
        * 화면(ID)		︰ frHome_D00
        * 화면(명)		︰ -
        * 메뉴(경로)	︰ -
        ...
        ***********************************************************************************/
        ...
        {
        	var sTranId = "select09";                       // transaction 서비스 실행 ID / 콜백에서 수신할 서비스ID
            var sService = "PJHOME/select09";            // 서비스명
            var sInDs = "dsCond=dsCond";                  	// 서버로 전송할 데이타셋 @ParamDataSet 인자와 맵핑됨
            var sOutDs = "dsReqData=dsReqData";       	// 서버에서 수신할 데이타셋
        ...
        this.loadIncludeScript("sr_D04.xfdl");
