(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new CheckBox("chkUnFilter","331","10","80","20",null,null,null,null,null,null,this.tab.tpgDsList.form);
            obj.set_taborder("4");
            obj.set_text("필터제거");
            this.tab.tpgDsList.addChild(obj.name, obj);
            ...
            obj = new Static("stcCnt","chkUnFilter:0","8","60","24",null,null,null,null,null,null,this.tab.tpgDsList.form);
            obj.set_taborder("8");
            obj.set_text("0 건");
            obj.set_cssclass("sta_WF_grdCnt");
            obj.set_countDataset("dsCurrent");
            this.tab.tpgDsList.addChild(obj.name, obj);
            ...
            obj = new Button("btn_tblReload","Static00:5","10","57","24",null,null,null,null,null,null,this.tab.tpgCreQuery.form);
            obj.set_taborder("11");
            obj.set_text("갱신");
            this.tab.tpgCreQuery.addChild(obj.name, obj);

            obj = new Combo("cboTblNm","btn_tblReload:5","10","328","24",null,null,null,null,null,null,this.tab.tpgCreQuery.form);
            obj.set_taborder("10");
            obj.set_innerdataset("dsTblList");
            obj.set_codecolumn("TBL_CD");
            obj.set_datacolumn("TBL_FULL_NM");
            ...
            obj = new Button("btn_exec",null,"10","77","25","txt_format:10",null,null,null,null,null,this.tab.tpgCreDataset.form);
            obj.set_taborder("4");
            obj.set_text("생성");
            this.tab.tpgCreDataset.addChild(obj.name, obj);

            obj = new Edit("edt_id","Static00:10.00","10",null,"25","btn_exec:2",null,null,null,null,null,this.tab.tpgCreDataset.form);
            obj.set_taborder("1");
            this.tab.tpgCreDataset.addChild(obj.name, obj);
            ...
            obj = new Tabpage("tabSessionInfo",this.tab);
            obj.set_text("세션정보");
            this.tab.addChild(obj.name, obj);

            obj = new TextArea("txaSessionInfo","20","54","48%",null,null,"20",null,null,null,null,this.tab.tabSessionInfo.form);
            obj.set_taborder("0");
            obj.set_readonly("true");
            this.tab.tabSessionInfo.addChild(obj.name, obj);

            obj = new TextArea("txaAuthInfo",null,"54","48%",null,"20","20",null,null,null,null,this.tab.tabSessionInfo.form);
            obj.set_taborder("1");
            obj.set_readonly("true");
            this.tab.tabSessionInfo.addChild(obj.name, obj);

            obj = new Static("Static00","20","20","195","24",null,null,null,null,null,null,this.tab.tabSessionInfo.form);
            obj.set_taborder("2");
            obj.set_text("세션정보");
            this.tab.tabSessionInfo.addChild(obj.name, obj);

            obj = new Static("Static00_00",null,"20","48%","24","20",null,null,null,null,null,this.tab.tabSessionInfo.form);
            obj.set_taborder("3");
            obj.set_text("권한정보");
            this.tab.tabSessionInfo.addChild(obj.name, obj);
            // Layout Functions
            ...
            //-- Default Layout : this.tab.tabSessionInfo.form
            obj = new Layout("default","",0,0,this.tab.tabSessionInfo.form,function(p){});
            this.tab.tabSessionInfo.form.addLayout(obj.name, obj);
        ...
        // User Script
        this.registerScript("datasetList.xfdl", function() {
        /***********************************************************************************
        * 화면(명)		︰ DEBUG/UTIL
        * 메뉴(경로)	︰ 공통관리 > 플랫폼 > 공통
        * 화면 설명	︰ 공통
        ...
        ***********************************************************************************/
        ...
        this.fnCallback = function (sSvcId, nErrorCode, sErrorMsg)
        {
        	...
        	switch (sSvcId)
        	{
        		case "select01" : // 서비스 ID
        			...
        			nexacro.getApplication().gdsTblList.assign(this.dsTblList);
        			break;
        	}
        }
        ...
        {
        	if (this.dsCurrent == null) return;
        	if (this.chkUnFilter.value)	this.dsCurrent.filter("");
        };
        ...
        this.grdDatasetList_oncellclick = function (obj, e)
        {
        	...
        	this.tab.tpgDsList.form.stcCnt.setCountDataset(this.dsCurrent);
        };
        ...
        this.btn_exec_onclick = function(obj,e)
        {
        	...
        	if(this.tab.tabpages[this.tab.tabindex].id == "tpgCreQuery")
        	{
        		...
        		if(this.tab.tabpages[this.tab.tabindex].id == "tpgCreQuery")
        		{
        			...
        			if (cols.length > 0)
        			{
        				var selQuery = '\t<select id="select01" parameterType="java.util.Map" resultType="java.util.Map">';
        				selQuery += '\n\t\tSELECT';
        				var tblNm = Ex.isEmpty(this.tab.tabpages["tpgCreQuery"].form.cboTblNm.value) ? "" : this.tab.tabpages["tpgCreQuery"].form.cboTblNm.value.toUpperCase();
        ...
        this.tab_tpgCreQuery_btn_tblReload_onclick = function(obj,e)
        {
        	this.searchTblList();
        };
        ...
        this.tab_onchanged = function(obj,e)
        {
        	if(e.postindex == 1)
        	{
        		if(nexacro.getApplication().gdsTblList.rowcount == 0)
        		{
        			this.searchTblList();
        		}
        		else
        		{
        			this.dsTblList.assign(nexacro.getApplication().gdsTblList);
        		}
        	}
        	// session정보 setting
        	var txaSession 	= this.tab.tabSessionInfo.form.txaSessionInfo;

        	var value = '';
        	value += '접속도메인 :: ' + Ex.domainUrl();
        	value += '\n\n';

        	var oSession = Ex.util.getSession('session');
        	value += "---- 전체 session값 목록----\n";
        	for(var key in oSession) {
        		value += 'key:: ' + key + '\t\t value:: ' + oSession[key] + '\n';
        	}
        	txaSession.set_value(value);

        	// 권한정보 setting
        	var taxAuth		= this.tab.tabSessionInfo.form.txaAuthInfo;
        	var formObj		= this.getOwnerFrame().formObj
        	var oAuth = Ex.util.getMenuAuth(formObj);
        	var menuInfo = formObj.parent.parent.getOwnerFrame().info;

        	var value = '';
        	if( Ex.isEmpty(menuInfo) ) {
        		value += '호출 화면 :: work화면이 아닙니다.\n\n';
        	}
        	else {
        		value += '메뉴ID :: 	 ' + menuInfo.menuId + '\n';
        		value += '상위메뉴ID :: ' + menuInfo.upMenuId + '\n';
        		value += '메뉴명 :: 	 ' + menuInfo.menuNm + '\n';
        		value += '메뉴URL :: 	 ' + menuInfo.menuUrl + '\n';
        		value += '메뉴경로 :: 	 ' + menuInfo.menuPathNm + '\n';
        		value += '화면ID :: 	 ' + menuInfo.screenId + '\n';
        		value += '\n';
        	}

        	for(var key in oAuth) {
        		value += 'key:: ' + key + '\t\t :: ' + oAuth[key] + '\n';
        	}

        	taxAuth.set_value(value);
        };
        });
        ...
        this.on_initEvent = function()
        {
            ...
            this.tab.tpgCreQuery.form.btn_tblReload.addEventHandler("onclick",this.tab_tpgCreQuery_btn_tblReload_onclick,this);
        ...
        this.loadIncludeScript("datasetList.xfdl");
