(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divUrl","0","50",null,null,"0","0",null,null,null,null,this);
            obj.set_taborder("0");
            obj.getSetter("scrollbars").set("autovert");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Static("stcTitle","0","5",null,"40","0",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_cssclass("sta_POP_msg_title");
            this.addChild(obj.name, obj);

            obj = new Static("stcBgLineTop","0","0",null,"5","0",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_background("#4580ff");
            this.addChild(obj.name, obj);

            obj = new Static("stcBgLineTop00","20","44",null,"1","20",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_background("#dfdfdf");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this.divUrl.form
            obj = new Layout("default","",0,0,this.divUrl.form,function(p){});
            this.divUrl.form.addLayout(obj.name, obj);
        ...
        // User Script
        this.registerScript("comPop.xfdl", function() {
        /***********************************************************************************
        * 화면(명)	︰ 공통
        * 메뉴(경로)	︰ 공통관리 > 플랫폼 > 공통
        * 화면 설명	︰ 공통 팝업
        ...
        ***********************************************************************************/
        ...
        this.popupLoadComplete = function(form, divContObj, divBtnObj)
        {
        ...
        this.comPop_onkeyup = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("onsize",this.comPop_onsize,this);
            this.addEventHandler("onkeyup",this.comPop_onkeyup,this);
        };
        this.loadIncludeScript("comPop.xfdl");
