(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("HtmlReportViewerPop.xfdl", function() {
        /***********************************************************************************
        * 화면(ID)	︰ comJasperReportViewerPop
        * 화면(명)	︰ htmlReport Viewer Popup
        * 메뉴(경로)	︰
        * 화면 설명	︰
        * 작성자		︰ WEMB
        * 작성일		︰ 2025.01.13
        ...
        ***********************************************************************************/
        ...
        {
        	this.getOwnerFrame().set_titletext("HtmlReports Viewer");

        	//trace("this.getOwnerFrame() : ", this.getOwnerFrame())
        	if( Ex.isEmpty(this.getOwnerFrame().pDbConn) )
        	{
        		var param = {id : "ERROR", msg : "연결할 DB 정보가 지정되지 않았습니다."};
        	...
        	else
        	{
        		...
        		var reportUrl = nexacro.getEnvironment().services["svc_url"].url + "htmlReport/viewer?";
        		reportUrl += "CONN_NM="+encodeURIComponent(this.getOwnerFrame().pDbConn);

        		var dsParam = this.getOwnerFrame().pDsParam;
        		...
        		this.divViewer.form.wevReport.set_url(reportUrl);
        ...
        this.loadIncludeScript("HtmlReportViewerPop.xfdl");
