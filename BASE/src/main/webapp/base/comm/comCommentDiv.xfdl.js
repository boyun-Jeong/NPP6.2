(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"COMMENT_NO\" type=\"STRING\" size=\"256\"/><Column id=\"KEY_TBL\" type=\"STRING\" size=\"256\"/><Column id=\"PK1\" type=\"STRING\" size=\"256\"/><Column id=\"PK2\" type=\"STRING\" size=\"256\"/><Column id=\"PK3\" type=\"STRING\" size=\"256\"/><Column id=\"EXT_COL_1\" type=\"STRING\" size=\"256\"/><Column id=\"EXT_COL_2\" type=\"STRING\" size=\"256\"/><Column id=\"EXT_COL_3\" type=\"STRING\" size=\"256\"/><Column id=\"EXT_COL_4\" type=\"STRING\" size=\"256\"/><Column id=\"EXT_COL_5\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            ...
            obj = new Div("divInput","0",null,null,"50","0","0",null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Button("btnSave",null,"5","80",null,"5","5",null,null,null,null,this.divInput.form);
            obj.set_taborder("1");
            obj.set_text("댓글 등록");
            ...
            obj = new TextArea("txaInput","5","5",null,null,"btnSave:5","5",null,null,null,null,this.divInput.form);
            obj.set_taborder("0");
            obj.set_cssclass("txa_WF_normal");
            obj.set_wordWrap("char");
            obj.set_validationGroup("fvValiCmp");
            obj.set_validation("댓글내용;NULL");
            obj.set_tooltiptext("Ctrl+<ENTER> 등록");
            obj.set_text("");
            this.divInput.addChild(obj.name, obj);

            obj = new Div("divComment","0","0",null,null,"0","divInput:0",null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_background("white");
            obj.set_visible("false");
            obj.set_border("1px solid #dfdfdf");
            ...
            obj = new BindItem("item0","divInput.form.txaInput","value","dsComment","COMMENT_CONTS");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("comCommentDiv.xfdl", function() {
        /***********************************************************************************
        * 화면(명)	︰ 공통 댓글 div
        * 메뉴(경로)	︰ -
        * 화면 설명	︰
        ...
        ***********************************************************************************/
        ...
        this.fnDeleteOnclick = function(obj, e)
        {
        ...
        this.fnConfirmOnclick = function(obj, e)
        {
        ...
        this.divInput_txaInput_onkeydown = function(obj,e)
        {
        	if( e.ctrlkey) {
        		if( e.keycode == 13 )
        ...
        this.txaComment_onchanged = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divInput.form.btnSave.addEventHandler("onclick",this.fnCommOnclick,this);
            this.divInput.form.txaInput.addEventHandler("onkeydown",this.divInput_txaInput_onkeydown,this);
            this.divInput.form.txaInput.addEventHandler("onchanged",this.divInput_txaInput_onchanged,this);
            this.dsComment.addEventHandler("oncolumnchanged",this.fnCommOncolumnchanged,this);
        };
        this.loadIncludeScript("comCommentDiv.xfdl");
