(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divLogin","710","111","500","655",null,null,null,null,null,null,this);
            obj.set_taborder("0");
        ...
        // User Script
        this.addIncludeScript("frLogin_bak.xfdl","lib::comSHA256.xjs");
        this.registerScript("frLogin_bak.xfdl", function() {
        /***********************************************************************************
        * 화면(명)		︰ 공통
        * 메뉴(경로)	︰ 공통관리 > 플랫폼 > 공통
        * 화면 설명	︰ 공통
        		...
        		case "login" :
        			...
        			if (this.isAuthenticated === "true" && this.objApp.gdsSession.rowcount > 0 )
        			{
        				...
        				if( MKEY_LOGIN_YN == 'N' )
        				{
        					...
        					if( (Ex.util.today() > PW_EXP_DT) || (sha256_digest(sUserId) == USER_PW) || Ex.isEmpty(PW_INIT_DT) ) {
        						Ex.core.popup(
        							this,											// <--- 팝업 실행 스코프
        ...
        ***********************************************************************************/
        ...
        this.loadIncludeScript("frLogin_bak.xfdl");
