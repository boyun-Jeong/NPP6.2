(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static00","190.00","540","230","75",null,null,null,null,null,null,this.divLogin.form);
            obj.set_taborder("4");
            obj.set_text("※ 비밀번호\r\n - 직원 : WeMB OTP\r\n - 외주 : 메신저(Mi-SQUARE) 비밀번호");
            obj.set_verticalAlign("top");
            this.divLogin.addChild(obj.name, obj);

            obj = new Static("stcUrl","270.00","540","150","25",null,null,null,null,null,null,this.divLogin.form);
            obj.set_taborder("8");
            obj.set_color("red");
            ...
            obj = new Edit("edtUserPw","80","478",null,"48","80",null,null,null,null,null,this.divLogin.form);
            obj.set_taborder("1");
            ...
            obj = new Div("divLoginImg","0%","0",null,"380","0",null,null,null,null,null,this.divLogin.form);
            obj.set_taborder("2");
            obj.set_cssclass("div_LG_loginImg");
            obj.set_tabstop("false");
            this.divLogin.addChild(obj.name, obj);

            obj = new Static("test","40.00","36","150","25",null,null,null,null,null,null,this.divLogin.form.divLoginImg.form);
            obj.set_taborder("0");
            obj.set_color("white");
            obj.set_textDecoration("underline");
            obj.set_cursor("pointer");
            ...
            obj = new Edit("edtUserId","80","divLoginImg:40",null,"48","80",null,null,null,null,null,this.divLogin.form);
            obj.set_taborder("0");
            obj.set_displaynulltext("아이디를 입력하세요");
            obj.set_cssclass("edt_LG_input");
            this.divLogin.addChild(obj.name, obj);

            obj = new Button("btnMpassLogin",null,null,"170","64","80","edtUserId:10",null,null,null,null,this.divLogin.form);
            obj.set_taborder("3");
            ...
            obj = new CheckBox("chkSaveId","16.00%","536","120","24",null,null,null,null,null,null,this.divLogin.form);
            obj.set_taborder("6");
            obj.set_text("아이디저장");
            ...
            obj = new Button("btnPassLogin","80",null,"170","64",null,"edtUserId:10",null,null,null,null,this.divLogin.form);
            obj.set_taborder("7");
            obj.set_cssclass("btn_LG_login");
            obj.set_text("OTP/AD");
            obj.set_visible("true");
            ...
            obj = new Button("btnLogin","80.00","596",null,"64","80",null,null,null,null,null,this.divLogin.form);
            obj.set_taborder("5");
            obj.set_cssclass("btn_LG_login");
            obj.set_text("Login");
            this.divLogin.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("frLogin_bk.xfdl", function() {
        /***********************************************************************************
        * 화면(명)		︰ 공통
        * 메뉴(경로)	︰ 공통관리 > 플랫폼 > 공통
        * 화면 설명	︰ 공통
        ...
        ***********************************************************************************/
        ...
        this.loadIncludeScript("frLogin_bk.xfdl");
