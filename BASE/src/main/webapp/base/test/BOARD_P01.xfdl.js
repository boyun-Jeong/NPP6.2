(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divWebEditor","stcConts:5.00","120",null,null,"25","divFile:26",null,null,null,null,this.divContent.form);
            obj.set_taborder("2");
            ...
            obj = new Edit("edtTitle","125.00","91",null,"24","25",null,null,null,null,null,this.divContent.form);
            obj.set_taborder("13");
            obj.set_cssclass("edt_WF_normal");
        ...
        // User Script
        this.registerScript("BOARD_P01.xfdl", function() {
        /***********************************************************************************
        * 화면(ID)		︰ FOMM0210_P01
        * 화면(명)		︰ 공지사항 팝업
        * 메뉴(경로)	︰ 공통
        ...
        ***********************************************************************************/
        ...
        this.fnSave = function()
        {
            ...
            var sService = "BOARD/save01";                         // 서비스명
        ...
        this.loadIncludeScript("BOARD_P01.xfdl");
