(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new TextArea("TextArea00","90.00","134",null,null,"550","280",null,null,null,null,this);
            obj.set_taborder("0");
            this.addChild(obj.name, obj);

            obj = new Static("stcAutoInMsg","90.00","30","20","24",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Static("stcConnSocket","115.00","30","127","24",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_border("1px solid blue");
            obj.set_text("소켓연결 [X]");
            this.addChild(obj.name, obj);

            obj = new Button("btnConnect","247.00","30","53","24",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("연결");
            this.addChild(obj.name, obj);

            obj = new Button("btnDisConnect","305.00","30","53","24",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("해제");
            this.addChild(obj.name, obj);

            obj = new Edit("edit","90.00","76","370","31",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            this.addChild(obj.name, obj);

            obj = new Button("sendBtn","470.00","76","79","31",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("전송");
            this.addChild(obj.name, obj);

            obj = new Static("stc00","560","76","252","31",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("\"전송할 메세지/수신인 ID\" 형식으로 전송합니다.");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        // User Script
        this.registerScript("WS000_W.xfdl", function() {
        /***********************************************************************************
        * 화면(명)		︰ 팝업 처리
        * 메뉴(경로)	︰ 공통
        * 화면 설명	︰
        ...
        ***********************************************************************************/
        ...
        this.sendBtn_onclick = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.sendBtn.addEventHandler("onclick",this.sendBtn_onclick,this);
        };
        this.loadIncludeScript("WS000_W.xfdl");
