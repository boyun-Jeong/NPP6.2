 ...
 */
@Controller
@RequestMapping("PJ3800P")
public class PJ3800PController {

	private Logger log = LoggerFactory.getLogger(PJ3800PController.class);

	@Autowired
	private PJ3800PService pj3800pSvc;
	...
	public NexacroResult select01(@ParamDataSet(name = "dsCond") Map<String, Object> dsCond) throws NexacroException {
		...
		List<Map<String, Object>> dsReqment = pj3800pSvc.select01(dsCond);
	...
	public NexacroResult save01(@ParamDataSet(name = "dsCond") Map<String, Object> dsCond, @ParamDataSet(name = "dsReqment") List<Map<String, Object>> dsReqment) throws Exception 
	{
		...
		if( result.getVariables().get("AUTH_YN").equals("Y") ) {
			...
			reqId = pj3800pSvc.save01(dsReqment);
		}else {
		...
		dsReqment = pj3800pSvc.select01(dsCond);
		result.addDataSet("dsReqment", dsReqment);
